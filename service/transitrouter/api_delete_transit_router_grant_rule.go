...
// DeleteTransitRouterGrantRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DeleteTransitRouterGrantRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteTransitRouterGrantRuleCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteTransitRouterGrantRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DeleteTransitRouterGrantRuleWithContext(ctx byteplus.Context, input *DeleteTransitRouterGrantRuleInput, opts ...request.Option) (*DeleteTransitRouterGrantRuleOutput, error) {
	req, out := c.DeleteTransitRouterGrantRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
