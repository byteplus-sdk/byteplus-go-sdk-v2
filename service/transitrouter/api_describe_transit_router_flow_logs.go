...
// DescribeTransitRouterFlowLogsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DescribeTransitRouterFlowLogsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTransitRouterFlowLogsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTransitRouterFlowLogsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DescribeTransitRouterFlowLogsWithContext(ctx byteplus.Context, input *DescribeTransitRouterFlowLogsInput, opts ...request.Option) (*DescribeTransitRouterFlowLogsOutput, error) {
	req, out := c.DescribeTransitRouterFlowLogsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
