...
// CreateTransitRouterBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterBandwidthPackageWithContext(ctx byteplus.Context, input *CreateTransitRouterBandwidthPackageInput, opts ...request.Option) (*CreateTransitRouterBandwidthPackageOutput, error) {
	req, out := c.CreateTransitRouterBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
