...
// DissociateTransitRouterAttachmentFromRouteTableCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DissociateTransitRouterAttachmentFromRouteTableCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DissociateTransitRouterAttachmentFromRouteTableCommonRequest(input)
	req.SetContext(ctx)
...
// DissociateTransitRouterAttachmentFromRouteTableRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DissociateTransitRouterAttachmentFromRouteTableWithContext(ctx byteplus.Context, input *DissociateTransitRouterAttachmentFromRouteTableInput, opts ...request.Option) (*DissociateTransitRouterAttachmentFromRouteTableOutput, error) {
	req, out := c.DissociateTransitRouterAttachmentFromRouteTableRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
