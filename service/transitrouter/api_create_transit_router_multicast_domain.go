...
// CreateTransitRouterMulticastDomainCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterMulticastDomainCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterMulticastDomainCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterMulticastDomainRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterMulticastDomainWithContext(ctx byteplus.Context, input *CreateTransitRouterMulticastDomainInput, opts ...request.Option) (*CreateTransitRouterMulticastDomainOutput, error) {
	req, out := c.CreateTransitRouterMulticastDomainRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
