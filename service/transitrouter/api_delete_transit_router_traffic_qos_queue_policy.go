...
// DeleteTransitRouterTrafficQosQueuePolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DeleteTransitRouterTrafficQosQueuePolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteTransitRouterTrafficQosQueuePolicyCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteTransitRouterTrafficQosQueuePolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DeleteTransitRouterTrafficQosQueuePolicyWithContext(ctx byteplus.Context, input *DeleteTransitRouterTrafficQosQueuePolicyInput, opts ...request.Option) (*DeleteTransitRouterTrafficQosQueuePolicyOutput, error) {
	req, out := c.DeleteTransitRouterTrafficQosQueuePolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
