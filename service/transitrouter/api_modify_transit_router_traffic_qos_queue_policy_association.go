...
// ModifyTransitRouterTrafficQosQueuePolicyAssociationCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) ModifyTransitRouterTrafficQosQueuePolicyAssociationCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTransitRouterTrafficQosQueuePolicyAssociationCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTransitRouterTrafficQosQueuePolicyAssociationRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) ModifyTransitRouterTrafficQosQueuePolicyAssociationWithContext(ctx byteplus.Context, input *ModifyTransitRouterTrafficQosQueuePolicyAssociationInput, opts ...request.Option) (*ModifyTransitRouterTrafficQosQueuePolicyAssociationOutput, error) {
	req, out := c.ModifyTransitRouterTrafficQosQueuePolicyAssociationRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
