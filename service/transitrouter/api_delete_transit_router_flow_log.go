...
// DeleteTransitRouterFlowLogCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DeleteTransitRouterFlowLogCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteTransitRouterFlowLogCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteTransitRouterFlowLogRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DeleteTransitRouterFlowLogWithContext(ctx byteplus.Context, input *DeleteTransitRouterFlowLogInput, opts ...request.Option) (*DeleteTransitRouterFlowLogOutput, error) {
	req, out := c.DeleteTransitRouterFlowLogRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
