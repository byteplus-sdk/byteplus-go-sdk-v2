...
// CreateTransitRouterRoutePolicyEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterRoutePolicyEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterRoutePolicyEntryCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterRoutePolicyEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterRoutePolicyEntryWithContext(ctx byteplus.Context, input *CreateTransitRouterRoutePolicyEntryInput, opts ...request.Option) (*CreateTransitRouterRoutePolicyEntryOutput, error) {
	req, out := c.CreateTransitRouterRoutePolicyEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
