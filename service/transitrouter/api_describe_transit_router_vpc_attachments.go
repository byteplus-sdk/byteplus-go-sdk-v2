...
// DescribeTransitRouterVpcAttachmentsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DescribeTransitRouterVpcAttachmentsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTransitRouterVpcAttachmentsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTransitRouterVpcAttachmentsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DescribeTransitRouterVpcAttachmentsWithContext(ctx byteplus.Context, input *DescribeTransitRouterVpcAttachmentsInput, opts ...request.Option) (*DescribeTransitRouterVpcAttachmentsOutput, error) {
	req, out := c.DescribeTransitRouterVpcAttachmentsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
