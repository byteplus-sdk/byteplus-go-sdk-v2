...
// CreateTransitRouterVpcAttachmentCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterVpcAttachmentCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterVpcAttachmentCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterVpcAttachmentRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterVpcAttachmentWithContext(ctx byteplus.Context, input *CreateTransitRouterVpcAttachmentInput, opts ...request.Option) (*CreateTransitRouterVpcAttachmentOutput, error) {
	req, out := c.CreateTransitRouterVpcAttachmentRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
