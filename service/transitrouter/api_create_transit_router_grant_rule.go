...
// CreateTransitRouterGrantRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterGrantRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterGrantRuleCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterGrantRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterGrantRuleWithContext(ctx byteplus.Context, input *CreateTransitRouterGrantRuleInput, opts ...request.Option) (*CreateTransitRouterGrantRuleOutput, error) {
	req, out := c.CreateTransitRouterGrantRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
