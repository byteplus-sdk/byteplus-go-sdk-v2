...
// DeleteTransitRouterMulticastDomainCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DeleteTransitRouterMulticastDomainCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteTransitRouterMulticastDomainCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteTransitRouterMulticastDomainRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DeleteTransitRouterMulticastDomainWithContext(ctx byteplus.Context, input *DeleteTransitRouterMulticastDomainInput, opts ...request.Option) (*DeleteTransitRouterMulticastDomainOutput, error) {
	req, out := c.DeleteTransitRouterMulticastDomainRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
