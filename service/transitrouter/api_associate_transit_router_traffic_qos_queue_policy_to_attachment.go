...
// AssociateTransitRouterTrafficQosQueuePolicyToAttachmentCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) AssociateTransitRouterTrafficQosQueuePolicyToAttachmentCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AssociateTransitRouterTrafficQosQueuePolicyToAttachmentCommonRequest(input)
	req.SetContext(ctx)
...
// AssociateTransitRouterTrafficQosQueuePolicyToAttachmentRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) AssociateTransitRouterTrafficQosQueuePolicyToAttachmentWithContext(ctx byteplus.Context, input *AssociateTransitRouterTrafficQosQueuePolicyToAttachmentInput, opts ...request.Option) (*AssociateTransitRouterTrafficQosQueuePolicyToAttachmentOutput, error) {
	req, out := c.AssociateTransitRouterTrafficQosQueuePolicyToAttachmentRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
