...
// ModifyTransitRouterBandwidthPackageAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) ModifyTransitRouterBandwidthPackageAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTransitRouterBandwidthPackageAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTransitRouterBandwidthPackageAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) ModifyTransitRouterBandwidthPackageAttributesWithContext(ctx byteplus.Context, input *ModifyTransitRouterBandwidthPackageAttributesInput, opts ...request.Option) (*ModifyTransitRouterBandwidthPackageAttributesOutput, error) {
	req, out := c.ModifyTransitRouterBandwidthPackageAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
