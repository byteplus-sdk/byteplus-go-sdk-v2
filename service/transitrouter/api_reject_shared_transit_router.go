...
// RejectSharedTransitRouterCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) RejectSharedTransitRouterCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RejectSharedTransitRouterCommonRequest(input)
	req.SetContext(ctx)
...
// RejectSharedTransitRouterRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) RejectSharedTransitRouterWithContext(ctx byteplus.Context, input *RejectSharedTransitRouterInput, opts ...request.Option) (*RejectSharedTransitRouterOutput, error) {
	req, out := c.RejectSharedTransitRouterRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
