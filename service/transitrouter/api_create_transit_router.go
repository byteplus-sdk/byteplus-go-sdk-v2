...
// CreateTransitRouterCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterWithContext(ctx byteplus.Context, input *CreateTransitRouterInput, opts ...request.Option) (*CreateTransitRouterOutput, error) {
	req, out := c.CreateTransitRouterRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
