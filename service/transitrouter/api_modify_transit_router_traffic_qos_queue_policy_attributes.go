...
// ModifyTransitRouterTrafficQosQueuePolicyAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) ModifyTransitRouterTrafficQosQueuePolicyAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTransitRouterTrafficQosQueuePolicyAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTransitRouterTrafficQosQueuePolicyAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) ModifyTransitRouterTrafficQosQueuePolicyAttributesWithContext(ctx byteplus.Context, input *ModifyTransitRouterTrafficQosQueuePolicyAttributesInput, opts ...request.Option) (*ModifyTransitRouterTrafficQosQueuePolicyAttributesOutput, error) {
	req, out := c.ModifyTransitRouterTrafficQosQueuePolicyAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
