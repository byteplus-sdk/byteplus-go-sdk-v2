...
// CreateTransitRouterMulticastGroupSourceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterMulticastGroupSourceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterMulticastGroupSourceCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterMulticastGroupSourceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterMulticastGroupSourceWithContext(ctx byteplus.Context, input *CreateTransitRouterMulticastGroupSourceInput, opts ...request.Option) (*CreateTransitRouterMulticastGroupSourceOutput, error) {
	req, out := c.CreateTransitRouterMulticastGroupSourceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
