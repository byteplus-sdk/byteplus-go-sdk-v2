...
// DescribeTransitRouterRouteEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DescribeTransitRouterRouteEntriesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTransitRouterRouteEntriesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTransitRouterRouteEntriesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DescribeTransitRouterRouteEntriesWithContext(ctx byteplus.Context, input *DescribeTransitRouterRouteEntriesInput, opts ...request.Option) (*DescribeTransitRouterRouteEntriesOutput, error) {
	req, out := c.DescribeTransitRouterRouteEntriesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *DescribeTransitRouterRouteEntriesInput) SetTransitRouterRouteEntryNextHopId(v string) *DescribeTransitRouterRouteEntriesInput {
...
func (s *TransitRouterRouteEntryForDescribeTransitRouterRouteEntriesOutput) SetTransitRouterRouteEntryNextHopResourceId(v string) *TransitRouterRouteEntryForDescribeTransitRouterRouteEntriesOutput {
	s.TransitRouterRouteEntryNextHopResourceId = &v
	return s
}

// SetTransitRouterRouteEntryNextHopResourceType sets the TransitRouterRouteEntryNextHopResourceType field's value.
func (s *TransitRouterRouteEntryForDescribeTransitRouterRouteEntriesOutput) SetTransitRouterRouteEntryNextHopResourceType(v string) *TransitRouterRouteEntryForDescribeTransitRouterRouteEntriesOutput {
	s.TransitRouterRouteEntryNextHopResourceType = &v
	return s
}
