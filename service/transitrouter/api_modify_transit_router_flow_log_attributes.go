...
// ModifyTransitRouterFlowLogAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) ModifyTransitRouterFlowLogAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTransitRouterFlowLogAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTransitRouterFlowLogAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) ModifyTransitRouterFlowLogAttributesWithContext(ctx byteplus.Context, input *ModifyTransitRouterFlowLogAttributesInput, opts ...request.Option) (*ModifyTransitRouterFlowLogAttributesOutput, error) {
	req, out := c.ModifyTransitRouterFlowLogAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
