...
// ModifyTransitRouterForwardPolicyTableAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) ModifyTransitRouterForwardPolicyTableAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTransitRouterForwardPolicyTableAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTransitRouterForwardPolicyTableAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) ModifyTransitRouterForwardPolicyTableAttributesWithContext(ctx byteplus.Context, input *ModifyTransitRouterForwardPolicyTableAttributesInput, opts ...request.Option) (*ModifyTransitRouterForwardPolicyTableAttributesOutput, error) {
	req, out := c.ModifyTransitRouterForwardPolicyTableAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
