...
// CreateTransitRouterFlowLogCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterFlowLogCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterFlowLogCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterFlowLogRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterFlowLogWithContext(ctx byteplus.Context, input *CreateTransitRouterFlowLogInput, opts ...request.Option) (*CreateTransitRouterFlowLogOutput, error) {
	req, out := c.CreateTransitRouterFlowLogRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
