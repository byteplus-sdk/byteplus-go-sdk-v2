...
// DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentCommonRequest(input)
	req.SetContext(ctx)
...
// DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentWithContext(ctx byteplus.Context, input *DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentInput, opts ...request.Option) (*DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentOutput, error) {
	req, out := c.DissociateTransitRouterTrafficQosQueuePolicyFromAttachmentRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
