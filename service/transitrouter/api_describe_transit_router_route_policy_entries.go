...
// DescribeTransitRouterRoutePolicyEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DescribeTransitRouterRoutePolicyEntriesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTransitRouterRoutePolicyEntriesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTransitRouterRoutePolicyEntriesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DescribeTransitRouterRoutePolicyEntriesWithContext(ctx byteplus.Context, input *DescribeTransitRouterRoutePolicyEntriesInput, opts ...request.Option) (*DescribeTransitRouterRoutePolicyEntriesOutput, error) {
	req, out := c.DescribeTransitRouterRoutePolicyEntriesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
