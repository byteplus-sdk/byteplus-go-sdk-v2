...
// DescribeTransitRouterVpnAttachmentsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) DescribeTransitRouterVpnAttachmentsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTransitRouterVpnAttachmentsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTransitRouterVpnAttachmentsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) DescribeTransitRouterVpnAttachmentsWithContext(ctx byteplus.Context, input *DescribeTransitRouterVpnAttachmentsInput, opts ...request.Option) (*DescribeTransitRouterVpnAttachmentsOutput, error) {
	req, out := c.DescribeTransitRouterVpnAttachmentsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
