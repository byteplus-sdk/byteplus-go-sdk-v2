...
// CreateTransitRouterForwardPolicyEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *TRANSITROUTER) CreateTransitRouterForwardPolicyEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTransitRouterForwardPolicyEntryCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTransitRouterForwardPolicyEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TRANSITROUTER) CreateTransitRouterForwardPolicyEntryWithContext(ctx byteplus.Context, input *CreateTransitRouterForwardPolicyEntryInput, opts ...request.Option) (*CreateTransitRouterForwardPolicyEntryOutput, error) {
	req, out := c.CreateTransitRouterForwardPolicyEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
