...
// DeleteEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteEndpointRequest generates a "byteplus/request.Request" representing the
