...
// GetEndpointCertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// GetEndpointCertificateRequest generates a "byteplus/request.Request" representing the
