...
// CreateEvaluationJobCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ARK) CreateEvaluationJobCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateEvaluationJobCommonRequest(input)
	req.SetContext(ctx)
...
// CreateEvaluationJobRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ARK) CreateEvaluationJobWithContext(ctx byteplus.Context, input *CreateEvaluationJobInput, opts ...request.Option) (*CreateEvaluationJobOutput, error) {
	req, out := c.CreateEvaluationJobRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
