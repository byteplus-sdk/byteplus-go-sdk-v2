...
// ARK provides the API operation methods for making requests to
// ARK. See this package's package overview docs
// for details on the service.
//
// ARK methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ARK {
	svc := &ARK{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ARK operation and runs any
// custom request initialization.
func (c *ARK) newRequest(op *request.Operation, params, data interface{}) *request.Request {
