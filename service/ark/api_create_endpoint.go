...
// CreateEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateEndpointRequest generates a "byteplus/request.Request" representing the
