...
// DescribeAutoInstallPackagesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeAutoInstallPackagesRequest generates a "byteplus/request.Request" representing the
