...
// DeleteLaunchTemplateVersionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) DeleteLaunchTemplateVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteLaunchTemplateVersionCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteLaunchTemplateVersionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) DeleteLaunchTemplateVersionWithContext(ctx byteplus.Context, input *DeleteLaunchTemplateVersionInput, opts ...request.Option) (*DeleteLaunchTemplateVersionOutput, error) {
	req, out := c.DeleteLaunchTemplateVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
