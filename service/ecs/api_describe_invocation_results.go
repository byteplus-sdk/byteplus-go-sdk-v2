...
// DescribeInvocationResultsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeInvocationResultsRequest generates a "byteplus/request.Request" representing the
