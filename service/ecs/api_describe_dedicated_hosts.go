...
// DescribeDedicatedHostsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDedicatedHostsRequest generates a "byteplus/request.Request" representing the
