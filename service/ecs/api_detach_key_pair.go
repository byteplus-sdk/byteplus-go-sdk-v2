...
// DetachKeyPairCommonRequest generates a "byteplus/request.Request" representing the
...
// DetachKeyPairRequest generates a "byteplus/request.Request" representing the
