...
// DescribeSpotAdviceCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSpotAdviceRequest generates a "byteplus/request.Request" representing the
