...
// ReportInstancesStatusCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) ReportInstancesStatusCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ReportInstancesStatusCommonRequest(input)
	req.SetContext(ctx)
...
// ReportInstancesStatusRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) ReportInstancesStatusWithContext(ctx byteplus.Context, input *ReportInstancesStatusInput, opts ...request.Option) (*ReportInstancesStatusOutput, error) {
	req, out := c.ReportInstancesStatusRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
