...
// DeleteDedicatedHostClusterCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteDedicatedHostClusterRequest generates a "byteplus/request.Request" representing the
