...
// DescribeInstanceVncUrlCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeInstanceVncUrlRequest generates a "byteplus/request.Request" representing the
