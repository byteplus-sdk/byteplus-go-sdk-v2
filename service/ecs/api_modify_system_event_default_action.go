...
// ModifySystemEventDefaultActionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) ModifySystemEventDefaultActionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifySystemEventDefaultActionCommonRequest(input)
	req.SetContext(ctx)
...
// ModifySystemEventDefaultActionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) ModifySystemEventDefaultActionWithContext(ctx byteplus.Context, input *ModifySystemEventDefaultActionInput, opts ...request.Option) (*ModifySystemEventDefaultActionOutput, error) {
	req, out := c.ModifySystemEventDefaultActionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
