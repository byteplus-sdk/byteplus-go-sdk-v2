...
// GetConsoleOutputCommonRequest generates a "byteplus/request.Request" representing the
...
// GetConsoleOutputRequest generates a "byteplus/request.Request" representing the
