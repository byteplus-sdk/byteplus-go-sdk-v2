...
// PurchaseReservedInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// PurchaseReservedInstancesRequest generates a "byteplus/request.Request" representing the
