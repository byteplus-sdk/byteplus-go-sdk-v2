...
// DescribeEventTypesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeEventTypesRequest generates a "byteplus/request.Request" representing the
