...
// DescribeLaunchTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) DescribeLaunchTemplatesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeLaunchTemplatesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeLaunchTemplatesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) DescribeLaunchTemplatesWithContext(ctx byteplus.Context, input *DescribeLaunchTemplatesInput, opts ...request.Option) (*DescribeLaunchTemplatesOutput, error) {
	req, out := c.DescribeLaunchTemplatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
