...
// DescribeDedicatedHostTypesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDedicatedHostTypesRequest generates a "byteplus/request.Request" representing the
