...
// AllocateDedicatedHostsCommonRequest generates a "byteplus/request.Request" representing the
...
// AllocateDedicatedHostsRequest generates a "byteplus/request.Request" representing the
