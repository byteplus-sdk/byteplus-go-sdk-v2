...
// AllocateInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// AllocateInstancesRequest generates a "byteplus/request.Request" representing the
