...
// RenewScheduledInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
// RenewScheduledInstanceRequest generates a "byteplus/request.Request" representing the
