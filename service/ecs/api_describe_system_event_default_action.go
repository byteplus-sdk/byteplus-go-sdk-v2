...
// DescribeSystemEventDefaultActionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) DescribeSystemEventDefaultActionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeSystemEventDefaultActionCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeSystemEventDefaultActionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) DescribeSystemEventDefaultActionWithContext(ctx byteplus.Context, input *DescribeSystemEventDefaultActionInput, opts ...request.Option) (*DescribeSystemEventDefaultActionOutput, error) {
	req, out := c.DescribeSystemEventDefaultActionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
