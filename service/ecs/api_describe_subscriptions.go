...
// DescribeSubscriptionsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSubscriptionsRequest generates a "byteplus/request.Request" representing the
