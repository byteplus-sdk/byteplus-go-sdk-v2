...
// ModifyImageSharePermissionCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyImageSharePermissionRequest generates a "byteplus/request.Request" representing the
