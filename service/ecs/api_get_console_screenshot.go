...
// GetConsoleScreenshotCommonRequest generates a "byteplus/request.Request" representing the
...
// GetConsoleScreenshotRequest generates a "byteplus/request.Request" representing the
