...
// ExportImageCommonRequest generates a "byteplus/request.Request" representing the
...
// ExportImageRequest generates a "byteplus/request.Request" representing the
