...
// RenewDedicatedHostCommonRequest generates a "byteplus/request.Request" representing the
...
// RenewDedicatedHostRequest generates a "byteplus/request.Request" representing the
