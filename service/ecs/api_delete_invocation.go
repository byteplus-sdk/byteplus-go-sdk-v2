...
// DeleteInvocationCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteInvocationRequest generates a "byteplus/request.Request" representing the
