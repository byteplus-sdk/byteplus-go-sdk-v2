...
// DeleteKeyPairsCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteKeyPairsRequest generates a "byteplus/request.Request" representing the
