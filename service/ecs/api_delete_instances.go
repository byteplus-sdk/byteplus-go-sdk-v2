...
// DeleteInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteInstancesRequest generates a "byteplus/request.Request" representing the
