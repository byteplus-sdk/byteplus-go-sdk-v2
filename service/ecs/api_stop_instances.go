...
// StopInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// StopInstancesRequest generates a "byteplus/request.Request" representing the
