...
// ModifyInstancesSpecCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) ModifyInstancesSpecCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyInstancesSpecCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyInstancesSpecRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) ModifyInstancesSpecWithContext(ctx byteplus.Context, input *ModifyInstancesSpecInput, opts ...request.Option) (*ModifyInstancesSpecOutput, error) {
	req, out := c.ModifyInstancesSpecRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
