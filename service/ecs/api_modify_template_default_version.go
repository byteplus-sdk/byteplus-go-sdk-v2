...
// ModifyTemplateDefaultVersionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ECS) ModifyTemplateDefaultVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTemplateDefaultVersionCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTemplateDefaultVersionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) ModifyTemplateDefaultVersionWithContext(ctx byteplus.Context, input *ModifyTemplateDefaultVersionInput, opts ...request.Option) (*ModifyTemplateDefaultVersionOutput, error) {
	req, out := c.ModifyTemplateDefaultVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
