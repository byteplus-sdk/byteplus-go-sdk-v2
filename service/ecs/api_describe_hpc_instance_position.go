...
// DescribeHpcInstancePositionCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeHpcInstancePositionRequest generates a "byteplus/request.Request" representing the
