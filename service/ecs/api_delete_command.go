...
// DeleteCommandCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteCommandRequest generates a "byteplus/request.Request" representing the
