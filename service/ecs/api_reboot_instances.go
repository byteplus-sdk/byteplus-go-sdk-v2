...
// RebootInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// RebootInstancesRequest generates a "byteplus/request.Request" representing the
