...
// CreateSubscriptionCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSubscriptionRequest generates a "byteplus/request.Request" representing the
