...
// StopInvocationCommonRequest generates a "byteplus/request.Request" representing the
...
// StopInvocationRequest generates a "byteplus/request.Request" representing the
