...
// CreateKeyPairCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateKeyPairRequest generates a "byteplus/request.Request" representing the
