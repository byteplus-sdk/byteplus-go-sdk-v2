...
// DescribeSpotPriceHistoryCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSpotPriceHistoryRequest generates a "byteplus/request.Request" representing the
