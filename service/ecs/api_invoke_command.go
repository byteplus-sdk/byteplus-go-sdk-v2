...
// InvokeCommandCommonRequest generates a "byteplus/request.Request" representing the
...
// InvokeCommandRequest generates a "byteplus/request.Request" representing the
