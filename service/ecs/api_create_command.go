...
// CreateCommandCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateCommandRequest generates a "byteplus/request.Request" representing the
