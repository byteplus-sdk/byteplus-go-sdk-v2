...
// CreateHpcClusterCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateHpcClusterRequest generates a "byteplus/request.Request" representing the
