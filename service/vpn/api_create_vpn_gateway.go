...
// CreateVpnGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateVpnGatewayRequest generates a "byteplus/request.Request" representing the
