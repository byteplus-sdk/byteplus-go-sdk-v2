...
// DeleteVpnGatewayRouteCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVpnGatewayRouteRequest generates a "byteplus/request.Request" representing the
