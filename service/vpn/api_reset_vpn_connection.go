...
// ResetVpnConnectionCommonRequest generates a "byteplus/request.Request" representing the
...
// ResetVpnConnectionRequest generates a "byteplus/request.Request" representing the
