...
// DeleteVpnGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVpnGatewayRequest generates a "byteplus/request.Request" representing the
