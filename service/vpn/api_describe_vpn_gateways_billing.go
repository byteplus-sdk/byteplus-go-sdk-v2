...
// DescribeVpnGatewaysBillingCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnGatewaysBillingRequest generates a "byteplus/request.Request" representing the
