...
// DescribeCustomerGatewaysCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeCustomerGatewaysRequest generates a "byteplus/request.Request" representing the
