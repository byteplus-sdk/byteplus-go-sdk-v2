...
// DescribeVpnConnectionsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnConnectionsRequest generates a "byteplus/request.Request" representing the
