...
// DeleteVpnConnectionCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVpnConnectionRequest generates a "byteplus/request.Request" representing the
