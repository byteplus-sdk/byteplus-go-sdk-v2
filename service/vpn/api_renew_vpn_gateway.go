...
// RenewVpnGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// RenewVpnGatewayRequest generates a "byteplus/request.Request" representing the
