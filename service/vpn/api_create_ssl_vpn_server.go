...
// CreateSslVpnServerCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSslVpnServerRequest generates a "byteplus/request.Request" representing the
