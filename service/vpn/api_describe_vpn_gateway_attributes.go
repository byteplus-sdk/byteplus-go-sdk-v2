...
// DescribeVpnGatewayAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnGatewayAttributesRequest generates a "byteplus/request.Request" representing the
