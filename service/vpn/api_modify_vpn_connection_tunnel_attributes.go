...
// ModifyVpnConnectionTunnelAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyVpnConnectionTunnelAttributesRequest generates a "byteplus/request.Request" representing the
