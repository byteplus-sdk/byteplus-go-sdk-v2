...
// DescribeVpnGatewayRoutesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnGatewayRoutesRequest generates a "byteplus/request.Request" representing the
