...
// CreateVpnGatewayRouteCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateVpnGatewayRouteRequest generates a "byteplus/request.Request" representing the
