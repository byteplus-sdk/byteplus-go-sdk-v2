...
// DeleteCustomerGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteCustomerGatewayRequest generates a "byteplus/request.Request" representing the
