...
// DescribeVpnConnectionAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnConnectionAttributesRequest generates a "byteplus/request.Request" representing the
