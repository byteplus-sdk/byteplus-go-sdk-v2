...
// DescribeVpnGatewayRouteAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpnGatewayRouteAttributesRequest generates a "byteplus/request.Request" representing the
