...
// CreateCustomerGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateCustomerGatewayRequest generates a "byteplus/request.Request" representing the
