...
// SetVpnGatewayRenewalCommonRequest generates a "byteplus/request.Request" representing the
...
// SetVpnGatewayRenewalRequest generates a "byteplus/request.Request" representing the
