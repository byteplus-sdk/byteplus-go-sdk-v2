...
// ModifyVpcEndpointConnectionsCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyVpcEndpointConnectionsRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyVpcEndpointConnectionsInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "ModifyVpcEndpointConnectionsInput"}
	if s.EndpointId == nil {
