...
// CreateVpcGatewayEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateVpcGatewayEndpointRequest generates a "byteplus/request.Request" representing the
