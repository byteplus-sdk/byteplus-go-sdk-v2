...
// CreateUniqueResourceTypeVpcEndpointServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUniqueResourceTypeVpcEndpointServiceRequest generates a "byteplus/request.Request" representing the
