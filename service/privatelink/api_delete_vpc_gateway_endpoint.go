...
// DeleteVpcGatewayEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVpcGatewayEndpointRequest generates a "byteplus/request.Request" representing the
