...
// PRIVATELINK provides the API operation methods for making requests to
// PRIVATELINK. See this package's package overview docs
// for details on the service.
//
// PRIVATELINK methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *PRIVATELINK {
	svc := &PRIVATELINK{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a PRIVATELINK operation and runs any
// custom request initialization.
func (c *PRIVATELINK) newRequest(op *request.Operation, params, data interface{}) *request.Request {
