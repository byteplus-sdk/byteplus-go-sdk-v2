...
// ModifyVpcGatewayEndpointAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyVpcGatewayEndpointAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyVpcGatewayEndpointAttributesInput) Validate() error {
	...
	if s.EndpointName != nil && len(*s.EndpointName) > 128 {
		invalidParams.Add(request.NewErrParamMaxLen("EndpointName", 128, *s.EndpointName))
	}
