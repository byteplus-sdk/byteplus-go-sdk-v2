...
// ModifyUniqueResourceTypeVpcEndpointServiceAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyUniqueResourceTypeVpcEndpointServiceAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ResourceForModifyUniqueResourceTypeVpcEndpointServiceAttributesInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "ResourceForModifyUniqueResourceTypeVpcEndpointServiceAttributesInput"}
	if s.ResourceId == nil {
