...
// DeleteVpcEndpointServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVpcEndpointServiceRequest generates a "byteplus/request.Request" representing the
