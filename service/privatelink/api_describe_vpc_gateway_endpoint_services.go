...
// DescribeVpcGatewayEndpointServicesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpcGatewayEndpointServicesRequest generates a "byteplus/request.Request" representing the
