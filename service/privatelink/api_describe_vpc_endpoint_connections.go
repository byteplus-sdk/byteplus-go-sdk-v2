...
// DescribeVpcEndpointConnectionsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpcEndpointConnectionsRequest generates a "byteplus/request.Request" representing the
