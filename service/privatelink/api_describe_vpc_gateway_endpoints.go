...
// DescribeVpcGatewayEndpointsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpcGatewayEndpointsRequest generates a "byteplus/request.Request" representing the
...
func (s *DescribeVpcGatewayEndpointsInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "DescribeVpcGatewayEndpointsInput"}
