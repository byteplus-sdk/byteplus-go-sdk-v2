...
// AttachResourceToVpcEndpointServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// AttachResourceToVpcEndpointServiceRequest generates a "byteplus/request.Request" representing the
