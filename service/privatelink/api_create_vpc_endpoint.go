...
// CreateVpcEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateVpcEndpointRequest generates a "byteplus/request.Request" representing the
