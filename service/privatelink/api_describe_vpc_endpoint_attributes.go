...
// DescribeVpcEndpointAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpcEndpointAttributesRequest generates a "byteplus/request.Request" representing the
