...
// DescribeCenInterRegionBandwidthsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenInterRegionBandwidthsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenInterRegionBandwidthsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenInterRegionBandwidthsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenInterRegionBandwidthsWithContext(ctx byteplus.Context, input *DescribeCenInterRegionBandwidthsInput, opts ...request.Option) (*DescribeCenInterRegionBandwidthsOutput, error) {
	req, out := c.DescribeCenInterRegionBandwidthsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
