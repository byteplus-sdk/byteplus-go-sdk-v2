...
// RevokeInstanceFromCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) RevokeInstanceFromCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RevokeInstanceFromCenCommonRequest(input)
	req.SetContext(ctx)
...
// RevokeInstanceFromCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) RevokeInstanceFromCenWithContext(ctx byteplus.Context, input *RevokeInstanceFromCenInput, opts ...request.Option) (*RevokeInstanceFromCenOutput, error) {
	req, out := c.RevokeInstanceFromCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
