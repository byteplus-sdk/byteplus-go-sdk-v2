...
// DescribeCenAttachedInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenAttachedInstancesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenAttachedInstancesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenAttachedInstancesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenAttachedInstancesWithContext(ctx byteplus.Context, input *DescribeCenAttachedInstancesInput, opts ...request.Option) (*DescribeCenAttachedInstancesOutput, error) {
	req, out := c.DescribeCenAttachedInstancesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
