...
// CreateCenInterRegionBandwidthCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) CreateCenInterRegionBandwidthCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCenInterRegionBandwidthCommonRequest(input)
	req.SetContext(ctx)
...
// CreateCenInterRegionBandwidthRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) CreateCenInterRegionBandwidthWithContext(ctx byteplus.Context, input *CreateCenInterRegionBandwidthInput, opts ...request.Option) (*CreateCenInterRegionBandwidthOutput, error) {
	req, out := c.CreateCenInterRegionBandwidthRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
