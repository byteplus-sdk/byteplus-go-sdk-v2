...
// ModifyCenBandwidthPackageAssociationCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) ModifyCenBandwidthPackageAssociationCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCenBandwidthPackageAssociationCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyCenBandwidthPackageAssociationRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) ModifyCenBandwidthPackageAssociationWithContext(ctx byteplus.Context, input *ModifyCenBandwidthPackageAssociationInput, opts ...request.Option) (*ModifyCenBandwidthPackageAssociationOutput, error) {
	req, out := c.ModifyCenBandwidthPackageAssociationRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
