...
// WithdrawCenRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) WithdrawCenRouteEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.WithdrawCenRouteEntryCommonRequest(input)
	req.SetContext(ctx)
...
// WithdrawCenRouteEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) WithdrawCenRouteEntryWithContext(ctx byteplus.Context, input *WithdrawCenRouteEntryInput, opts ...request.Option) (*WithdrawCenRouteEntryOutput, error) {
	req, out := c.WithdrawCenRouteEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
