...
// DescribeCenAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenAttributesWithContext(ctx byteplus.Context, input *DescribeCenAttributesInput, opts ...request.Option) (*DescribeCenAttributesOutput, error) {
	req, out := c.DescribeCenAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
