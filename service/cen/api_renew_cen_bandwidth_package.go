...
// RenewCenBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) RenewCenBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RenewCenBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// RenewCenBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) RenewCenBandwidthPackageWithContext(ctx byteplus.Context, input *RenewCenBandwidthPackageInput, opts ...request.Option) (*RenewCenBandwidthPackageOutput, error) {
	req, out := c.RenewCenBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
