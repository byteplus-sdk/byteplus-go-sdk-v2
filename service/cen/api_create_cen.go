...
// CreateCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) CreateCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCenCommonRequest(input)
	req.SetContext(ctx)
...
// CreateCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) CreateCenWithContext(ctx byteplus.Context, input *CreateCenInput, opts ...request.Option) (*CreateCenOutput, error) {
	req, out := c.CreateCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
