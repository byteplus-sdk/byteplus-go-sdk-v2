...
// DeleteCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DeleteCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteCenCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DeleteCenWithContext(ctx byteplus.Context, input *DeleteCenInput, opts ...request.Option) (*DeleteCenOutput, error) {
	req, out := c.DeleteCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
