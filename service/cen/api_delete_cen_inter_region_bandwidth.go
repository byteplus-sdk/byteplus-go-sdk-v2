...
// DeleteCenInterRegionBandwidthCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DeleteCenInterRegionBandwidthCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteCenInterRegionBandwidthCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteCenInterRegionBandwidthRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DeleteCenInterRegionBandwidthWithContext(ctx byteplus.Context, input *DeleteCenInterRegionBandwidthInput, opts ...request.Option) (*DeleteCenInterRegionBandwidthOutput, error) {
	req, out := c.DeleteCenInterRegionBandwidthRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
