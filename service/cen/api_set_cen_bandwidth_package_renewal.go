...
// SetCenBandwidthPackageRenewalCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) SetCenBandwidthPackageRenewalCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SetCenBandwidthPackageRenewalCommonRequest(input)
	req.SetContext(ctx)
...
// SetCenBandwidthPackageRenewalRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) SetCenBandwidthPackageRenewalWithContext(ctx byteplus.Context, input *SetCenBandwidthPackageRenewalInput, opts ...request.Option) (*SetCenBandwidthPackageRenewalOutput, error) {
	req, out := c.SetCenBandwidthPackageRenewalRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
