...
// DescribeCenServiceRouteEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenServiceRouteEntriesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenServiceRouteEntriesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenServiceRouteEntriesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenServiceRouteEntriesWithContext(ctx byteplus.Context, input *DescribeCenServiceRouteEntriesInput, opts ...request.Option) (*DescribeCenServiceRouteEntriesOutput, error) {
	req, out := c.DescribeCenServiceRouteEntriesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
