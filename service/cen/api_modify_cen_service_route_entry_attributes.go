...
// ModifyCenServiceRouteEntryAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) ModifyCenServiceRouteEntryAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCenServiceRouteEntryAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyCenServiceRouteEntryAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) ModifyCenServiceRouteEntryAttributesWithContext(ctx byteplus.Context, input *ModifyCenServiceRouteEntryAttributesInput, opts ...request.Option) (*ModifyCenServiceRouteEntryAttributesOutput, error) {
	req, out := c.ModifyCenServiceRouteEntryAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
