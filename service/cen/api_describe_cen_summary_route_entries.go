...
// DescribeCenSummaryRouteEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenSummaryRouteEntriesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenSummaryRouteEntriesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenSummaryRouteEntriesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenSummaryRouteEntriesWithContext(ctx byteplus.Context, input *DescribeCenSummaryRouteEntriesInput, opts ...request.Option) (*DescribeCenSummaryRouteEntriesOutput, error) {
	req, out := c.DescribeCenSummaryRouteEntriesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
