...
// DisassociateCenBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DisassociateCenBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DisassociateCenBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// DisassociateCenBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DisassociateCenBandwidthPackageWithContext(ctx byteplus.Context, input *DisassociateCenBandwidthPackageInput, opts ...request.Option) (*DisassociateCenBandwidthPackageOutput, error) {
	req, out := c.DisassociateCenBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
