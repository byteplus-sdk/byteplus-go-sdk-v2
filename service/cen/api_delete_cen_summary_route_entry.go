...
// DeleteCenSummaryRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DeleteCenSummaryRouteEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteCenSummaryRouteEntryCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteCenSummaryRouteEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DeleteCenSummaryRouteEntryWithContext(ctx byteplus.Context, input *DeleteCenSummaryRouteEntryInput, opts ...request.Option) (*DeleteCenSummaryRouteEntryOutput, error) {
	req, out := c.DeleteCenSummaryRouteEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
