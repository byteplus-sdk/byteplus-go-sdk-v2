...
// CreateCenServiceRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) CreateCenServiceRouteEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCenServiceRouteEntryCommonRequest(input)
	req.SetContext(ctx)
...
// CreateCenServiceRouteEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) CreateCenServiceRouteEntryWithContext(ctx byteplus.Context, input *CreateCenServiceRouteEntryInput, opts ...request.Option) (*CreateCenServiceRouteEntryOutput, error) {
	req, out := c.CreateCenServiceRouteEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
