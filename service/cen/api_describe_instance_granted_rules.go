...
// DescribeInstanceGrantedRulesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeInstanceGrantedRulesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstanceGrantedRulesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeInstanceGrantedRulesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeInstanceGrantedRulesWithContext(ctx byteplus.Context, input *DescribeInstanceGrantedRulesInput, opts ...request.Option) (*DescribeInstanceGrantedRulesOutput, error) {
	req, out := c.DescribeInstanceGrantedRulesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
