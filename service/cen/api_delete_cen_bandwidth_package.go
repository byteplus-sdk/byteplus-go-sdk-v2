...
// DeleteCenBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DeleteCenBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteCenBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteCenBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DeleteCenBandwidthPackageWithContext(ctx byteplus.Context, input *DeleteCenBandwidthPackageInput, opts ...request.Option) (*DeleteCenBandwidthPackageOutput, error) {
	req, out := c.DeleteCenBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
