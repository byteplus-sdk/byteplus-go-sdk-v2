...
// CreateCenSummaryRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) CreateCenSummaryRouteEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCenSummaryRouteEntryCommonRequest(input)
	req.SetContext(ctx)
...
// CreateCenSummaryRouteEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) CreateCenSummaryRouteEntryWithContext(ctx byteplus.Context, input *CreateCenSummaryRouteEntryInput, opts ...request.Option) (*CreateCenSummaryRouteEntryOutput, error) {
	req, out := c.CreateCenSummaryRouteEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
