...
// ModifyCenInterRegionBandwidthAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) ModifyCenInterRegionBandwidthAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCenInterRegionBandwidthAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyCenInterRegionBandwidthAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) ModifyCenInterRegionBandwidthAttributesWithContext(ctx byteplus.Context, input *ModifyCenInterRegionBandwidthAttributesInput, opts ...request.Option) (*ModifyCenInterRegionBandwidthAttributesOutput, error) {
	req, out := c.ModifyCenInterRegionBandwidthAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
