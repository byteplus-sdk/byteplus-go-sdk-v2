...
// ModifyCenBandwidthPackageAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) ModifyCenBandwidthPackageAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCenBandwidthPackageAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyCenBandwidthPackageAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) ModifyCenBandwidthPackageAttributesWithContext(ctx byteplus.Context, input *ModifyCenBandwidthPackageAttributesInput, opts ...request.Option) (*ModifyCenBandwidthPackageAttributesOutput, error) {
	req, out := c.ModifyCenBandwidthPackageAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
