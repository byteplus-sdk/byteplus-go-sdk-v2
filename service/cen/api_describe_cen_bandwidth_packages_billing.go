...
// DescribeCenBandwidthPackagesBillingCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenBandwidthPackagesBillingCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenBandwidthPackagesBillingCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenBandwidthPackagesBillingRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenBandwidthPackagesBillingWithContext(ctx byteplus.Context, input *DescribeCenBandwidthPackagesBillingInput, opts ...request.Option) (*DescribeCenBandwidthPackagesBillingOutput, error) {
	req, out := c.DescribeCenBandwidthPackagesBillingRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
