...
// CreateCenBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) CreateCenBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCenBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// CreateCenBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) CreateCenBandwidthPackageWithContext(ctx byteplus.Context, input *CreateCenBandwidthPackageInput, opts ...request.Option) (*CreateCenBandwidthPackageOutput, error) {
	req, out := c.CreateCenBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
