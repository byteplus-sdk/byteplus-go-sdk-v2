...
// PublishCenRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) PublishCenRouteEntryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.PublishCenRouteEntryCommonRequest(input)
	req.SetContext(ctx)
...
// PublishCenRouteEntryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) PublishCenRouteEntryWithContext(ctx byteplus.Context, input *PublishCenRouteEntryInput, opts ...request.Option) (*PublishCenRouteEntryOutput, error) {
	req, out := c.PublishCenRouteEntryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
