...
// GrantInstanceToCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) GrantInstanceToCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GrantInstanceToCenCommonRequest(input)
	req.SetContext(ctx)
...
// GrantInstanceToCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) GrantInstanceToCenWithContext(ctx byteplus.Context, input *GrantInstanceToCenInput, opts ...request.Option) (*GrantInstanceToCenOutput, error) {
	req, out := c.GrantInstanceToCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
