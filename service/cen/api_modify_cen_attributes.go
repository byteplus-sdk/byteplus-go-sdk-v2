...
// ModifyCenAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) ModifyCenAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCenAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyCenAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) ModifyCenAttributesWithContext(ctx byteplus.Context, input *ModifyCenAttributesInput, opts ...request.Option) (*ModifyCenAttributesOutput, error) {
	req, out := c.ModifyCenAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
