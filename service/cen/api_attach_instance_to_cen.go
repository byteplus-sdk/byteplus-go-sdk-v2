...
// AttachInstanceToCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) AttachInstanceToCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AttachInstanceToCenCommonRequest(input)
	req.SetContext(ctx)
...
// AttachInstanceToCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) AttachInstanceToCenWithContext(ctx byteplus.Context, input *AttachInstanceToCenInput, opts ...request.Option) (*AttachInstanceToCenOutput, error) {
	req, out := c.AttachInstanceToCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
