...
// DescribeCenAttachedInstanceAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenAttachedInstanceAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenAttachedInstanceAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenAttachedInstanceAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenAttachedInstanceAttributesWithContext(ctx byteplus.Context, input *DescribeCenAttachedInstanceAttributesInput, opts ...request.Option) (*DescribeCenAttachedInstanceAttributesOutput, error) {
	req, out := c.DescribeCenAttachedInstanceAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
