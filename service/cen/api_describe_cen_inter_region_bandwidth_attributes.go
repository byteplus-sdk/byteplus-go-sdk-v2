...
// DescribeCenInterRegionBandwidthAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for CEN's
...
func (c *CEN) DescribeCenInterRegionBandwidthAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenInterRegionBandwidthAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenInterRegionBandwidthAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenInterRegionBandwidthAttributesWithContext(ctx byteplus.Context, input *DescribeCenInterRegionBandwidthAttributesInput, opts ...request.Option) (*DescribeCenInterRegionBandwidthAttributesOutput, error) {
	req, out := c.DescribeCenInterRegionBandwidthAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
