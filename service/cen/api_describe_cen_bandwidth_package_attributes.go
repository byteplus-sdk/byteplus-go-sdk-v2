...
// DescribeCenBandwidthPackageAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenBandwidthPackageAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenBandwidthPackageAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenBandwidthPackageAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenBandwidthPackageAttributesWithContext(ctx byteplus.Context, input *DescribeCenBandwidthPackageAttributesInput, opts ...request.Option) (*DescribeCenBandwidthPackageAttributesOutput, error) {
	req, out := c.DescribeCenBandwidthPackageAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
