...
// DescribeGrantRulesToCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeGrantRulesToCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeGrantRulesToCenCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeGrantRulesToCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeGrantRulesToCenWithContext(ctx byteplus.Context, input *DescribeGrantRulesToCenInput, opts ...request.Option) (*DescribeGrantRulesToCenOutput, error) {
	req, out := c.DescribeGrantRulesToCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
