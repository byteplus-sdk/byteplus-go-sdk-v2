...
// DescribeCensCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCensCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCensCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCensRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCensWithContext(ctx byteplus.Context, input *DescribeCensInput, opts ...request.Option) (*DescribeCensOutput, error) {
	req, out := c.DescribeCensRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
