...
// DescribeCenBandwidthPackagesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenBandwidthPackagesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenBandwidthPackagesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenBandwidthPackagesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenBandwidthPackagesWithContext(ctx byteplus.Context, input *DescribeCenBandwidthPackagesInput, opts ...request.Option) (*DescribeCenBandwidthPackagesOutput, error) {
	req, out := c.DescribeCenBandwidthPackagesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
