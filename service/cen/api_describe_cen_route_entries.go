...
// DescribeCenRouteEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DescribeCenRouteEntriesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCenRouteEntriesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCenRouteEntriesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DescribeCenRouteEntriesWithContext(ctx byteplus.Context, input *DescribeCenRouteEntriesInput, opts ...request.Option) (*DescribeCenRouteEntriesOutput, error) {
	req, out := c.DescribeCenRouteEntriesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
