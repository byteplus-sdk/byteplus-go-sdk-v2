...
// DetachInstanceFromCenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) DetachInstanceFromCenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DetachInstanceFromCenCommonRequest(input)
	req.SetContext(ctx)
...
// DetachInstanceFromCenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) DetachInstanceFromCenWithContext(ctx byteplus.Context, input *DetachInstanceFromCenInput, opts ...request.Option) (*DetachInstanceFromCenOutput, error) {
	req, out := c.DetachInstanceFromCenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
