...
// AssociateCenBandwidthPackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *CEN) AssociateCenBandwidthPackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AssociateCenBandwidthPackageCommonRequest(input)
	req.SetContext(ctx)
...
// AssociateCenBandwidthPackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CEN) AssociateCenBandwidthPackageWithContext(ctx byteplus.Context, input *AssociateCenBandwidthPackageInput, opts ...request.Option) (*AssociateCenBandwidthPackageOutput, error) {
	req, out := c.AssociateCenBandwidthPackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
