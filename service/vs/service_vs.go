...
// VS provides the API operation methods for making requests to
// VS. See this package's package overview docs
// for details on the service.
//
// VS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VS {
	svc := &VS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VS operation and runs any
// custom request initialization.
func (c *VS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
