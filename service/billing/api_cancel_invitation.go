...
// CancelInvitationCommonRequest generates a "byteplus/request.Request" representing the
...
// CancelInvitationRequest generates a "byteplus/request.Request" representing the
