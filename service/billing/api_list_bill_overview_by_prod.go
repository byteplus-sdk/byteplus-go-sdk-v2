...
// ListBillOverviewByProdCommonRequest generates a "byteplus/request.Request" representing the
...
// ListBillOverviewByProdRequest generates a "byteplus/request.Request" representing the
...
func (s *ListForListBillOverviewByProdOutput) SetPointDeductAmount(v string) *ListForListBillOverviewByProdOutput {
