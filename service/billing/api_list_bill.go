...
// ListBillCommonRequest generates a "byteplus/request.Request" representing the
...
// ListBillRequest generates a "byteplus/request.Request" representing the
...
func (s *ListForListBillOutput) SetPointDeductAmount(v string) *ListForListBillOutput {
