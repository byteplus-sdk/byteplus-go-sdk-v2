...
// HandleInvitationCommonRequest generates a "byteplus/request.Request" representing the
...
// HandleInvitationRequest generates a "byteplus/request.Request" representing the
