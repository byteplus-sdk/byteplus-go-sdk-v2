...
// CommonBuyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) CommonBuyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CommonBuyCommonRequest(input)
	req.SetContext(ctx)
...
// CommonBuyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) CommonBuyWithContext(ctx byteplus.Context, input *CommonBuyInput, opts ...request.Option) (*CommonBuyOutput, error) {
	req, out := c.CommonBuyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
