...
// ListBudgetAmountByBudgetIDCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetAmountByBudgetIDCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetAmountByBudgetIDCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetAmountByBudgetIDRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetAmountByBudgetIDWithContext(ctx byteplus.Context, input *ListBudgetAmountByBudgetIDInput, opts ...request.Option) (*ListBudgetAmountByBudgetIDOutput, error) {
	req, out := c.ListBudgetAmountByBudgetIDRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
