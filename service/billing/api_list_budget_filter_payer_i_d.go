...
// ListBudgetFilterPayerIDCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterPayerIDCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterPayerIDCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterPayerIDRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterPayerIDWithContext(ctx byteplus.Context, input *ListBudgetFilterPayerIDInput, opts ...request.Option) (*ListBudgetFilterPayerIDOutput, error) {
	req, out := c.ListBudgetFilterPayerIDRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
