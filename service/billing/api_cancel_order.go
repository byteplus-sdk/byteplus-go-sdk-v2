...
// CancelOrderCommonRequest generates a "byteplus/request.Request" representing the
...
// CancelOrderRequest generates a "byteplus/request.Request" representing the
