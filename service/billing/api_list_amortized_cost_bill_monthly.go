...
// ListAmortizedCostBillMonthlyCommonRequest generates a "byteplus/request.Request" representing the
...
// ListAmortizedCostBillMonthlyRequest generates a "byteplus/request.Request" representing the
...
func (s *ListForListAmortizedCostBillMonthlyOutput) SetResourceID(v string) *ListForListAmortizedCostBillMonthlyOutput {
	s.ResourceID = &v
	return s
}
