...
// QueryBudgetDetailCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) QueryBudgetDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryBudgetDetailCommonRequest(input)
	req.SetContext(ctx)
...
// QueryBudgetDetailRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) QueryBudgetDetailWithContext(ctx byteplus.Context, input *QueryBudgetDetailInput, opts ...request.Option) (*QueryBudgetDetailOutput, error) {
	req, out := c.QueryBudgetDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
