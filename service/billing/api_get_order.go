...
// GetOrderCommonRequest generates a "byteplus/request.Request" representing the
...
// GetOrderRequest generates a "byteplus/request.Request" representing the
...
func (s *OrderFailRefundInfoForGetOrderOutput) SetDeductionCount(v string) *OrderFailRefundInfoForGetOrderOutput {
	s.DeductionCount = &v
	return s
}
