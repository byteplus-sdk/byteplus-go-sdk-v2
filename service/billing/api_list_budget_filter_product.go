...
// ListBudgetFilterProductCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterProductCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterProductCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterProductRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterProductWithContext(ctx byteplus.Context, input *ListBudgetFilterProductInput, opts ...request.Option) (*ListBudgetFilterProductOutput, error) {
	req, out := c.ListBudgetFilterProductRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
