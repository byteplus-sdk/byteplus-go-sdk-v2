...
// ListBudgetFilterTagKeyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterTagKeyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterTagKeyCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterTagKeyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterTagKeyWithContext(ctx byteplus.Context, input *ListBudgetFilterTagKeyInput, opts ...request.Option) (*ListBudgetFilterTagKeyOutput, error) {
	req, out := c.ListBudgetFilterTagKeyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
