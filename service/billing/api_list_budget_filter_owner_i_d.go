...
// ListBudgetFilterOwnerIDCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterOwnerIDCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterOwnerIDCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterOwnerIDRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterOwnerIDWithContext(ctx byteplus.Context, input *ListBudgetFilterOwnerIDInput, opts ...request.Option) (*ListBudgetFilterOwnerIDOutput, error) {
	req, out := c.ListBudgetFilterOwnerIDRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
