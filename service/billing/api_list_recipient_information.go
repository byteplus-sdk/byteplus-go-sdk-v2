...
// ListRecipientInformationCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListRecipientInformationCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListRecipientInformationCommonRequest(input)
	req.SetContext(ctx)
...
// ListRecipientInformationRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListRecipientInformationWithContext(ctx byteplus.Context, input *ListRecipientInformationInput, opts ...request.Option) (*ListRecipientInformationOutput, error) {
	req, out := c.ListRecipientInformationRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
