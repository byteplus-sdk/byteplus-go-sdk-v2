...
// ListBudgetFilterSubjectInfoCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterSubjectInfoCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterSubjectInfoCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterSubjectInfoRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterSubjectInfoWithContext(ctx byteplus.Context, input *ListBudgetFilterSubjectInfoInput, opts ...request.Option) (*ListBudgetFilterSubjectInfoOutput, error) {
	req, out := c.ListBudgetFilterSubjectInfoRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
