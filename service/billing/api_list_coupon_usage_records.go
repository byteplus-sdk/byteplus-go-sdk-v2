...
// ListCouponUsageRecordsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListCouponUsageRecordsRequest generates a "byteplus/request.Request" representing the
