...
// ListBudgetFilterProjectCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterProjectCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterProjectCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterProjectRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterProjectWithContext(ctx byteplus.Context, input *ListBudgetFilterProjectInput, opts ...request.Option) (*ListBudgetFilterProjectOutput, error) {
	req, out := c.ListBudgetFilterProjectRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
