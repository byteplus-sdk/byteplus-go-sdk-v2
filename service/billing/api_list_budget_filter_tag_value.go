...
// ListBudgetFilterTagValueCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterTagValueCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterTagValueCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterTagValueRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterTagValueWithContext(ctx byteplus.Context, input *ListBudgetFilterTagValueInput, opts ...request.Option) (*ListBudgetFilterTagValueOutput, error) {
	req, out := c.ListBudgetFilterTagValueRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
