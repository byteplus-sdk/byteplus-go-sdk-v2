...
// ListBudgetFilterRegionCodeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterRegionCodeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterRegionCodeCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterRegionCodeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterRegionCodeWithContext(ctx byteplus.Context, input *ListBudgetFilterRegionCodeInput, opts ...request.Option) (*ListBudgetFilterRegionCodeOutput, error) {
	req, out := c.ListBudgetFilterRegionCodeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
