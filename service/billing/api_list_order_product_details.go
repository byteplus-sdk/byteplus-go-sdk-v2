...
// ListOrderProductDetailsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListOrderProductDetailsRequest generates a "byteplus/request.Request" representing the
