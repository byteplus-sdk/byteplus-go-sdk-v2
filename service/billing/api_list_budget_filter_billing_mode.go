...
// ListBudgetFilterBillingModeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterBillingModeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterBillingModeCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterBillingModeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterBillingModeWithContext(ctx byteplus.Context, input *ListBudgetFilterBillingModeInput, opts ...request.Option) (*ListBudgetFilterBillingModeOutput, error) {
	req, out := c.ListBudgetFilterBillingModeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
