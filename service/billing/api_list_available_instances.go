...
// ListAvailableInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// ListAvailableInstancesRequest generates a "byteplus/request.Request" representing the
