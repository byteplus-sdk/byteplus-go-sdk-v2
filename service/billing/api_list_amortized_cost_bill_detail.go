...
// ListAmortizedCostBillDetailCommonRequest generates a "byteplus/request.Request" representing the
...
// ListAmortizedCostBillDetailRequest generates a "byteplus/request.Request" representing the
...
func (s *ListForListAmortizedCostBillDetailOutput) SetResourceID(v string) *ListForListAmortizedCostBillDetailOutput {
	s.ResourceID = &v
	return s
}
