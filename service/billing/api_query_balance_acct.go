...
// QueryBalanceAcctCommonRequest generates a "byteplus/request.Request" representing the
...
// QueryBalanceAcctRequest generates a "byteplus/request.Request" representing the
