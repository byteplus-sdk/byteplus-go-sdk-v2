...
// ListBudgetFilterZoneCodeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *BILLING) ListBudgetFilterZoneCodeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBudgetFilterZoneCodeCommonRequest(input)
	req.SetContext(ctx)
...
// ListBudgetFilterZoneCodeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *BILLING) ListBudgetFilterZoneCodeWithContext(ctx byteplus.Context, input *ListBudgetFilterZoneCodeInput, opts ...request.Option) (*ListBudgetFilterZoneCodeOutput, error) {
	req, out := c.ListBudgetFilterZoneCodeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
