...
// ListCouponsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListCouponsRequest generates a "byteplus/request.Request" representing the
