...
// VS20260714 provides the API operation methods for making requests to
// VS20260714. See this package's package overview docs
// for details on the service.
//
// VS20260714 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type VS20260714 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *VS20260714 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VS20260714 {
	svc := &VS20260714{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VS20260714 operation and runs any
// custom request initialization.
func (c *VS20260714) newRequest(op *request.Operation, params, data interface{}) *request.Request {
