...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *AUTOSCALING {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *AUTOSCALING {
	svc := &AUTOSCALING{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
