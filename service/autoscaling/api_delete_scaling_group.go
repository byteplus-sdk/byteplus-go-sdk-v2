...
// DeleteScalingGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteScalingGroupRequest generates a "byteplus/request.Request" representing the
