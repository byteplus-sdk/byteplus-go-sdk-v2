...
// DescribeScalingActivitiesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeScalingActivitiesRequest generates a "byteplus/request.Request" representing the
