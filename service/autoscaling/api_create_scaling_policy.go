...
// CreateScalingPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateScalingPolicyRequest generates a "byteplus/request.Request" representing the
...
func (s *AlarmPolicyForCreateScalingPolicyInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "AlarmPolicyForCreateScalingPolicyInput"}
