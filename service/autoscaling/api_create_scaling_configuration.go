...
// CreateScalingConfigurationCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateScalingConfigurationRequest generates a "byteplus/request.Request" representing the
