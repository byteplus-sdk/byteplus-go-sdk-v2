...
// DescribeLifecycleActivitiesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeLifecycleActivitiesRequest generates a "byteplus/request.Request" representing the
