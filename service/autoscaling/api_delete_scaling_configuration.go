...
// DeleteScalingConfigurationCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteScalingConfigurationRequest generates a "byteplus/request.Request" representing the
