...
// SetInstancesProtectionCommonRequest generates a "byteplus/request.Request" representing the
...
// SetInstancesProtectionRequest generates a "byteplus/request.Request" representing the
