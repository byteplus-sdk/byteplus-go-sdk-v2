...
// DescribeScalingPoliciesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeScalingPoliciesRequest generates a "byteplus/request.Request" representing the
