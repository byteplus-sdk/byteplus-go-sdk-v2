...
// CreateLifecycleHookCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateLifecycleHookRequest generates a "byteplus/request.Request" representing the
