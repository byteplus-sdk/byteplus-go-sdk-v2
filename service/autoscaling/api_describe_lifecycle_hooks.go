...
// DescribeLifecycleHooksCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeLifecycleHooksRequest generates a "byteplus/request.Request" representing the
