...
// AttachInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// AttachInstancesRequest generates a "byteplus/request.Request" representing the
