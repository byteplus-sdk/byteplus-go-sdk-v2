...
// DeleteScalingPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteScalingPolicyRequest generates a "byteplus/request.Request" representing the
