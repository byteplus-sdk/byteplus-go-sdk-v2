...
// ModifyLifecycleHookCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyLifecycleHookRequest generates a "byteplus/request.Request" representing the
