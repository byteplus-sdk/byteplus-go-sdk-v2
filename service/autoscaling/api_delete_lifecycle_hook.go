...
// DeleteLifecycleHookCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteLifecycleHookRequest generates a "byteplus/request.Request" representing the
