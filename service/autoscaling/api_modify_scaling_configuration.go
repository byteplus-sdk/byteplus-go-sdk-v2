...
// ModifyScalingConfigurationCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyScalingConfigurationRequest generates a "byteplus/request.Request" representing the
