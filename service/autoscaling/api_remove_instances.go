...
// RemoveInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
// RemoveInstancesRequest generates a "byteplus/request.Request" representing the
