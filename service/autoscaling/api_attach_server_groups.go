...
// AttachServerGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
// AttachServerGroupsRequest generates a "byteplus/request.Request" representing the
