...
// EnableScalingConfigurationCommonRequest generates a "byteplus/request.Request" representing the
...
// EnableScalingConfigurationRequest generates a "byteplus/request.Request" representing the
