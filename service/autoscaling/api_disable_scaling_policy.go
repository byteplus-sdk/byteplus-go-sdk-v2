...
// DisableScalingPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// DisableScalingPolicyRequest generates a "byteplus/request.Request" representing the
