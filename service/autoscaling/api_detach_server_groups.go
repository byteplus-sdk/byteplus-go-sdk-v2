...
// DetachServerGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
// DetachServerGroupsRequest generates a "byteplus/request.Request" representing the
