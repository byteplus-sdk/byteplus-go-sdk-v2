...
// DeleteBackupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteBackupRequest generates a "byteplus/request.Request" representing the
