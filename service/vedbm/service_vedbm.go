...
// VEDBM provides the API operation methods for making requests to
// VEDBM. See this package's package overview docs
// for details on the service.
//
// VEDBM methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VEDBM {
	svc := &VEDBM{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VEDBM operation and runs any
// custom request initialization.
func (c *VEDBM) newRequest(op *request.Operation, params, data interface{}) *request.Request {
