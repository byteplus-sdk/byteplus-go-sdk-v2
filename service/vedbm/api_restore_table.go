...
// RestoreTableCommonRequest generates a "byteplus/request.Request" representing the
...
// RestoreTableRequest generates a "byteplus/request.Request" representing the
