...
// DescribeParameterTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeParameterTemplatesRequest generates a "byteplus/request.Request" representing the
