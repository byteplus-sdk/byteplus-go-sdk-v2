...
// CancelScheduleEventsCommonRequest generates a "byteplus/request.Request" representing the
...
// CancelScheduleEventsRequest generates a "byteplus/request.Request" representing the
