...
func (s *AuthorizedAllowListForDescribeInstanceAllowListsOutput) SetAllowListIPNum(v int32) *AuthorizedAllowListForDescribeInstanceAllowListsOutput {
	s.AllowListIPNum = &v
	return s
}
...
func (s *AuthorizedAllowListForDescribeInstanceAllowListsOutput) SetAssociatedInstanceNum(v int32) *AuthorizedAllowListForDescribeInstanceAllowListsOutput {
