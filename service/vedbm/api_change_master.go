...
// ChangeMasterCommonRequest generates a "byteplus/request.Request" representing the
...
// ChangeMasterRequest generates a "byteplus/request.Request" representing the
