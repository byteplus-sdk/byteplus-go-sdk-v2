...
// DeleteVolumeCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteVolumeRequest generates a "byteplus/request.Request" representing the
