...
// DescribeSnapshotsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSnapshotsRequest generates a "byteplus/request.Request" representing the
