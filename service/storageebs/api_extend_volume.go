...
// ExtendVolumeCommonRequest generates a "byteplus/request.Request" representing the
...
// ExtendVolumeRequest generates a "byteplus/request.Request" representing the
