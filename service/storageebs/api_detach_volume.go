...
// DetachVolumeCommonRequest generates a "byteplus/request.Request" representing the
...
// DetachVolumeRequest generates a "byteplus/request.Request" representing the
