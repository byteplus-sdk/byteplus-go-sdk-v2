...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *STORAGEEBS {
	svc := &STORAGEEBS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a STORAGEEBS operation and runs any
// custom request initialization.
func (c *STORAGEEBS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
