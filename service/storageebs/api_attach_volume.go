...
// AttachVolumeCommonRequest generates a "byteplus/request.Request" representing the
...
// AttachVolumeRequest generates a "byteplus/request.Request" representing the
