...
// DescribeTagsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeTagsRequest generates a "byteplus/request.Request" representing the
