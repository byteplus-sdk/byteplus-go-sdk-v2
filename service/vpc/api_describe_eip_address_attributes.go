...
// DescribeEipAddressAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeEipAddressAttributesRequest generates a "byteplus/request.Request" representing the
