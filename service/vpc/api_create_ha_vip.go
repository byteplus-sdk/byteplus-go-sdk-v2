...
// CreateHaVipCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateHaVipRequest generates a "byteplus/request.Request" representing the
