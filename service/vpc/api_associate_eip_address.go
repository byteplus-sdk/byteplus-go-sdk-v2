...
// AssociateEipAddressCommonRequest generates a "byteplus/request.Request" representing the
...
// AssociateEipAddressRequest generates a "byteplus/request.Request" representing the
