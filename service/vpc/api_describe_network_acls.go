...
// DescribeNetworkAclsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNetworkAclsRequest generates a "byteplus/request.Request" representing the
...
func (s *NetworkAclForDescribeNetworkAclsOutput) SetAccountId(v string) *NetworkAclForDescribeNetworkAclsOutput {
	s.AccountId = &v
	return s
}
