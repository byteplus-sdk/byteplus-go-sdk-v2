...
// ModifyIpamResourceCidrCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VPC) ModifyIpamResourceCidrCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyIpamResourceCidrCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyIpamResourceCidrRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VPC) ModifyIpamResourceCidrWithContext(ctx byteplus.Context, input *ModifyIpamResourceCidrInput, opts ...request.Option) (*ModifyIpamResourceCidrOutput, error) {
	req, out := c.ModifyIpamResourceCidrRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
