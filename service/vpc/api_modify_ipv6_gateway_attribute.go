...
// ModifyIpv6GatewayAttributeCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyIpv6GatewayAttributeRequest generates a "byteplus/request.Request" representing the
