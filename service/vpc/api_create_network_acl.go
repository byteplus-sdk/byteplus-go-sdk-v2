...
// CreateNetworkAclCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNetworkAclRequest generates a "byteplus/request.Request" representing the
...
func (s *CreateNetworkAclOutput) SetAsyncTaskId(v string) *CreateNetworkAclOutput {
	s.AsyncTaskId = &v
	return s
}
