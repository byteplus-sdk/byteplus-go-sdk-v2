...
// DisassociateVpcUserCidrBlockCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VPC) DisassociateVpcUserCidrBlockCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DisassociateVpcUserCidrBlockCommonRequest(input)
	req.SetContext(ctx)
...
// DisassociateVpcUserCidrBlockRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VPC) DisassociateVpcUserCidrBlockWithContext(ctx byteplus.Context, input *DisassociateVpcUserCidrBlockInput, opts ...request.Option) (*DisassociateVpcUserCidrBlockOutput, error) {
	req, out := c.DisassociateVpcUserCidrBlockRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
