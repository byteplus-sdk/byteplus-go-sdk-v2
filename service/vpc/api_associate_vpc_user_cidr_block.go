...
// AssociateVpcUserCidrBlockCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VPC) AssociateVpcUserCidrBlockCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AssociateVpcUserCidrBlockCommonRequest(input)
	req.SetContext(ctx)
...
// AssociateVpcUserCidrBlockRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VPC) AssociateVpcUserCidrBlockWithContext(ctx byteplus.Context, input *AssociateVpcUserCidrBlockInput, opts ...request.Option) (*AssociateVpcUserCidrBlockOutput, error) {
	req, out := c.AssociateVpcUserCidrBlockRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
