...
// AllocateIpv6AddressBandwidthCommonRequest generates a "byteplus/request.Request" representing the
...
// AllocateIpv6AddressBandwidthRequest generates a "byteplus/request.Request" representing the
