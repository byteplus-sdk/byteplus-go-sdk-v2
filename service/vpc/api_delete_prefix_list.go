...
// DeletePrefixListCommonRequest generates a "byteplus/request.Request" representing the
...
// DeletePrefixListRequest generates a "byteplus/request.Request" representing the
...
func (s *DeletePrefixListOutput) SetAsyncTaskId(v string) *DeletePrefixListOutput {
	s.AsyncTaskId = &v
	return s
}
