...
// DisassociateHaVipCommonRequest generates a "byteplus/request.Request" representing the
...
// DisassociateHaVipRequest generates a "byteplus/request.Request" representing the
...
func (s *DisassociateHaVipOutput) SetAsyncTaskId(v string) *DisassociateHaVipOutput {
	s.AsyncTaskId = &v
	return s
}
