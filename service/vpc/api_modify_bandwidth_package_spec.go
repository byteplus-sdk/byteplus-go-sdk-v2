...
// ModifyBandwidthPackageSpecCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyBandwidthPackageSpecRequest generates a "byteplus/request.Request" representing the
