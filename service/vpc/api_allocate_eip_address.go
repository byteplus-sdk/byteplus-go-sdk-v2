...
// AllocateEipAddressCommonRequest generates a "byteplus/request.Request" representing the
...
// AllocateEipAddressRequest generates a "byteplus/request.Request" representing the
