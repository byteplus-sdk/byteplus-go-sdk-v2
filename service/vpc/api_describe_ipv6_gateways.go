...
// DescribeIpv6GatewaysCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeIpv6GatewaysRequest generates a "byteplus/request.Request" representing the
