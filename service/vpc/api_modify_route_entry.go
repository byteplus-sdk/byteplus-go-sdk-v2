...
// ModifyRouteEntryCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyRouteEntryRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyRouteEntryOutput) SetAsyncTaskId(v string) *ModifyRouteEntryOutput {
	s.AsyncTaskId = &v
	return s
}
