...
// AddBandwidthPackageIpCommonRequest generates a "byteplus/request.Request" representing the
...
// AddBandwidthPackageIpRequest generates a "byteplus/request.Request" representing the
