...
// ModifyHaVipAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyHaVipAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyHaVipAttributesOutput) SetAsyncTaskId(v string) *ModifyHaVipAttributesOutput {
	s.AsyncTaskId = &v
	return s
}
