...
// DeactiveFlowLogCommonRequest generates a "byteplus/request.Request" representing the
...
// DeactiveFlowLogRequest generates a "byteplus/request.Request" representing the
...
func (s *DeactiveFlowLogOutput) SetAsyncTaskId(v string) *DeactiveFlowLogOutput {
	s.AsyncTaskId = &v
	return s
}
