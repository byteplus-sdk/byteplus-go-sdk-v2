...
// ModifyIpamResourceDiscoveryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VPC) ModifyIpamResourceDiscoveryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyIpamResourceDiscoveryCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyIpamResourceDiscoveryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VPC) ModifyIpamResourceDiscoveryWithContext(ctx byteplus.Context, input *ModifyIpamResourceDiscoveryInput, opts ...request.Option) (*ModifyIpamResourceDiscoveryOutput, error) {
	req, out := c.ModifyIpamResourceDiscoveryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
