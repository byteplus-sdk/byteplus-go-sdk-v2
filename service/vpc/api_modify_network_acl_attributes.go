...
// ModifyNetworkAclAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyNetworkAclAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyNetworkAclAttributesOutput) SetAsyncTaskId(v string) *ModifyNetworkAclAttributesOutput {
	s.AsyncTaskId = &v
	return s
}
