...
// DeleteInstanceGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteInstanceGroupRequest generates a "byteplus/request.Request" representing the
