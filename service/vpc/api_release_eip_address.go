...
// ReleaseEipAddressCommonRequest generates a "byteplus/request.Request" representing the
...
// ReleaseEipAddressRequest generates a "byteplus/request.Request" representing the
