...
// DeleteTrafficMirrorFilterCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteTrafficMirrorFilterRequest generates a "byteplus/request.Request" representing the
...
func (s *DeleteTrafficMirrorFilterOutput) SetAsyncTaskId(v string) *DeleteTrafficMirrorFilterOutput {
	s.AsyncTaskId = &v
	return s
}
