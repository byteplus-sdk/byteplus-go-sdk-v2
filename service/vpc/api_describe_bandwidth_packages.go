...
// DescribeBandwidthPackagesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeBandwidthPackagesRequest generates a "byteplus/request.Request" representing the
