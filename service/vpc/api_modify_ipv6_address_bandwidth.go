...
// ModifyIpv6AddressBandwidthCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyIpv6AddressBandwidthRequest generates a "byteplus/request.Request" representing the
