...
// ModifyEipAddressAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyEipAddressAttributesRequest generates a "byteplus/request.Request" representing the
