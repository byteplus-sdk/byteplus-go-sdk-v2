...
// APIG20221112 provides the API operation methods for making requests to
// APIG20221112. See this package's package overview docs
// for details on the service.
//
// APIG20221112 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *APIG20221112 {
	svc := &APIG20221112{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a APIG20221112 operation and runs any
// custom request initialization.
func (c *APIG20221112) newRequest(op *request.Operation, params, data interface{}) *request.Request {
