...
// KICKART provides the API operation methods for making requests to
// KICKART. See this package's package overview docs
// for details on the service.
//
// KICKART methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *KICKART {
	svc := &KICKART{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a KICKART operation and runs any
// custom request initialization.
func (c *KICKART) newRequest(op *request.Operation, params, data interface{}) *request.Request {
