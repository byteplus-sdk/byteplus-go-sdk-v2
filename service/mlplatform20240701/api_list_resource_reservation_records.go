...
// ListResourceReservationRecordsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceReservationRecordsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceReservationRecordsCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceReservationRecordsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceReservationRecordsWithContext(ctx byteplus.Context, input *ListResourceReservationRecordsInput, opts ...request.Option) (*ListResourceReservationRecordsOutput, error) {
	req, out := c.ListResourceReservationRecordsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
