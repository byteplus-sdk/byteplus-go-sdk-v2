...
// UpdateResourceQueueCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) UpdateResourceQueueCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateResourceQueueCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateResourceQueueRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) UpdateResourceQueueWithContext(ctx byteplus.Context, input *UpdateResourceQueueInput, opts ...request.Option) (*UpdateResourceQueueOutput, error) {
	req, out := c.UpdateResourceQueueRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
