...
// UpdateDevInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) UpdateDevInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateDevInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateDevInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) UpdateDevInstanceWithContext(ctx byteplus.Context, input *UpdateDevInstanceInput, opts ...request.Option) (*UpdateDevInstanceOutput, error) {
	req, out := c.UpdateDevInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
