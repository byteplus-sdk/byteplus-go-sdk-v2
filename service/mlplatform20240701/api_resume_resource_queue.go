...
// ResumeResourceQueueCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ResumeResourceQueueCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ResumeResourceQueueCommonRequest(input)
	req.SetContext(ctx)
...
// ResumeResourceQueueRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ResumeResourceQueueWithContext(ctx byteplus.Context, input *ResumeResourceQueueInput, opts ...request.Option) (*ResumeResourceQueueOutput, error) {
	req, out := c.ResumeResourceQueueRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
