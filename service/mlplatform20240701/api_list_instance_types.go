...
// ListInstanceTypesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListInstanceTypesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListInstanceTypesCommonRequest(input)
	req.SetContext(ctx)
...
// ListInstanceTypesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListInstanceTypesWithContext(ctx byteplus.Context, input *ListInstanceTypesInput, opts ...request.Option) (*ListInstanceTypesOutput, error) {
	req, out := c.ListInstanceTypesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
