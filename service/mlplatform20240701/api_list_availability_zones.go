...
// ListAvailabilityZonesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListAvailabilityZonesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAvailabilityZonesCommonRequest(input)
	req.SetContext(ctx)
...
// ListAvailabilityZonesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListAvailabilityZonesWithContext(ctx byteplus.Context, input *ListAvailabilityZonesInput, opts ...request.Option) (*ListAvailabilityZonesOutput, error) {
	req, out := c.ListAvailabilityZonesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
