...
// StartDevInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) StartDevInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.StartDevInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// StartDevInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) StartDevInstanceWithContext(ctx byteplus.Context, input *StartDevInstanceInput, opts ...request.Option) (*StartDevInstanceOutput, error) {
	req, out := c.StartDevInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *StartDevInstanceInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "StartDevInstanceInput"}
	if s.Id == nil {
