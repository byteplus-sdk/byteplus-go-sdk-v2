...
// RebuildDevInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) RebuildDevInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RebuildDevInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RebuildDevInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) RebuildDevInstanceWithContext(ctx byteplus.Context, input *RebuildDevInstanceInput, opts ...request.Option) (*RebuildDevInstanceOutput, error) {
	req, out := c.RebuildDevInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
