...
// CreateResourceQueueCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) CreateResourceQueueCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateResourceQueueCommonRequest(input)
	req.SetContext(ctx)
...
// CreateResourceQueueRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) CreateResourceQueueWithContext(ctx byteplus.Context, input *CreateResourceQueueInput, opts ...request.Option) (*CreateResourceQueueOutput, error) {
	req, out := c.CreateResourceQueueRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
