...
// CreateResourceGroupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) CreateResourceGroupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateResourceGroupCommonRequest(input)
	req.SetContext(ctx)
...
// CreateResourceGroupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) CreateResourceGroupWithContext(ctx byteplus.Context, input *CreateResourceGroupInput, opts ...request.Option) (*CreateResourceGroupOutput, error) {
	req, out := c.CreateResourceGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
