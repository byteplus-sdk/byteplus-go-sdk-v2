...
// GetResourceQueueCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) GetResourceQueueCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetResourceQueueCommonRequest(input)
	req.SetContext(ctx)
...
// GetResourceQueueRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) GetResourceQueueWithContext(ctx byteplus.Context, input *GetResourceQueueInput, opts ...request.Option) (*GetResourceQueueOutput, error) {
	req, out := c.GetResourceQueueRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
