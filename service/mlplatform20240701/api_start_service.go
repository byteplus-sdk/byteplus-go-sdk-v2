...
// StartServiceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) StartServiceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.StartServiceCommonRequest(input)
	req.SetContext(ctx)
...
// StartServiceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) StartServiceWithContext(ctx byteplus.Context, input *StartServiceInput, opts ...request.Option) (*StartServiceOutput, error) {
	req, out := c.StartServiceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
