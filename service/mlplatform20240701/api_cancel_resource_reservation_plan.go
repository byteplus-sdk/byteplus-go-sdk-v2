...
// CancelResourceReservationPlanCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) CancelResourceReservationPlanCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CancelResourceReservationPlanCommonRequest(input)
	req.SetContext(ctx)
...
// CancelResourceReservationPlanRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) CancelResourceReservationPlanWithContext(ctx byteplus.Context, input *CancelResourceReservationPlanInput, opts ...request.Option) (*CancelResourceReservationPlanOutput, error) {
	req, out := c.CancelResourceReservationPlanRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
