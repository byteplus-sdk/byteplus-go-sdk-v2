...
// ListResourceQueuesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceQueuesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceQueuesCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceQueuesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceQueuesWithContext(ctx byteplus.Context, input *ListResourceQueuesInput, opts ...request.Option) (*ListResourceQueuesOutput, error) {
	req, out := c.ListResourceQueuesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
