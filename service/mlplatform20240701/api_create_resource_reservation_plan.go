...
// CreateResourceReservationPlanCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) CreateResourceReservationPlanCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateResourceReservationPlanCommonRequest(input)
	req.SetContext(ctx)
...
// CreateResourceReservationPlanRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) CreateResourceReservationPlanWithContext(ctx byteplus.Context, input *CreateResourceReservationPlanInput, opts ...request.Option) (*CreateResourceReservationPlanOutput, error) {
	req, out := c.CreateResourceReservationPlanRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
