...
// CreateDevInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) CreateDevInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDevInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDevInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) CreateDevInstanceWithContext(ctx byteplus.Context, input *CreateDevInstanceInput, opts ...request.Option) (*CreateDevInstanceOutput, error) {
	req, out := c.CreateDevInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
