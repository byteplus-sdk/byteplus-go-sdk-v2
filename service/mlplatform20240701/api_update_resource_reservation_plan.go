...
// UpdateResourceReservationPlanCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) UpdateResourceReservationPlanCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateResourceReservationPlanCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateResourceReservationPlanRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) UpdateResourceReservationPlanWithContext(ctx byteplus.Context, input *UpdateResourceReservationPlanInput, opts ...request.Option) (*UpdateResourceReservationPlanOutput, error) {
	req, out := c.UpdateResourceReservationPlanRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
