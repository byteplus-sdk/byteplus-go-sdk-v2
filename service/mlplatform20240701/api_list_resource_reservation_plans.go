...
// ListResourceReservationPlansCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceReservationPlansCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceReservationPlansCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceReservationPlansRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceReservationPlansWithContext(ctx byteplus.Context, input *ListResourceReservationPlansInput, opts ...request.Option) (*ListResourceReservationPlansOutput, error) {
	req, out := c.ListResourceReservationPlansRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
