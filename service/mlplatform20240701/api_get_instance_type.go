...
// GetInstanceTypeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) GetInstanceTypeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetInstanceTypeCommonRequest(input)
	req.SetContext(ctx)
...
// GetInstanceTypeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) GetInstanceTypeWithContext(ctx byteplus.Context, input *GetInstanceTypeInput, opts ...request.Option) (*GetInstanceTypeOutput, error) {
	req, out := c.GetInstanceTypeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
