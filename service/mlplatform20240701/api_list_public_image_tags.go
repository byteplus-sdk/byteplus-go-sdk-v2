...
// ListPublicImageTagsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListPublicImageTagsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListPublicImageTagsCommonRequest(input)
	req.SetContext(ctx)
...
// ListPublicImageTagsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListPublicImageTagsWithContext(ctx byteplus.Context, input *ListPublicImageTagsInput, opts ...request.Option) (*ListPublicImageTagsOutput, error) {
	req, out := c.ListPublicImageTagsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
