...
// UpdateResourceGroupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) UpdateResourceGroupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateResourceGroupCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateResourceGroupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) UpdateResourceGroupWithContext(ctx byteplus.Context, input *UpdateResourceGroupInput, opts ...request.Option) (*UpdateResourceGroupOutput, error) {
	req, out := c.UpdateResourceGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
