...
// ListPublicImageReposCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListPublicImageReposCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListPublicImageReposCommonRequest(input)
	req.SetContext(ctx)
...
// ListPublicImageReposRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListPublicImageReposWithContext(ctx byteplus.Context, input *ListPublicImageReposInput, opts ...request.Option) (*ListPublicImageReposOutput, error) {
	req, out := c.ListPublicImageReposRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
