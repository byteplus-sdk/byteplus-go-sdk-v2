...
// GetResourceGroupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) GetResourceGroupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetResourceGroupCommonRequest(input)
	req.SetContext(ctx)
...
// GetResourceGroupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) GetResourceGroupWithContext(ctx byteplus.Context, input *GetResourceGroupInput, opts ...request.Option) (*GetResourceGroupOutput, error) {
	req, out := c.GetResourceGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
