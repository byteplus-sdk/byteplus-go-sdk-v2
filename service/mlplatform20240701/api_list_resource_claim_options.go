...
// ListResourceClaimOptionsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceClaimOptionsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceClaimOptionsCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceClaimOptionsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceClaimOptionsWithContext(ctx byteplus.Context, input *ListResourceClaimOptionsInput, opts ...request.Option) (*ListResourceClaimOptionsOutput, error) {
	req, out := c.ListResourceClaimOptionsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
