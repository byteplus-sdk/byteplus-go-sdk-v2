...
// GetResourceReservationPlanCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) GetResourceReservationPlanCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetResourceReservationPlanCommonRequest(input)
	req.SetContext(ctx)
...
// GetResourceReservationPlanRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) GetResourceReservationPlanWithContext(ctx byteplus.Context, input *GetResourceReservationPlanInput, opts ...request.Option) (*GetResourceReservationPlanOutput, error) {
	req, out := c.GetResourceReservationPlanRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
