...
// ListJobInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListJobInstancesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListJobInstancesCommonRequest(input)
	req.SetContext(ctx)
...
// ListJobInstancesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListJobInstancesWithContext(ctx byteplus.Context, input *ListJobInstancesInput, opts ...request.Option) (*ListJobInstancesOutput, error) {
	req, out := c.ListJobInstancesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
