...
// RebootDevInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) RebootDevInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RebootDevInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RebootDevInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) RebootDevInstanceWithContext(ctx byteplus.Context, input *RebootDevInstanceInput, opts ...request.Option) (*RebootDevInstanceOutput, error) {
	req, out := c.RebootDevInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *RebootDevInstanceInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "RebootDevInstanceInput"}
	if s.Id == nil {
