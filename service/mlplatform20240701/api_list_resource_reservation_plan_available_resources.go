...
// ListResourceReservationPlanAvailableResourcesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceReservationPlanAvailableResourcesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceReservationPlanAvailableResourcesCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceReservationPlanAvailableResourcesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceReservationPlanAvailableResourcesWithContext(ctx byteplus.Context, input *ListResourceReservationPlanAvailableResourcesInput, opts ...request.Option) (*ListResourceReservationPlanAvailableResourcesOutput, error) {
	req, out := c.ListResourceReservationPlanAvailableResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
