...
// ListVolumeTypesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListVolumeTypesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListVolumeTypesCommonRequest(input)
	req.SetContext(ctx)
...
// ListVolumeTypesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListVolumeTypesWithContext(ctx byteplus.Context, input *ListVolumeTypesInput, opts ...request.Option) (*ListVolumeTypesOutput, error) {
	req, out := c.ListVolumeTypesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
