...
// ListResourceGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListResourceGroupsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceGroupsCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceGroupsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListResourceGroupsWithContext(ctx byteplus.Context, input *ListResourceGroupsInput, opts ...request.Option) (*ListResourceGroupsOutput, error) {
	req, out := c.ListResourceGroupsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
