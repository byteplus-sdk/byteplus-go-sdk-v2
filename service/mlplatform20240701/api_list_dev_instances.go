...
// ListDevInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MLPLATFORM20240701) ListDevInstancesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListDevInstancesCommonRequest(input)
	req.SetContext(ctx)
...
// ListDevInstancesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MLPLATFORM20240701) ListDevInstancesWithContext(ctx byteplus.Context, input *ListDevInstancesInput, opts ...request.Option) (*ListDevInstancesOutput, error) {
	req, out := c.ListDevInstancesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
