...
// ListResourceTypesCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for TAG's
...
func (c *TAG) ListResourceTypesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceTypesCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourceTypesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *TAG) ListResourceTypesWithContext(ctx byteplus.Context, input *ListResourceTypesInput, opts ...request.Option) (*ListResourceTypesOutput, error) {
	req, out := c.ListResourceTypesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
