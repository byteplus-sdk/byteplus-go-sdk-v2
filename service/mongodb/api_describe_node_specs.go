...
// DescribeNodeSpecsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeNodeSpecsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeNodeSpecsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeNodeSpecsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeNodeSpecsWithContext(ctx byteplus.Context, input *DescribeNodeSpecsInput, opts ...request.Option) (*DescribeNodeSpecsOutput, error) {
	req, out := c.DescribeNodeSpecsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
