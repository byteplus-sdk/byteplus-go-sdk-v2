...
// SwitchDBMasterCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) SwitchDBMasterCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchDBMasterCommonRequest(input)
	req.SetContext(ctx)
...
// SwitchDBMasterRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) SwitchDBMasterWithContext(ctx byteplus.Context, input *SwitchDBMasterInput, opts ...request.Option) (*SwitchDBMasterOutput, error) {
	req, out := c.SwitchDBMasterRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
