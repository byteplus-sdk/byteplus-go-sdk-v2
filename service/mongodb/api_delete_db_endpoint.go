...
// DeleteDBEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DeleteDBEndpointCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDBEndpointCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDBEndpointRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DeleteDBEndpointWithContext(ctx byteplus.Context, input *DeleteDBEndpointInput, opts ...request.Option) (*DeleteDBEndpointOutput, error) {
	req, out := c.DeleteDBEndpointRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
