...
// DescribeDBInstanceBackupPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeDBInstanceBackupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceBackupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceBackupPolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeDBInstanceBackupPolicyWithContext(ctx byteplus.Context, input *DescribeDBInstanceBackupPolicyInput, opts ...request.Option) (*DescribeDBInstanceBackupPolicyOutput, error) {
	req, out := c.DescribeDBInstanceBackupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
