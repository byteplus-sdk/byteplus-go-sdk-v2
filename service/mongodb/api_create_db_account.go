...
// CreateDBAccountCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *MONGODB) CreateDBAccountCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// CreateDBAccountCommon API operation for MONGODB.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the BYTEPLUS API reference guide for MONGODB's
// API operation CreateDBAccountCommon for usage and error information.
func (c *MONGODB) CreateDBAccountCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *MONGODB) CreateDBAccountCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDBAccountCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDBAccountRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *MONGODB) CreateDBAccountRequest(input *CreateDBAccountInput) (req *request.Request, output *CreateDBAccountOutput) {
	op := &request.Operation{
...
// CreateDBAccount API operation for MONGODB.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *MONGODB) CreateDBAccount(input *CreateDBAccountInput) (*CreateDBAccountOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) CreateDBAccountWithContext(ctx byteplus.Context, input *CreateDBAccountInput, opts ...request.Option) (*CreateDBAccountOutput, error) {
	req, out := c.CreateDBAccountRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type AccountDBPrivilegeForCreateDBAccountInput struct {
...
func (s AccountDBPrivilegeForCreateDBAccountInput) String() string {
	return byteplusutil.Prettify(s)
}

// GoString returns the string representation
func (s AccountDBPrivilegeForCreateDBAccountInput) GoString() string {
	return s.String()
}

// SetDBName sets the DBName field's value.
func (s *AccountDBPrivilegeForCreateDBAccountInput) SetDBName(v string) *AccountDBPrivilegeForCreateDBAccountInput {
	s.DBName = &v
	return s
}

// SetRoleNames sets the RoleNames field's value.
func (s *AccountDBPrivilegeForCreateDBAccountInput) SetRoleNames(v []*string) *AccountDBPrivilegeForCreateDBAccountInput {
	s.RoleNames = v
	return s
}
...
type CreateDBAccountInput struct {
	...
	AccountDBPrivileges []*AccountDBPrivilegeForCreateDBAccountInput `type:"list" json:",omitempty"`
...
func (s *CreateDBAccountInput) SetAccountDBPrivileges(v []*AccountDBPrivilegeForCreateDBAccountInput) *CreateDBAccountInput {
...
func (s *CreateDBAccountInput) SetAuthDB(v string) *CreateDBAccountInput {
	s.AuthDB = &v
	return s
}
