...
// DescribeDBInstanceBackupURLCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeDBInstanceBackupURLCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceBackupURLCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceBackupURLRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeDBInstanceBackupURLWithContext(ctx byteplus.Context, input *DescribeDBInstanceBackupURLInput, opts ...request.Option) (*DescribeDBInstanceBackupURLOutput, error) {
	req, out := c.DescribeDBInstanceBackupURLRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
