...
// ModifyMultiDBInstanceParametersCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) ModifyMultiDBInstanceParametersCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyMultiDBInstanceParametersCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyMultiDBInstanceParametersRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) ModifyMultiDBInstanceParametersWithContext(ctx byteplus.Context, input *ModifyMultiDBInstanceParametersInput, opts ...request.Option) (*ModifyMultiDBInstanceParametersOutput, error) {
	req, out := c.ModifyMultiDBInstanceParametersRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
