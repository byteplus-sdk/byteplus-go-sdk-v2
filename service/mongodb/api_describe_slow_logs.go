...
// DescribeSlowLogsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeSlowLogsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeSlowLogsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeSlowLogsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeSlowLogsWithContext(ctx byteplus.Context, input *DescribeSlowLogsInput, opts ...request.Option) (*DescribeSlowLogsOutput, error) {
	req, out := c.DescribeSlowLogsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
