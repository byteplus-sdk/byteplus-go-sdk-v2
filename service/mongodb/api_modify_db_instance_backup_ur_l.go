...
// ModifyDBInstanceBackupURLCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) ModifyDBInstanceBackupURLCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceBackupURLCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceBackupURLRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) ModifyDBInstanceBackupURLWithContext(ctx byteplus.Context, input *ModifyDBInstanceBackupURLInput, opts ...request.Option) (*ModifyDBInstanceBackupURLOutput, error) {
	req, out := c.ModifyDBInstanceBackupURLRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
