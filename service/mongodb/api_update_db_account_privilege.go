...
// UpdateDBAccountPrivilegeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) UpdateDBAccountPrivilegeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateDBAccountPrivilegeCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateDBAccountPrivilegeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) UpdateDBAccountPrivilegeWithContext(ctx byteplus.Context, input *UpdateDBAccountPrivilegeInput, opts ...request.Option) (*UpdateDBAccountPrivilegeOutput, error) {
	req, out := c.UpdateDBAccountPrivilegeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
