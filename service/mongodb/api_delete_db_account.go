...
// DeleteDBAccountCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *MONGODB) DeleteDBAccountCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeleteDBAccountCommon API operation for MONGODB.
//
...
func (c *MONGODB) DeleteDBAccountCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *MONGODB) DeleteDBAccountCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDBAccountCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDBAccountRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *MONGODB) DeleteDBAccountRequest(input *DeleteDBAccountInput) (req *request.Request, output *DeleteDBAccountOutput) {
	op := &request.Operation{
...
// DeleteDBAccount API operation for MONGODB.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *MONGODB) DeleteDBAccount(input *DeleteDBAccountInput) (*DeleteDBAccountOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DeleteDBAccountWithContext(ctx byteplus.Context, input *DeleteDBAccountInput, opts ...request.Option) (*DeleteDBAccountOutput, error) {
	req, out := c.DeleteDBAccountRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *DeleteDBAccountInput) SetAuthDB(v string) *DeleteDBAccountInput {
	s.AuthDB = &v
	return s
}
