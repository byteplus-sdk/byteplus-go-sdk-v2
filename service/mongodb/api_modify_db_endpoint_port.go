...
// ModifyDBEndpointPortCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) ModifyDBEndpointPortCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointPortCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBEndpointPortRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) ModifyDBEndpointPortWithContext(ctx byteplus.Context, input *ModifyDBEndpointPortInput, opts ...request.Option) (*ModifyDBEndpointPortOutput, error) {
	req, out := c.ModifyDBEndpointPortRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
