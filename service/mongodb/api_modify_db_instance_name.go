...
// ModifyDBInstanceNameCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) ModifyDBInstanceNameCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceNameCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceNameRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) ModifyDBInstanceNameWithContext(ctx byteplus.Context, input *ModifyDBInstanceNameInput, opts ...request.Option) (*ModifyDBInstanceNameOutput, error) {
	req, out := c.ModifyDBInstanceNameRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
