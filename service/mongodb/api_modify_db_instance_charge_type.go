...
// ModifyDBInstanceChargeTypeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) ModifyDBInstanceChargeTypeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceChargeTypeCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceChargeTypeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) ModifyDBInstanceChargeTypeWithContext(ctx byteplus.Context, input *ModifyDBInstanceChargeTypeInput, opts ...request.Option) (*ModifyDBInstanceChargeTypeOutput, error) {
	req, out := c.ModifyDBInstanceChargeTypeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
