...
// DescribeNormalLogsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeNormalLogsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeNormalLogsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeNormalLogsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeNormalLogsWithContext(ctx byteplus.Context, input *DescribeNormalLogsInput, opts ...request.Option) (*DescribeNormalLogsOutput, error) {
	req, out := c.DescribeNormalLogsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
