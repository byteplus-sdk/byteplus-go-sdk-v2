...
// DescribeDBEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *MONGODB) DescribeDBEndpointCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBEndpointCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBEndpointRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeDBEndpointWithContext(ctx byteplus.Context, input *DescribeDBEndpointInput, opts ...request.Option) (*DescribeDBEndpointOutput, error) {
	req, out := c.DescribeDBEndpointRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
