...
func (c *MONGODB) DescribeDBInstanceSSLCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceSSLCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *MONGODB) DescribeDBInstanceSSLWithContext(ctx byteplus.Context, input *DescribeDBInstanceSSLInput, opts ...request.Option) (*DescribeDBInstanceSSLOutput, error) {
	req, out := c.DescribeDBInstanceSSLRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
