...
// ECOPARTNER provides the API operation methods for making requests to
// ECO_PARTNER. See this package's package overview docs
// for details on the service.
//
// ECOPARTNER methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ECOPARTNER {
	svc := &ECOPARTNER{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ECOPARTNER operation and runs any
// custom request initialization.
func (c *ECOPARTNER) newRequest(op *request.Operation, params, data interface{}) *request.Request {
