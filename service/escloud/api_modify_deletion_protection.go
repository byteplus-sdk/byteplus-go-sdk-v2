...
// ModifyDeletionProtectionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ESCLOUD) ModifyDeletionProtectionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDeletionProtectionCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDeletionProtectionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ESCLOUD) ModifyDeletionProtectionWithContext(ctx byteplus.Context, input *ModifyDeletionProtectionInput, opts ...request.Option) (*ModifyDeletionProtectionOutput, error) {
	req, out := c.ModifyDeletionProtectionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
