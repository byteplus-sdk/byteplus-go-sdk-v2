...
// DescribeInstancePluginsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ESCLOUD) DescribeInstancePluginsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstancePluginsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeInstancePluginsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ESCLOUD) DescribeInstancePluginsWithContext(ctx byteplus.Context, input *DescribeInstancePluginsInput, opts ...request.Option) (*DescribeInstancePluginsOutput, error) {
	req, out := c.DescribeInstancePluginsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
