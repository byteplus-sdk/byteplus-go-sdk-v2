...
// ReleaseInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ESCLOUD) ReleaseInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ReleaseInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// ReleaseInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ESCLOUD) ReleaseInstanceWithContext(ctx byteplus.Context, input *ReleaseInstanceInput, opts ...request.Option) (*ReleaseInstanceOutput, error) {
	req, out := c.ReleaseInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
