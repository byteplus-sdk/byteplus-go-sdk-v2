...
// RenameInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ESCLOUD) RenameInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RenameInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RenameInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ESCLOUD) RenameInstanceWithContext(ctx byteplus.Context, input *RenameInstanceInput, opts ...request.Option) (*RenameInstanceOutput, error) {
	req, out := c.RenameInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
