...
// DescribeIpAllowListCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *ESCLOUD) DescribeIpAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeIpAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeIpAllowListRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ESCLOUD) DescribeIpAllowListWithContext(ctx byteplus.Context, input *DescribeIpAllowListInput, opts ...request.Option) (*DescribeIpAllowListOutput, error) {
	req, out := c.DescribeIpAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
