...
// DescribeSandboxCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSandboxRequest generates a "byteplus/request.Request" representing the
