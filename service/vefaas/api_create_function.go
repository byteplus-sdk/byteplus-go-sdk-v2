...
// CreateFunctionCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateFunctionRequest generates a "byteplus/request.Request" representing the
