...
// DeleteTimerCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteTimerRequest generates a "byteplus/request.Request" representing the
