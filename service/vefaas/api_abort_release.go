...
// AbortReleaseCommonRequest generates a "byteplus/request.Request" representing the
...
// AbortReleaseRequest generates a "byteplus/request.Request" representing the
