...
// GetKafkaTriggerCommonRequest generates a "byteplus/request.Request" representing the
...
// GetKafkaTriggerRequest generates a "byteplus/request.Request" representing the
