...
// DeleteFunctionCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteFunctionRequest generates a "byteplus/request.Request" representing the
