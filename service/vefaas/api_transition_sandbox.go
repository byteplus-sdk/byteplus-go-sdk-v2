...
// TransitionSandboxCommonRequest generates a "byteplus/request.Request" representing the
...
// TransitionSandboxRequest generates a "byteplus/request.Request" representing the
