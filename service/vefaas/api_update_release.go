...
// UpdateReleaseCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateReleaseRequest generates a "byteplus/request.Request" representing the
