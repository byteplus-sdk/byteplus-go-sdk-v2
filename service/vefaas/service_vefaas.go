...
// VEFAAS provides the API operation methods for making requests to
// VEFAAS. See this package's package overview docs
// for details on the service.
//
// VEFAAS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VEFAAS {
	svc := &VEFAAS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VEFAAS operation and runs any
// custom request initialization.
func (c *VEFAAS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
