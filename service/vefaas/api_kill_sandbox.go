...
// KillSandboxCommonRequest generates a "byteplus/request.Request" representing the
...
// KillSandboxRequest generates a "byteplus/request.Request" representing the
