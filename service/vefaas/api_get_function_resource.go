...
// GetFunctionResourceCommonRequest generates a "byteplus/request.Request" representing the
...
// GetFunctionResourceRequest generates a "byteplus/request.Request" representing the
