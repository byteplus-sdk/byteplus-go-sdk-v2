...
// UpdateKafkaTriggerCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateKafkaTriggerRequest generates a "byteplus/request.Request" representing the
