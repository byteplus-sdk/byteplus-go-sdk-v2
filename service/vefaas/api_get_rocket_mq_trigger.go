...
// GetRocketMQTriggerCommonRequest generates a "byteplus/request.Request" representing the
...
// GetRocketMQTriggerRequest generates a "byteplus/request.Request" representing the
