...
// CreateSandboxCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSandboxRequest generates a "byteplus/request.Request" representing the
