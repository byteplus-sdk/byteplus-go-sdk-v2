...
// SetFilesetQosCommonRequest generates a "byteplus/request.Request" representing the
...
// SetFilesetQosRequest generates a "byteplus/request.Request" representing the
