...
// CreateMountServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateMountServiceRequest generates a "byteplus/request.Request" representing the
