...
// CreatePreSignedUrlCommonRequest generates a "byteplus/request.Request" representing the
...
// CreatePreSignedUrlRequest generates a "byteplus/request.Request" representing the
