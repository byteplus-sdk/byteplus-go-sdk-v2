...
// UpdateFilesetCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateFilesetRequest generates a "byteplus/request.Request" representing the
