...
// UpdateAuditCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VEPFS) UpdateAuditCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateAuditCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateAuditRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VEPFS) UpdateAuditWithContext(ctx byteplus.Context, input *UpdateAuditInput, opts ...request.Option) (*UpdateAuditOutput, error) {
	req, out := c.UpdateAuditRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
