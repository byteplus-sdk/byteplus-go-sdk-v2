...
// CreateFilesetCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateFilesetRequest generates a "byteplus/request.Request" representing the
