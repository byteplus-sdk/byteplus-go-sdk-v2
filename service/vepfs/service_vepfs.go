...
// VEPFS provides the API operation methods for making requests to
// VEPFS. See this package's package overview docs
// for details on the service.
//
// VEPFS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VEPFS {
	svc := &VEPFS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VEPFS operation and runs any
// custom request initialization.
func (c *VEPFS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
