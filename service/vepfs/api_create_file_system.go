...
// CreateFileSystemCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateFileSystemRequest generates a "byteplus/request.Request" representing the
