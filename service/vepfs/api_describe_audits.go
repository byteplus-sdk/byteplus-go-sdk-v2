...
// DescribeAuditsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *VEPFS) DescribeAuditsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAuditsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeAuditsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VEPFS) DescribeAuditsWithContext(ctx byteplus.Context, input *DescribeAuditsInput, opts ...request.Option) (*DescribeAuditsOutput, error) {
	req, out := c.DescribeAuditsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
