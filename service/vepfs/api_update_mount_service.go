...
const opUpdateMountServiceCommon = "UpdateMountService"

// UpdateMountServiceCommonRequest generates a "byteplus/request.Request" representing the
// client's request for the UpdateMountServiceCommon operation. The "output" return
// value will be populated with the UpdateMountServiceCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned UpdateMountServiceCommon Request to send the API call to the service.
// the "output" return value is not valid until after UpdateMountServiceCommon Send returns without error.
//
// See UpdateMountServiceCommon for more information on using the UpdateMountServiceCommon
...
func (c *VEPFS) UpdateMountServiceCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opUpdateMountServiceCommon,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}
...
// API operation UpdateMountServiceCommon for usage and error information.
func (c *VEPFS) UpdateMountServiceCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.UpdateMountServiceCommonRequest(input)
	return out, req.Send()
}

// UpdateMountServiceCommonWithContext is the same as UpdateMountServiceCommon with the addition of
...
const opUpdateMountService = "UpdateMountService"

// UpdateMountServiceRequest generates a "byteplus/request.Request" representing the
// client's request for the UpdateMountService operation. The "output" return
// value will be populated with the UpdateMountServiceCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned UpdateMountServiceCommon Request to send the API call to the service.
// the "output" return value is not valid until after UpdateMountServiceCommon Send returns without error.
//
// See UpdateMountService for more information on using the UpdateMountService
// API call, and error handling.
//
...
func (c *VEPFS) UpdateMountServiceRequest(input *UpdateMountServiceInput) (req *request.Request, output *UpdateMountServiceOutput) {
	op := &request.Operation{
		Name:       opUpdateMountService,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}

	if input == nil {
		input = &UpdateMountServiceInput{}
	}

	output = &UpdateMountServiceOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the BYTEPLUS API reference guide for VEPFS's
// API operation UpdateMountService for usage and error information.
func (c *VEPFS) UpdateMountService(input *UpdateMountServiceInput) (*UpdateMountServiceOutput, error) {
	req, out := c.UpdateMountServiceRequest(input)
	return out, req.Send()
}

// UpdateMountServiceWithContext is the same as UpdateMountService with the addition of
// the ability to pass a context and additional request options.
//
