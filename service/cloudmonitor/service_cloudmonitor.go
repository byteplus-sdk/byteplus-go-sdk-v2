...
// CLOUDMONITOR provides the API operation methods for making requests to
// CLOUDMONITOR. See this package's package overview docs
// for details on the service.
//
// CLOUDMONITOR methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDMONITOR {
	svc := &CLOUDMONITOR{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDMONITOR operation and runs any
// custom request initialization.
func (c *CLOUDMONITOR) newRequest(op *request.Operation, params, data interface{}) *request.Request {
