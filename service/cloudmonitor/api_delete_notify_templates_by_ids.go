...
// DeleteNotifyTemplatesByIdsCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNotifyTemplatesByIdsRequest generates a "byteplus/request.Request" representing the
