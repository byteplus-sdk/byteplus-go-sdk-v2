...
// CreateAlertTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateAlertTemplateRequest generates a "byteplus/request.Request" representing the
