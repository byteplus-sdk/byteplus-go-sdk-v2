...
// ListContactGroupByIdsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListContactGroupByIdsRequest generates a "byteplus/request.Request" representing the
