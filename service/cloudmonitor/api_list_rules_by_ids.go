...
// ListRulesByIdsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListRulesByIdsRequest generates a "byteplus/request.Request" representing the
...
func (s *ConditionForListRulesByIdsOutput) SetSubNamespace(v string) *ConditionForListRulesByIdsOutput {
	s.SubNamespace = &v
	return s
}
