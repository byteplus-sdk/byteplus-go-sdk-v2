...
// UpdateNotificationCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateNotificationRequest generates a "byteplus/request.Request" representing the
