...
// CreateContactsCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateContactsRequest generates a "byteplus/request.Request" representing the
