...
// UpdateWebhookCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateWebhookRequest generates a "byteplus/request.Request" representing the
