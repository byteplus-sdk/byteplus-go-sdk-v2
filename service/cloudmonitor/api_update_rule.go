...
// UpdateRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateRuleRequest generates a "byteplus/request.Request" representing the
...
// SetLevel sets the Level field's value.
func (s *NoDataForUpdateRuleInput) SetLevel(v string) *NoDataForUpdateRuleInput {
	s.Level = &v
	return s
}
