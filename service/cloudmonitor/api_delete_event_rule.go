...
// DeleteEventRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteEventRuleRequest generates a "byteplus/request.Request" representing the
