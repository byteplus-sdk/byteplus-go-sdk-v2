...
// SetStateOfRulesByIdsCommonRequest generates a "byteplus/request.Request" representing the
...
// SetStateOfRulesByIdsRequest generates a "byteplus/request.Request" representing the
