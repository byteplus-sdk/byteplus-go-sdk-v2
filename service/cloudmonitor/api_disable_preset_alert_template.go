...
// DisablePresetAlertTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
// DisablePresetAlertTemplateRequest generates a "byteplus/request.Request" representing the
