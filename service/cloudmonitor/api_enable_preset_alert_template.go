...
// EnablePresetAlertTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
// EnablePresetAlertTemplateRequest generates a "byteplus/request.Request" representing the
