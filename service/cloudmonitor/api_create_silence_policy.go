...
// CreateSilencePolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSilencePolicyRequest generates a "byteplus/request.Request" representing the
