...
// CreateEventRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateEventRuleRequest generates a "byteplus/request.Request" representing the
