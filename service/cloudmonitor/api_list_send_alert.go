...
// ListSendAlertCommonRequest generates a "byteplus/request.Request" representing the
...
// ListSendAlertRequest generates a "byteplus/request.Request" representing the
