...
// UpdateContactsCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateContactsRequest generates a "byteplus/request.Request" representing the
