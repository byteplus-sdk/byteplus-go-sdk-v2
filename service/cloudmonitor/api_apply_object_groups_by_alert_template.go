...
// ApplyObjectGroupsByAlertTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
// ApplyObjectGroupsByAlertTemplateRequest generates a "byteplus/request.Request" representing the
