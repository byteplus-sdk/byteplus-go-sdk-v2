...
// CreateWebhookCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateWebhookRequest generates a "byteplus/request.Request" representing the
