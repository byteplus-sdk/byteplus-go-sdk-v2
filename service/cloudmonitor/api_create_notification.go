...
// CreateNotificationCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNotificationRequest generates a "byteplus/request.Request" representing the
