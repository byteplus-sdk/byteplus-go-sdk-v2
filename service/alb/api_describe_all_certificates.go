...
// DescribeAllCertificatesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeAllCertificatesRequest generates a "byteplus/request.Request" representing the
