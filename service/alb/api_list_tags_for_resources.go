...
const (
	// ResourceTypeForListTagsForResourcesInputLoadbalancer is a ResourceTypeForListTagsForResourcesInput enum value
	ResourceTypeForListTagsForResourcesInputLoadbalancer = "loadbalancer"
