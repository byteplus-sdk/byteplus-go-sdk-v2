...
// UploadCACertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// UploadCACertificateRequest generates a "byteplus/request.Request" representing the
