...
// EnableHealthLogCommonRequest generates a "byteplus/request.Request" representing the
...
// EnableHealthLogRequest generates a "byteplus/request.Request" representing the
