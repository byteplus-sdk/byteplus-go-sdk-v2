...
// CreateHealthCheckTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateHealthCheckTemplatesRequest generates a "byteplus/request.Request" representing the
