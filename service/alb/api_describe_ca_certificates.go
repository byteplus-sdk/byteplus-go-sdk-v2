...
// DescribeCACertificatesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeCACertificatesRequest generates a "byteplus/request.Request" representing the
