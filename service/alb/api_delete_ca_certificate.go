...
// DeleteCACertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteCACertificateRequest generates a "byteplus/request.Request" representing the
