...
// DescribeHealthCheckTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeHealthCheckTemplatesRequest generates a "byteplus/request.Request" representing the
