...
// ReplaceCertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// ReplaceCertificateRequest generates a "byteplus/request.Request" representing the
