...
// ModifyHealthCheckTemplatesAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyHealthCheckTemplatesAttributesRequest generates a "byteplus/request.Request" representing the
