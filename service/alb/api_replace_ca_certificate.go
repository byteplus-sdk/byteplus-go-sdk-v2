...
// ReplaceCACertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// ReplaceCACertificateRequest generates a "byteplus/request.Request" representing the
