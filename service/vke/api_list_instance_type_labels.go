...
// ListInstanceTypeLabelsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListInstanceTypeLabelsRequest generates a "byteplus/request.Request" representing the
