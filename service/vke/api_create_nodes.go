...
// CreateNodesCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNodesRequest generates a "byteplus/request.Request" representing the
