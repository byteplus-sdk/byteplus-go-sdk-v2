...
// DeleteClusterCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteClusterRequest generates a "byteplus/request.Request" representing the
