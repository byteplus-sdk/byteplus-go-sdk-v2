...
// UpdateScalingPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateScalingPolicyRequest generates a "byteplus/request.Request" representing the
