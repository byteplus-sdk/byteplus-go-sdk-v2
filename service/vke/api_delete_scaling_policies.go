...
// DeleteScalingPoliciesCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteScalingPoliciesRequest generates a "byteplus/request.Request" representing the
