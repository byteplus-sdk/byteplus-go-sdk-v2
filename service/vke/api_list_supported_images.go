...
// ListSupportedImagesCommonRequest generates a "byteplus/request.Request" representing the
...
// ListSupportedImagesRequest generates a "byteplus/request.Request" representing the
