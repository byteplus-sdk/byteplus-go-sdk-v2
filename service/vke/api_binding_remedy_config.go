...
// BindingRemedyConfigCommonRequest generates a "byteplus/request.Request" representing the
...
// BindingRemedyConfigRequest generates a "byteplus/request.Request" representing the
