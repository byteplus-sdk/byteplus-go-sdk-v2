...
// VKE provides the API operation methods for making requests to
// VKE. See this package's package overview docs
// for details on the service.
//
// VKE methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VKE {
	svc := &VKE{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VKE operation and runs any
// custom request initialization.
func (c *VKE) newRequest(op *request.Operation, params, data interface{}) *request.Request {
