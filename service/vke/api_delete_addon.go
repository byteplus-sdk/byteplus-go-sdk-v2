...
// DeleteAddonCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteAddonRequest generates a "byteplus/request.Request" representing the
