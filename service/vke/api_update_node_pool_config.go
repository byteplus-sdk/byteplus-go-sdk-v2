...
// UpdateNodePoolConfigCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateNodePoolConfigRequest generates a "byteplus/request.Request" representing the
