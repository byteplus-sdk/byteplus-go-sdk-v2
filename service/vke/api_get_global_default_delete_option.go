...
// GetGlobalDefaultDeleteOptionCommonRequest generates a "byteplus/request.Request" representing the
...
// GetGlobalDefaultDeleteOptionRequest generates a "byteplus/request.Request" representing the
