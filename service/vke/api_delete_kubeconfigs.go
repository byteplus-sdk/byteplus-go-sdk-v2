...
// DeleteKubeconfigsCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteKubeconfigsRequest generates a "byteplus/request.Request" representing the
