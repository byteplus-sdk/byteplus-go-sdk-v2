...
// ForwardKubernetesApiCommonRequest generates a "byteplus/request.Request" representing the
...
// ForwardKubernetesApiRequest generates a "byteplus/request.Request" representing the
