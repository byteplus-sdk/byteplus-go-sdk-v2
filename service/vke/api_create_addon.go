...
// CreateAddonCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateAddonRequest generates a "byteplus/request.Request" representing the
