...
// ListSupportedAddonsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListSupportedAddonsRequest generates a "byteplus/request.Request" representing the
