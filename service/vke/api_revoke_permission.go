...
// RevokePermissionCommonRequest generates a "byteplus/request.Request" representing the
...
// RevokePermissionRequest generates a "byteplus/request.Request" representing the
