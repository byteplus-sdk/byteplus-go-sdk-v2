...
// CreateKubeconfigCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateKubeconfigRequest generates a "byteplus/request.Request" representing the
