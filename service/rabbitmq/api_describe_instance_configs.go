...
// DescribeInstanceConfigsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) DescribeInstanceConfigsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstanceConfigsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeInstanceConfigsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) DescribeInstanceConfigsWithContext(ctx byteplus.Context, input *DescribeInstanceConfigsInput, opts ...request.Option) (*DescribeInstanceConfigsOutput, error) {
	req, out := c.DescribeInstanceConfigsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
