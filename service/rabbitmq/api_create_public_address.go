...
// CreatePublicAddressCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) CreatePublicAddressCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreatePublicAddressCommonRequest(input)
	req.SetContext(ctx)
...
// CreatePublicAddressRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) CreatePublicAddressWithContext(ctx byteplus.Context, input *CreatePublicAddressInput, opts ...request.Option) (*CreatePublicAddressOutput, error) {
	req, out := c.CreatePublicAddressRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
