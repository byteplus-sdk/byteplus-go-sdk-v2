...
// ModifyInstanceAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) ModifyInstanceAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyInstanceAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyInstanceAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) ModifyInstanceAttributesWithContext(ctx byteplus.Context, input *ModifyInstanceAttributesInput, opts ...request.Option) (*ModifyInstanceAttributesOutput, error) {
	req, out := c.ModifyInstanceAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
