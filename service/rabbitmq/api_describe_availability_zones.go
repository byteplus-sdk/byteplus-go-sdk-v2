...
// DescribeAvailabilityZonesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) DescribeAvailabilityZonesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAvailabilityZonesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeAvailabilityZonesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) DescribeAvailabilityZonesWithContext(ctx byteplus.Context, input *DescribeAvailabilityZonesInput, opts ...request.Option) (*DescribeAvailabilityZonesOutput, error) {
	req, out := c.DescribeAvailabilityZonesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
