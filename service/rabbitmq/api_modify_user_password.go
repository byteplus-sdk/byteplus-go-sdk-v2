...
func (c *RABBITMQ) ModifyUserPasswordCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyUserPasswordCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) ModifyUserPasswordWithContext(ctx byteplus.Context, input *ModifyUserPasswordInput, opts ...request.Option) (*ModifyUserPasswordOutput, error) {
	req, out := c.ModifyUserPasswordRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
