...
// DescribeTagsByResourceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) DescribeTagsByResourceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTagsByResourceCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTagsByResourceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) DescribeTagsByResourceWithContext(ctx byteplus.Context, input *DescribeTagsByResourceInput, opts ...request.Option) (*DescribeTagsByResourceOutput, error) {
	req, out := c.DescribeTagsByResourceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
