...
func (c *RABBITMQ) DescribeInstanceDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstanceDetailCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) DescribeInstanceDetailWithContext(ctx byteplus.Context, input *DescribeInstanceDetailInput, opts ...request.Option) (*DescribeInstanceDetailOutput, error) {
	req, out := c.DescribeInstanceDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
