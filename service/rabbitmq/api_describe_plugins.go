...
// DescribePluginsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) DescribePluginsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribePluginsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribePluginsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) DescribePluginsWithContext(ctx byteplus.Context, input *DescribePluginsInput, opts ...request.Option) (*DescribePluginsOutput, error) {
	req, out := c.DescribePluginsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
