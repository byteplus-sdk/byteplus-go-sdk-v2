...
func (c *RABBITMQ) RestartInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RestartInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) RestartInstanceWithContext(ctx byteplus.Context, input *RestartInstanceInput, opts ...request.Option) (*RestartInstanceOutput, error) {
	req, out := c.RestartInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
