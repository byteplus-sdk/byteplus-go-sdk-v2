...
// ModifyPluginCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RABBITMQ) ModifyPluginCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyPluginCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyPluginRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RABBITMQ) ModifyPluginWithContext(ctx byteplus.Context, input *ModifyPluginInput, opts ...request.Option) (*ModifyPluginOutput, error) {
	req, out := c.ModifyPluginRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
