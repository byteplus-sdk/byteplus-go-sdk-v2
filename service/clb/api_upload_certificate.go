...
// UploadCertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// UploadCertificateRequest generates a "byteplus/request.Request" representing the
