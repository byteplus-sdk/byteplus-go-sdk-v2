...
// CreateRulesCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateRulesRequest generates a "byteplus/request.Request" representing the
