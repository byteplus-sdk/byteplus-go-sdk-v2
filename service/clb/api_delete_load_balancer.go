...
// DeleteLoadBalancerCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteLoadBalancerRequest generates a "byteplus/request.Request" representing the
