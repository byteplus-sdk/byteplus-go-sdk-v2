...
// DescribeRulesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeRulesRequest generates a "byteplus/request.Request" representing the
