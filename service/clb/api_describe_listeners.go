...
// DescribeListenersCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeListenersRequest generates a "byteplus/request.Request" representing the
