...
// RenewLoadBalancerCommonRequest generates a "byteplus/request.Request" representing the
...
// RenewLoadBalancerRequest generates a "byteplus/request.Request" representing the
