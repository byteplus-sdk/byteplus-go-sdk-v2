...
// DeleteNLBListenerCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNLBListenerRequest generates a "byteplus/request.Request" representing the
