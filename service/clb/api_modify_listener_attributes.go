...
// ModifyListenerAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyListenerAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyListenerAttributesInput) SetCAEnabled(v string) *ModifyListenerAttributesInput {
	s.CAEnabled = &v
	return s
}
