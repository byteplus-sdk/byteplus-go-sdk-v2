...
// DescribeNLBListenersCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNLBListenersRequest generates a "byteplus/request.Request" representing the
