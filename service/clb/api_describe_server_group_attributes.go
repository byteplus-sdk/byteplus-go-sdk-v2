...
// DescribeServerGroupAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeServerGroupAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *DescribeServerGroupAttributesOutput) SetAnyPortEnabled(v string) *DescribeServerGroupAttributesOutput {
	s.AnyPortEnabled = &v
	return s
}
