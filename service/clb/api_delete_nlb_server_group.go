...
// DeleteNLBServerGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNLBServerGroupRequest generates a "byteplus/request.Request" representing the
