...
// DescribeServerGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeServerGroupsRequest generates a "byteplus/request.Request" representing the
