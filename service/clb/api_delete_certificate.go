...
// DeleteCertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteCertificateRequest generates a "byteplus/request.Request" representing the
