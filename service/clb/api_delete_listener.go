...
// DeleteListenerCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteListenerRequest generates a "byteplus/request.Request" representing the
