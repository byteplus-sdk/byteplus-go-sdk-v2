...
// DeleteServerGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteServerGroupRequest generates a "byteplus/request.Request" representing the
