...
// DeleteNLBSecurityPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNLBSecurityPolicyRequest generates a "byteplus/request.Request" representing the
