...
// DeleteRulesCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteRulesRequest generates a "byteplus/request.Request" representing the
