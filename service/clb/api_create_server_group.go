...
// CreateServerGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateServerGroupRequest generates a "byteplus/request.Request" representing the
