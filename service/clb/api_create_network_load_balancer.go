...
// CreateNetworkLoadBalancerCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNetworkLoadBalancerRequest generates a "byteplus/request.Request" representing the
