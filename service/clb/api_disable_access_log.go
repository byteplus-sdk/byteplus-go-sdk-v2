...
// DisableAccessLogCommonRequest generates a "byteplus/request.Request" representing the
...
// DisableAccessLogRequest generates a "byteplus/request.Request" representing the
