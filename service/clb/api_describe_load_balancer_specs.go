...
// DescribeLoadBalancerSpecsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeLoadBalancerSpecsRequest generates a "byteplus/request.Request" representing the
