...
// DescribeCertificatesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeCertificatesRequest generates a "byteplus/request.Request" representing the
