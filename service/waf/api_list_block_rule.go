...
// ListBlockRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// ListBlockRuleRequest generates a "byteplus/request.Request" representing the
