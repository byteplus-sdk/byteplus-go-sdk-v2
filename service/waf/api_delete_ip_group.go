...
// DeleteIpGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteIpGroupRequest generates a "byteplus/request.Request" representing the
