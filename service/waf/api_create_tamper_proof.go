...
// CreateTamperProofCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateTamperProofRequest generates a "byteplus/request.Request" representing the
