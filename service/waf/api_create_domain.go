...
// CreateDomainCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDomainRequest generates a "byteplus/request.Request" representing the
