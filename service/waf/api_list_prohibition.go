...
// ListProhibitionCommonRequest generates a "byteplus/request.Request" representing the
...
// ListProhibitionRequest generates a "byteplus/request.Request" representing the
