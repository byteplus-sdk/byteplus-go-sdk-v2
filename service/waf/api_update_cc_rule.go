...
// UpdateCCRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateCCRuleRequest generates a "byteplus/request.Request" representing the
