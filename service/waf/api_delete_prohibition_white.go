...
// DeleteProhibitionWhiteCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteProhibitionWhiteRequest generates a "byteplus/request.Request" representing the
