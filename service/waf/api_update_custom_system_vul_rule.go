...
// UpdateCustomSystemVulRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateCustomSystemVulRuleRequest generates a "byteplus/request.Request" representing the
