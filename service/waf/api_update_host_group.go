...
// UpdateHostGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateHostGroupRequest generates a "byteplus/request.Request" representing the
