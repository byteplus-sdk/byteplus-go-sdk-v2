...
// ListWafServiceCertificateCommonRequest generates a "byteplus/request.Request" representing the
...
// ListWafServiceCertificateRequest generates a "byteplus/request.Request" representing the
