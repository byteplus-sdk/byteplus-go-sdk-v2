...
// AddHostGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// AddHostGroupRequest generates a "byteplus/request.Request" representing the
