...
// QueryCertificateIfReplaceCommonRequest generates a "byteplus/request.Request" representing the
...
// QueryCertificateIfReplaceRequest generates a "byteplus/request.Request" representing the
