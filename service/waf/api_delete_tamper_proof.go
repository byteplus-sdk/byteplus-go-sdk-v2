...
// DeleteTamperProofCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteTamperProofRequest generates a "byteplus/request.Request" representing the
