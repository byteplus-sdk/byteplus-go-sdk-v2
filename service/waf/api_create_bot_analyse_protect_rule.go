...
// CreateBotAnalyseProtectRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateBotAnalyseProtectRuleRequest generates a "byteplus/request.Request" representing the
