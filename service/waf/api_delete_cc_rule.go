...
// DeleteCCRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteCCRuleRequest generates a "byteplus/request.Request" representing the
