...
// CreateVulWhiteFieldCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateVulWhiteFieldRequest generates a "byteplus/request.Request" representing the
