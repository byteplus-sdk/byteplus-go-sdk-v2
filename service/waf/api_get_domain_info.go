...
// GetDomainInfoCommonRequest generates a "byteplus/request.Request" representing the
...
// GetDomainInfoRequest generates a "byteplus/request.Request" representing the
