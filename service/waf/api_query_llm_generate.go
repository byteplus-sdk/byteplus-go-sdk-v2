...
// QueryLLMGenerateCommonRequest generates a "byteplus/request.Request" representing the
...
// QueryLLMGenerateRequest generates a "byteplus/request.Request" representing the
