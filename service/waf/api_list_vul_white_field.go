...
// ListVulWhiteFieldCommonRequest generates a "byteplus/request.Request" representing the
...
// ListVulWhiteFieldRequest generates a "byteplus/request.Request" representing the
