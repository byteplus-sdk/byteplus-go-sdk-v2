...
// DeleteProhibitionBlackCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteProhibitionBlackRequest generates a "byteplus/request.Request" representing the
