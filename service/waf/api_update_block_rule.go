...
// UpdateBlockRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateBlockRuleRequest generates a "byteplus/request.Request" representing the
