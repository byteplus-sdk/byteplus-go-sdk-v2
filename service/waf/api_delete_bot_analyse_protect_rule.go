...
// DeleteBotAnalyseProtectRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteBotAnalyseProtectRuleRequest generates a "byteplus/request.Request" representing the
