...
// AddProhibitionBlackCommonRequest generates a "byteplus/request.Request" representing the
...
// AddProhibitionBlackRequest generates a "byteplus/request.Request" representing the
