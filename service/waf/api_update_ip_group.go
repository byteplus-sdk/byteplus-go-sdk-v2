...
// UpdateIpGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateIpGroupRequest generates a "byteplus/request.Request" representing the
