...
// AddProhibitionWhiteCommonRequest generates a "byteplus/request.Request" representing the
...
// AddProhibitionWhiteRequest generates a "byteplus/request.Request" representing the
