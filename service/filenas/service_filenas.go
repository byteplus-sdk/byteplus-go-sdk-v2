...
// FILENAS provides the API operation methods for making requests to
// FILENAS. See this package's package overview docs
// for details on the service.
//
// FILENAS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *FILENAS {
	svc := &FILENAS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a FILENAS operation and runs any
// custom request initialization.
func (c *FILENAS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
