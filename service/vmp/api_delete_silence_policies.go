...
// DeleteSilencePoliciesCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteSilencePoliciesRequest generates a "byteplus/request.Request" representing the
