...
// CreateRuleFileCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateRuleFileRequest generates a "byteplus/request.Request" representing the
