...
// GetIntegrationTaskCommonRequest generates a "byteplus/request.Request" representing the
...
// GetIntegrationTaskRequest generates a "byteplus/request.Request" representing the
