...
const opGetRuleFileCommon = "GetRuleFile"

// GetRuleFileCommonRequest generates a "byteplus/request.Request" representing the
// client's request for the GetRuleFileCommon operation. The "output" return
// value will be populated with the GetRuleFileCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned GetRuleFileCommon Request to send the API call to the service.
// the "output" return value is not valid until after GetRuleFileCommon Send returns without error.
//
// See GetRuleFileCommon for more information on using the GetRuleFileCommon
...
// API operation GetRuleFileCommon for usage and error information.
func (c *VMP) GetRuleFileCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.GetRuleFileCommonRequest(input)
	return out, req.Send()
}

// GetRuleFileCommonWithContext is the same as GetRuleFileCommon with the addition of
...
const opGetRuleFile = "GetRuleFile"

// GetRuleFileRequest generates a "byteplus/request.Request" representing the
// client's request for the GetRuleFile operation. The "output" return
// value will be populated with the GetRuleFileCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned GetRuleFileCommon Request to send the API call to the service.
// the "output" return value is not valid until after GetRuleFileCommon Send returns without error.
//
// See GetRuleFile for more information on using the GetRuleFile
// API call, and error handling.
//
...
func (c *VMP) GetRuleFileRequest(input *GetRuleFileInput) (req *request.Request, output *GetRuleFileOutput) {
	...
	if input == nil {
		input = &GetRuleFileInput{}
	}

	output = &GetRuleFileOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the BYTEPLUS API reference guide for VMP's
// API operation GetRuleFile for usage and error information.
func (c *VMP) GetRuleFile(input *GetRuleFileInput) (*GetRuleFileOutput, error) {
	req, out := c.GetRuleFileRequest(input)
	return out, req.Send()
}

// GetRuleFileWithContext is the same as GetRuleFile with the addition of
// the ability to pass a context and additional request options.
//
...
func (s *GetRuleFileInput) SetId(v string) *GetRuleFileInput {
	s.Id = &v
	return s
}
...
// SetId sets the Id field's value.
func (s *GetRuleFileOutput) SetId(v string) *GetRuleFileOutput {
	s.Id = &v
	return s
}
...
// SetName sets the Name field's value.
func (s *GetRuleFileOutput) SetName(v string) *GetRuleFileOutput {
	s.Name = &v
	return s
}
