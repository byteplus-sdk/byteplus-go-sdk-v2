...
// CreateAlertingRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateAlertingRuleRequest generates a "byteplus/request.Request" representing the
