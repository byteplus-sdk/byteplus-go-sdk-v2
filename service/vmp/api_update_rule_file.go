...
// UpdateRuleFileCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateRuleFileRequest generates a "byteplus/request.Request" representing the
