...
// CreateIntegrationTaskCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateIntegrationTaskRequest generates a "byteplus/request.Request" representing the
