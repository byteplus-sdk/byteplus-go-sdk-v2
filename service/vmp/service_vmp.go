...
// VMP provides the API operation methods for making requests to
// VMP. See this package's package overview docs
// for details on the service.
//
// VMP methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VMP {
	svc := &VMP{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VMP operation and runs any
// custom request initialization.
func (c *VMP) newRequest(op *request.Operation, params, data interface{}) *request.Request {
