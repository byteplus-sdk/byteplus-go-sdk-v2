...
// ListRuleFilesCommonRequest generates a "byteplus/request.Request" representing the
...
// ListRuleFilesRequest generates a "byteplus/request.Request" representing the
