...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) DownloadSSLCertificateCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DownloadSSLCertificateCommon API operation for RDS_MSSQL.
//
...
func (c *RDSMSSQL) DownloadSSLCertificateCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RDSMSSQL) DownloadSSLCertificateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DownloadSSLCertificateCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) DownloadSSLCertificateRequest(input *DownloadSSLCertificateInput) (req *request.Request, output *DownloadSSLCertificateOutput) {
	op := &request.Operation{
...
// DownloadSSLCertificate API operation for RDS_MSSQL.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RDSMSSQL) DownloadSSLCertificate(input *DownloadSSLCertificateInput) (*DownloadSSLCertificateOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) DownloadSSLCertificateWithContext(ctx byteplus.Context, input *DownloadSSLCertificateInput, opts ...request.Option) (*DownloadSSLCertificateOutput, error) {
	req, out := c.DownloadSSLCertificateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
