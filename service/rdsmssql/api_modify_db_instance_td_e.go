...
func (c *RDSMSSQL) ModifyDBInstanceTDECommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceTDECommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) ModifyDBInstanceTDEWithContext(ctx byteplus.Context, input *ModifyDBInstanceTDEInput, opts ...request.Option) (*ModifyDBInstanceTDEOutput, error) {
	req, out := c.ModifyDBInstanceTDERequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
