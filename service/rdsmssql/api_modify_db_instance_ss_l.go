...
// ModifyDBInstanceSSLCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) ModifyDBInstanceSSLCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ModifyDBInstanceSSLCommon API operation for RDS_MSSQL.
//
...
func (c *RDSMSSQL) ModifyDBInstanceSSLCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RDSMSSQL) ModifyDBInstanceSSLCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceSSLCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceSSLRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) ModifyDBInstanceSSLRequest(input *ModifyDBInstanceSSLInput) (req *request.Request, output *ModifyDBInstanceSSLOutput) {
	op := &request.Operation{
...
// ModifyDBInstanceSSL API operation for RDS_MSSQL.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RDSMSSQL) ModifyDBInstanceSSL(input *ModifyDBInstanceSSLInput) (*ModifyDBInstanceSSLOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) ModifyDBInstanceSSLWithContext(ctx byteplus.Context, input *ModifyDBInstanceSSLInput, opts ...request.Option) (*ModifyDBInstanceSSLOutput, error) {
	req, out := c.ModifyDBInstanceSSLRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *ModifyDBInstanceSSLInput) SetCertificate(v string) *ModifyDBInstanceSSLInput {
	s.Certificate = &v
	return s
}
...
func (s *ModifyDBInstanceSSLInput) SetPassword(v string) *ModifyDBInstanceSSLInput {
	s.Password = &v
	return s
}

// SetType sets the Type field's value.
func (s *ModifyDBInstanceSSLInput) SetType(v string) *ModifyDBInstanceSSLInput {
	s.Type = &v
	return s
}
