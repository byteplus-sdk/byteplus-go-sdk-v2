...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) DescribeDBInstanceSSLCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DescribeDBInstanceSSLCommon API operation for RDS_MSSQL.
//
...
func (c *RDSMSSQL) DescribeDBInstanceSSLCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RDSMSSQL) DescribeDBInstanceSSLCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceSSLCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RDSMSSQL) DescribeDBInstanceSSLRequest(input *DescribeDBInstanceSSLInput) (req *request.Request, output *DescribeDBInstanceSSLOutput) {
	op := &request.Operation{
...
// DescribeDBInstanceSSL API operation for RDS_MSSQL.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RDSMSSQL) DescribeDBInstanceSSL(input *DescribeDBInstanceSSLInput) (*DescribeDBInstanceSSLOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) DescribeDBInstanceSSLWithContext(ctx byteplus.Context, input *DescribeDBInstanceSSLInput, opts ...request.Option) (*DescribeDBInstanceSSLOutput, error) {
	req, out := c.DescribeDBInstanceSSLRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type DescribeDBInstanceSSLOutput struct {
	...
	RequireUpdate *bool `type:"boolean" json:",omitempty"`
...
func (s *DescribeDBInstanceSSLOutput) SetCertType(v string) *DescribeDBInstanceSSLOutput {
	s.CertType = &v
	return s
}

// SetForceEncryption sets the ForceEncryption field's value.
func (s *DescribeDBInstanceSSLOutput) SetForceEncryption(v bool) *DescribeDBInstanceSSLOutput {
	s.ForceEncryption = &v
	return s
}
...
// SetRequireUpdate sets the RequireUpdate field's value.
func (s *DescribeDBInstanceSSLOutput) SetRequireUpdate(v bool) *DescribeDBInstanceSSLOutput {
	s.RequireUpdate = &v
	return s
}
