...
func (c *RDSMSSQL) ResetDBAccountCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ResetDBAccountCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) ResetDBAccountWithContext(ctx byteplus.Context, input *ResetDBAccountInput, opts ...request.Option) (*ResetDBAccountOutput, error) {
	req, out := c.ResetDBAccountRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
