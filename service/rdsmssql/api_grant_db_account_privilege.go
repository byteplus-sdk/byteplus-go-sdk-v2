...
func (c *RDSMSSQL) GrantDBAccountPrivilegeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GrantDBAccountPrivilegeCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) GrantDBAccountPrivilegeWithContext(ctx byteplus.Context, input *GrantDBAccountPrivilegeInput, opts ...request.Option) (*GrantDBAccountPrivilegeOutput, error) {
	req, out := c.GrantDBAccountPrivilegeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
