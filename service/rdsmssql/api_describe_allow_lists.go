...
func (c *RDSMSSQL) DescribeAllowListsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAllowListsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) DescribeAllowListsWithContext(ctx byteplus.Context, input *DescribeAllowListsInput, opts ...request.Option) (*DescribeAllowListsOutput, error) {
	req, out := c.DescribeAllowListsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
