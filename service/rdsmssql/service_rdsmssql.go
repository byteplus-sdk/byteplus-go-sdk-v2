...
// RDSMSSQL provides the API operation methods for making requests to
// RDS_MSSQL. See this package's package overview docs
// for details on the service.
//
// RDSMSSQL methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *RDSMSSQL {
	svc := &RDSMSSQL{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a RDSMSSQL operation and runs any
// custom request initialization.
func (c *RDSMSSQL) newRequest(op *request.Operation, params, data interface{}) *request.Request {
