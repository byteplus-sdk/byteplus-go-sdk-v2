...
// DescribeInstanceAllowListsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMSSQL) DescribeInstanceAllowListsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstanceAllowListsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeInstanceAllowListsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) DescribeInstanceAllowListsWithContext(ctx byteplus.Context, input *DescribeInstanceAllowListsInput, opts ...request.Option) (*DescribeInstanceAllowListsOutput, error) {
	req, out := c.DescribeInstanceAllowListsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
