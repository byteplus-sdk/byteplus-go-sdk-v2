...
func (c *RDSMSSQL) DescribeDBAccountsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBAccountsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMSSQL) DescribeDBAccountsWithContext(ctx byteplus.Context, input *DescribeDBAccountsInput, opts ...request.Option) (*DescribeDBAccountsOutput, error) {
	req, out := c.DescribeDBAccountsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
