...
// ECS20251101 provides the API operation methods for making requests to
// ECS20251101. See this package's package overview docs
// for details on the service.
//
// ECS20251101 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type ECS20251101 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *ECS20251101 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ECS20251101 {
	svc := &ECS20251101{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ECS20251101 operation and runs any
// custom request initialization.
func (c *ECS20251101) newRequest(op *request.Operation, params, data interface{}) *request.Request {
