...
// DeleteImagesCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) DeleteImagesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeleteImagesCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) DeleteImagesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) DeleteImagesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteImagesCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteImagesRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) DeleteImagesRequest(input *DeleteImagesInput) (req *request.Request, output *DeleteImagesOutput) {
	op := &request.Operation{
		Name:       opDeleteImages,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// DeleteImages API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) DeleteImages(input *DeleteImagesInput) (*DeleteImagesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) DeleteImagesWithContext(ctx byteplus.Context, input *DeleteImagesInput, opts ...request.Option) (*DeleteImagesOutput, error) {
	req, out := c.DeleteImagesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
