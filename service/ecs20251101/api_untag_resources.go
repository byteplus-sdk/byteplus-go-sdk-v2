...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) UntagResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UntagResourcesCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) UntagResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) UntagResourcesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UntagResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) UntagResourcesRequest(input *UntagResourcesInput) (req *request.Request, output *UntagResourcesOutput) {
	op := &request.Operation{
...
// UntagResources API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) UntagResources(input *UntagResourcesInput) (*UntagResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) UntagResourcesWithContext(ctx byteplus.Context, input *UntagResourcesInput, opts ...request.Option) (*UntagResourcesOutput, error) {
	req, out := c.UntagResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
