...
// ReplaceSystemVolumeCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ReplaceSystemVolumeCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ReplaceSystemVolumeCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) ReplaceSystemVolumeCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) ReplaceSystemVolumeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ReplaceSystemVolumeCommonRequest(input)
	req.SetContext(ctx)
...
// ReplaceSystemVolumeRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ReplaceSystemVolumeRequest(input *ReplaceSystemVolumeInput) (req *request.Request, output *ReplaceSystemVolumeOutput) {
	op := &request.Operation{
...
// ReplaceSystemVolume API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) ReplaceSystemVolume(input *ReplaceSystemVolumeInput) (*ReplaceSystemVolumeOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) ReplaceSystemVolumeWithContext(ctx byteplus.Context, input *ReplaceSystemVolumeInput, opts ...request.Option) (*ReplaceSystemVolumeOutput, error) {
	req, out := c.ReplaceSystemVolumeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
