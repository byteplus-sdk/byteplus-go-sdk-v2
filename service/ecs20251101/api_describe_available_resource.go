...
// DescribeAvailableResourceCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) DescribeAvailableResourceCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DescribeAvailableResourceCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) DescribeAvailableResourceCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) DescribeAvailableResourceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAvailableResourceCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeAvailableResourceRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) DescribeAvailableResourceRequest(input *DescribeAvailableResourceInput) (req *request.Request, output *DescribeAvailableResourceOutput) {
	op := &request.Operation{
...
// DescribeAvailableResource API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) DescribeAvailableResource(input *DescribeAvailableResourceInput) (*DescribeAvailableResourceOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) DescribeAvailableResourceWithContext(ctx byteplus.Context, input *DescribeAvailableResourceInput, opts ...request.Option) (*DescribeAvailableResourceOutput, error) {
	req, out := c.DescribeAvailableResourceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
