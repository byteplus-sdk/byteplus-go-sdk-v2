...
// ImportImageCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ImportImageCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ImportImageCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) ImportImageCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) ImportImageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ImportImageCommonRequest(input)
	req.SetContext(ctx)
...
// ImportImageRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ImportImageRequest(input *ImportImageInput) (req *request.Request, output *ImportImageOutput) {
	op := &request.Operation{
		Name:       opImportImage,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// ImportImage API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) ImportImage(input *ImportImageInput) (*ImportImageOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) ImportImageWithContext(ctx byteplus.Context, input *ImportImageInput, opts ...request.Option) (*ImportImageOutput, error) {
	req, out := c.ImportImageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
