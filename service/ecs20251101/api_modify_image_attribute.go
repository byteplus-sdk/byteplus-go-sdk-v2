...
// ModifyImageAttributeCommonRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ModifyImageAttributeCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ModifyImageAttributeCommon API operation for ECS20251101.
//
...
func (c *ECS20251101) ModifyImageAttributeCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ECS20251101) ModifyImageAttributeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyImageAttributeCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyImageAttributeRequest generates a "byteplus/request.Request" representing the
...
//        fmt.Println(resp)
//    }
func (c *ECS20251101) ModifyImageAttributeRequest(input *ModifyImageAttributeInput) (req *request.Request, output *ModifyImageAttributeOutput) {
	op := &request.Operation{
...
// ModifyImageAttribute API operation for ECS20251101.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ECS20251101) ModifyImageAttribute(input *ModifyImageAttributeInput) (*ModifyImageAttributeOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS20251101) ModifyImageAttributeWithContext(ctx byteplus.Context, input *ModifyImageAttributeInput, opts ...request.Option) (*ModifyImageAttributeOutput, error) {
	req, out := c.ModifyImageAttributeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
