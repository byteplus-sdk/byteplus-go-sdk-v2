...
// StopContinuousBackupCommonRequest generates a "byteplus/request.Request" representing the
...
// StopContinuousBackupRequest generates a "byteplus/request.Request" representing the
