...
// DeleteBlueGreenDeploymentCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *REDIS) DeleteBlueGreenDeploymentCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteBlueGreenDeploymentCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteBlueGreenDeploymentRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *REDIS) DeleteBlueGreenDeploymentWithContext(ctx byteplus.Context, input *DeleteBlueGreenDeploymentInput, opts ...request.Option) (*DeleteBlueGreenDeploymentOutput, error) {
	req, out := c.DeleteBlueGreenDeploymentRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
