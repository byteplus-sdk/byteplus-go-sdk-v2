...
func (s *ModifyPlannedEventExecuteTimeInput) Validate() error {
	...
	if s.TargetEndTime == nil {
		invalidParams.Add(request.NewErrParamRequired("TargetEndTime"))
	}
	if s.TargetStartTime == nil {
		invalidParams.Add(request.NewErrParamRequired("TargetStartTime"))
	}
...
func (s *ModifyPlannedEventExecuteTimeInput) SetClientToken(v string) *ModifyPlannedEventExecuteTimeInput {
	s.ClientToken = &v
	return s
}

// SetEventIds sets the EventIds field's value.
func (s *ModifyPlannedEventExecuteTimeInput) SetEventIds(v []*string) *ModifyPlannedEventExecuteTimeInput {
	s.EventIds = v
	return s
}

// SetTargetEndTime sets the TargetEndTime field's value.
func (s *ModifyPlannedEventExecuteTimeInput) SetTargetEndTime(v string) *ModifyPlannedEventExecuteTimeInput {
	s.TargetEndTime = &v
	return s
}

// SetTargetStartTime sets the TargetStartTime field's value.
func (s *ModifyPlannedEventExecuteTimeInput) SetTargetStartTime(v string) *ModifyPlannedEventExecuteTimeInput {
	s.TargetStartTime = &v
	return s
}
