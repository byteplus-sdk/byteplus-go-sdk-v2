...
// RestartDBInstanceProxyCommonRequest generates a "byteplus/request.Request" representing the
...
// RestartDBInstanceProxyRequest generates a "byteplus/request.Request" representing the
