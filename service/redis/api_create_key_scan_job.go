...
// CreateKeyScanJobCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateKeyScanJobRequest generates a "byteplus/request.Request" representing the
