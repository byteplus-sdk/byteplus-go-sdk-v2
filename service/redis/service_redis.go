...
// REDIS provides the API operation methods for making requests to
// REDIS. See this package's package overview docs
// for details on the service.
//
// REDIS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *REDIS {
	svc := &REDIS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a REDIS operation and runs any
// custom request initialization.
func (c *REDIS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
