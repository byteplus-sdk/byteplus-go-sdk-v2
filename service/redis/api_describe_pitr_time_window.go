...
// DescribePitrTimeWindowCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribePitrTimeWindowRequest generates a "byteplus/request.Request" representing the
