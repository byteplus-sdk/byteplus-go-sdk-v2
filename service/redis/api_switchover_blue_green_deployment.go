...
// SwitchoverBlueGreenDeploymentCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *REDIS) SwitchoverBlueGreenDeploymentCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchoverBlueGreenDeploymentCommonRequest(input)
	req.SetContext(ctx)
...
// SwitchoverBlueGreenDeploymentRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *REDIS) SwitchoverBlueGreenDeploymentWithContext(ctx byteplus.Context, input *SwitchoverBlueGreenDeploymentInput, opts ...request.Option) (*SwitchoverBlueGreenDeploymentOutput, error) {
	req, out := c.SwitchoverBlueGreenDeploymentRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
