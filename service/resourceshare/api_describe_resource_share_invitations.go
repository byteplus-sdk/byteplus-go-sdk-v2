...
// DescribeResourceShareInvitationsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeResourceShareInvitationsRequest generates a "byteplus/request.Request" representing the
...
type DescribeResourceShareInvitationsInput struct {
	...
	// ResourceShareTrns is a required field
...
func (s *DescribeResourceShareInvitationsInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "DescribeResourceShareInvitationsInput"}
	if s.ResourceShareTrns == nil {
		invalidParams.Add(request.NewErrParamRequired("ResourceShareTrns"))
	}
