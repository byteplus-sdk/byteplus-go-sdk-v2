...
// GetPermissionCommonRequest generates a "byteplus/request.Request" representing the
...
// GetPermissionRequest generates a "byteplus/request.Request" representing the
