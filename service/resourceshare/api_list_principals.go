...
// ListPrincipalsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListPrincipalsRequest generates a "byteplus/request.Request" representing the
