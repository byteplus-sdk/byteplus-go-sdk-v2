...
// AssociateResourceShareCommonRequest generates a "byteplus/request.Request" representing the
...
// AssociateResourceShareRequest generates a "byteplus/request.Request" representing the
