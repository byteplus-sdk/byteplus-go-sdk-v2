...
// DescribeResourceSharesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeResourceSharesRequest generates a "byteplus/request.Request" representing the
