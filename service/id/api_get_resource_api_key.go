...
// GetResourceApiKeyCommonRequest generates a "byteplus/request.Request" representing the
...
// GetResourceApiKeyRequest generates a "byteplus/request.Request" representing the
