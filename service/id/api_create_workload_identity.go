...
// CreateWorkloadIdentityCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateWorkloadIdentityRequest generates a "byteplus/request.Request" representing the
...
func (s *CreateWorkloadIdentityOutput) SetSource(v string) *CreateWorkloadIdentityOutput {
	s.Source = &v
	return s
}
