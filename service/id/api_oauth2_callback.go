...
// Oauth2CallbackCommonRequest generates a "byteplus/request.Request" representing the
...
// Oauth2CallbackRequest generates a "byteplus/request.Request" representing the
