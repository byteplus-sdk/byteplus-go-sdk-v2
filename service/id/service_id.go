...
// ID provides the API operation methods for making requests to
// ID. See this package's package overview docs
// for details on the service.
//
// ID methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ID {
	svc := &ID{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ID operation and runs any
// custom request initialization.
func (c *ID) newRequest(op *request.Operation, params, data interface{}) *request.Request {
