...
// GetInboundAuthConfigCommonRequest generates a "byteplus/request.Request" representing the
...
// GetInboundAuthConfigRequest generates a "byteplus/request.Request" representing the
...
func (s *ApiKeyMetadataForGetInboundAuthConfigOutput) SetPrefix(v string) *ApiKeyMetadataForGetInboundAuthConfigOutput {
	s.Prefix = &v
	return s
}
