...
// CreateUserPoolClientCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUserPoolClientRequest generates a "byteplus/request.Request" representing the
