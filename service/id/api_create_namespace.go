...
// CreateNamespaceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNamespaceRequest generates a "byteplus/request.Request" representing the
