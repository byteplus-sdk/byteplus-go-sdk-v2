...
// GetNamespaceCommonRequest generates a "byteplus/request.Request" representing the
...
// GetNamespaceRequest generates a "byteplus/request.Request" representing the
