...
// CreateUsersCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUsersRequest generates a "byteplus/request.Request" representing the
