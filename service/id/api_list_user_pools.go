...
// ListUserPoolsCommonRequest generates a "byteplus/request.Request" representing the
...
// ListUserPoolsRequest generates a "byteplus/request.Request" representing the
