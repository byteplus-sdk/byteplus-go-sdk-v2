...
// DeleteUserPoolCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteUserPoolRequest generates a "byteplus/request.Request" representing the
