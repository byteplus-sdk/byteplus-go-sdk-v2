...
// DeleteUserPoolClientCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteUserPoolClientRequest generates a "byteplus/request.Request" representing the
