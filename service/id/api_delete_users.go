...
// DeleteUsersCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteUsersRequest generates a "byteplus/request.Request" representing the
