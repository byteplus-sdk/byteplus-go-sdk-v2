...
// DeleteNamespaceCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNamespaceRequest generates a "byteplus/request.Request" representing the
