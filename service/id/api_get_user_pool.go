...
// GetUserPoolCommonRequest generates a "byteplus/request.Request" representing the
...
// GetUserPoolRequest generates a "byteplus/request.Request" representing the
