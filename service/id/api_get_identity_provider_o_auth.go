...
// GetIdentityProviderOAuthCommonRequest generates a "byteplus/request.Request" representing the
...
// GetIdentityProviderOAuthRequest generates a "byteplus/request.Request" representing the
