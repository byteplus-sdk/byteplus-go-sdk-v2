...
// GrantPermissionCommonRequest generates a "byteplus/request.Request" representing the
...
// GrantPermissionRequest generates a "byteplus/request.Request" representing the
