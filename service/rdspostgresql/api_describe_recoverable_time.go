...
func (c *RDSPOSTGRESQL) DescribeRecoverableTimeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeRecoverableTimeCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeRecoverableTimeWithContext(ctx byteplus.Context, input *DescribeRecoverableTimeInput, opts ...request.Option) (*DescribeRecoverableTimeOutput, error) {
	req, out := c.DescribeRecoverableTimeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
