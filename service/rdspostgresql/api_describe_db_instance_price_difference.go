...
// DescribeDBInstancePriceDifferenceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DescribeDBInstancePriceDifferenceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstancePriceDifferenceCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstancePriceDifferenceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeDBInstancePriceDifferenceWithContext(ctx byteplus.Context, input *DescribeDBInstancePriceDifferenceInput, opts ...request.Option) (*DescribeDBInstancePriceDifferenceOutput, error) {
	req, out := c.DescribeDBInstancePriceDifferenceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
