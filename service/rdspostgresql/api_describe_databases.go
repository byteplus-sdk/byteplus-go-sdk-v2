...
// DescribeDatabasesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DescribeDatabasesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDatabasesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDatabasesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeDatabasesWithContext(ctx byteplus.Context, input *DescribeDatabasesInput, opts ...request.Option) (*DescribeDatabasesOutput, error) {
	req, out := c.DescribeDatabasesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
