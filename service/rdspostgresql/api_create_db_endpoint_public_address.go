...
// CreateDBEndpointPublicAddressCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) CreateDBEndpointPublicAddressCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDBEndpointPublicAddressCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDBEndpointPublicAddressRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) CreateDBEndpointPublicAddressWithContext(ctx byteplus.Context, input *CreateDBEndpointPublicAddressInput, opts ...request.Option) (*CreateDBEndpointPublicAddressOutput, error) {
	req, out := c.CreateDBEndpointPublicAddressRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
