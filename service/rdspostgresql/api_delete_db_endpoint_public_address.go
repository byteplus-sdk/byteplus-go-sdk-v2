...
// DeleteDBEndpointPublicAddressCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DeleteDBEndpointPublicAddressCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDBEndpointPublicAddressCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDBEndpointPublicAddressRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DeleteDBEndpointPublicAddressWithContext(ctx byteplus.Context, input *DeleteDBEndpointPublicAddressInput, opts ...request.Option) (*DeleteDBEndpointPublicAddressOutput, error) {
	req, out := c.DeleteDBEndpointPublicAddressRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
