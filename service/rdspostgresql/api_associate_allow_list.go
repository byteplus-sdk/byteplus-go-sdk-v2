...
func (c *RDSPOSTGRESQL) AssociateAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AssociateAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) AssociateAllowListWithContext(ctx byteplus.Context, input *AssociateAllowListInput, opts ...request.Option) (*AssociateAllowListOutput, error) {
	req, out := c.AssociateAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
