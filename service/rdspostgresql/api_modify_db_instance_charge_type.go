...
func (c *RDSPOSTGRESQL) ModifyDBInstanceChargeTypeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceChargeTypeCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) ModifyDBInstanceChargeTypeWithContext(ctx byteplus.Context, input *ModifyDBInstanceChargeTypeInput, opts ...request.Option) (*ModifyDBInstanceChargeTypeOutput, error) {
	req, out := c.ModifyDBInstanceChargeTypeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
