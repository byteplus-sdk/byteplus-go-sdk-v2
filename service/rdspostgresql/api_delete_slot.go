...
// DeleteSlotCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DeleteSlotCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteSlotCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteSlotRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DeleteSlotWithContext(ctx byteplus.Context, input *DeleteSlotInput, opts ...request.Option) (*DeleteSlotOutput, error) {
	req, out := c.DeleteSlotRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
