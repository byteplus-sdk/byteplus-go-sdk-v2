...
// RDSPOSTGRESQL provides the API operation methods for making requests to
// RDS_POSTGRESQL. See this package's package overview docs
// for details on the service.
//
// RDSPOSTGRESQL methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *RDSPOSTGRESQL {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *RDSPOSTGRESQL {
	svc := &RDSPOSTGRESQL{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a RDSPOSTGRESQL operation and runs any
// custom request initialization.
func (c *RDSPOSTGRESQL) newRequest(op *request.Operation, params, data interface{}) *request.Request {
