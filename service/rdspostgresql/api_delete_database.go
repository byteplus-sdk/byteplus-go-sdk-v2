...
// DeleteDatabaseCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DeleteDatabaseCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDatabaseCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDatabaseRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DeleteDatabaseWithContext(ctx byteplus.Context, input *DeleteDatabaseInput, opts ...request.Option) (*DeleteDatabaseOutput, error) {
	req, out := c.DeleteDatabaseRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
