...
// ModifyDBEndpointDNSCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) ModifyDBEndpointDNSCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointDNSCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBEndpointDNSRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) ModifyDBEndpointDNSWithContext(ctx byteplus.Context, input *ModifyDBEndpointDNSInput, opts ...request.Option) (*ModifyDBEndpointDNSOutput, error) {
	req, out := c.ModifyDBEndpointDNSRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
