...
func (c *RDSPOSTGRESQL) RevokeDBAccountPrivilegeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RevokeDBAccountPrivilegeCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) RevokeDBAccountPrivilegeWithContext(ctx byteplus.Context, input *RevokeDBAccountPrivilegeInput, opts ...request.Option) (*RevokeDBAccountPrivilegeOutput, error) {
	req, out := c.RevokeDBAccountPrivilegeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
