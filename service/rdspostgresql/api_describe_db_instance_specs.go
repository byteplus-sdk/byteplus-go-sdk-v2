...
// DescribeDBInstanceSpecsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) DescribeDBInstanceSpecsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceSpecsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceSpecsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeDBInstanceSpecsWithContext(ctx byteplus.Context, input *DescribeDBInstanceSpecsInput, opts ...request.Option) (*DescribeDBInstanceSpecsOutput, error) {
	req, out := c.DescribeDBInstanceSpecsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
