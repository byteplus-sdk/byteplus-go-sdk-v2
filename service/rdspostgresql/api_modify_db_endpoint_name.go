...
// ModifyDBEndpointNameCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) ModifyDBEndpointNameCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointNameCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBEndpointNameRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) ModifyDBEndpointNameWithContext(ctx byteplus.Context, input *ModifyDBEndpointNameInput, opts ...request.Option) (*ModifyDBEndpointNameOutput, error) {
	req, out := c.ModifyDBEndpointNameRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
