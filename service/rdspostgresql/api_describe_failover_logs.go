...
func (c *RDSPOSTGRESQL) DescribeFailoverLogsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeFailoverLogsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeFailoverLogsWithContext(ctx byteplus.Context, input *DescribeFailoverLogsInput, opts ...request.Option) (*DescribeFailoverLogsOutput, error) {
	req, out := c.DescribeFailoverLogsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
