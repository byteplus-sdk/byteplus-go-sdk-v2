...
func (c *RDSPOSTGRESQL) DescribeAllowListDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAllowListDetailCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeAllowListDetailWithContext(ctx byteplus.Context, input *DescribeAllowListDetailInput, opts ...request.Option) (*DescribeAllowListDetailOutput, error) {
	req, out := c.DescribeAllowListDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
