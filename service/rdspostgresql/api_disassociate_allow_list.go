...
func (c *RDSPOSTGRESQL) DisassociateAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DisassociateAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DisassociateAllowListWithContext(ctx byteplus.Context, input *DisassociateAllowListInput, opts ...request.Option) (*DisassociateAllowListOutput, error) {
	req, out := c.DisassociateAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
