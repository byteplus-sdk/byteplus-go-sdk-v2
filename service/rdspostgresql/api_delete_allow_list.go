...
func (c *RDSPOSTGRESQL) DeleteAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DeleteAllowListWithContext(ctx byteplus.Context, input *DeleteAllowListInput, opts ...request.Option) (*DeleteAllowListOutput, error) {
	req, out := c.DeleteAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
