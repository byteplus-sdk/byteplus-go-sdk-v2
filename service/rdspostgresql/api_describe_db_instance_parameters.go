...
func (c *RDSPOSTGRESQL) DescribeDBInstanceParametersCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceParametersCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) DescribeDBInstanceParametersWithContext(ctx byteplus.Context, input *DescribeDBInstanceParametersInput, opts ...request.Option) (*DescribeDBInstanceParametersOutput, error) {
	req, out := c.DescribeDBInstanceParametersRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
