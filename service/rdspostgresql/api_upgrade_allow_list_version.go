...
// UpgradeAllowListVersionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSPOSTGRESQL) UpgradeAllowListVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpgradeAllowListVersionCommonRequest(input)
	req.SetContext(ctx)
...
// UpgradeAllowListVersionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSPOSTGRESQL) UpgradeAllowListVersionWithContext(ctx byteplus.Context, input *UpgradeAllowListVersionInput, opts ...request.Option) (*UpgradeAllowListVersionOutput, error) {
	req, out := c.UpgradeAllowListVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
