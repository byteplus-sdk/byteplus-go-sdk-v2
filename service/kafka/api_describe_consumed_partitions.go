...
// DescribeConsumedPartitionsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeConsumedPartitionsRequest generates a "byteplus/request.Request" representing the
