...
// DescribeTopicsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeTopicsRequest generates a "byteplus/request.Request" representing the
