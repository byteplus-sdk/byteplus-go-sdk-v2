...
// DeleteTopicCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteTopicRequest generates a "byteplus/request.Request" representing the
