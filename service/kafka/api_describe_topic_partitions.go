...
// DescribeTopicPartitionsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeTopicPartitionsRequest generates a "byteplus/request.Request" representing the
