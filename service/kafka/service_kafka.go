...
// KAFKA. See this package's package overview docs
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *KAFKA {
	svc := &KAFKA{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
