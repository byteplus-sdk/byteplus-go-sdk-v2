...
// DescribeGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeGroupsRequest generates a "byteplus/request.Request" representing the
...
func (s *DescribeGroupsInput) SetTopic(v string) *DescribeGroupsInput {
	s.Topic = &v
	return s
}
