...
// ModifyUserAuthorityCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyUserAuthorityRequest generates a "byteplus/request.Request" representing the
