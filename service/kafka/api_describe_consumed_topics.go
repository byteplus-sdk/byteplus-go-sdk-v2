...
// DescribeConsumedTopicsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeConsumedTopicsRequest generates a "byteplus/request.Request" representing the
