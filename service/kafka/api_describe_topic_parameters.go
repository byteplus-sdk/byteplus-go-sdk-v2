...
// DescribeTopicParametersCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeTopicParametersRequest generates a "byteplus/request.Request" representing the
