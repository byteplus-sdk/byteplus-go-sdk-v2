...
// ModifyTopicAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyTopicAttributesRequest generates a "byteplus/request.Request" representing the
