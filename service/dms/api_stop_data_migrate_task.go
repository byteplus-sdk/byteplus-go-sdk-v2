...
// StopDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) StopDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.StopDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// StopDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) StopDataMigrateTaskWithContext(ctx byteplus.Context, input *StopDataMigrateTaskInput, opts ...request.Option) (*StopDataMigrateTaskOutput, error) {
	req, out := c.StopDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
