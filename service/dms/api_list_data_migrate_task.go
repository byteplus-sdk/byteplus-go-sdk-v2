...
// ListDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) ListDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// ListDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) ListDataMigrateTaskWithContext(ctx byteplus.Context, input *ListDataMigrateTaskInput, opts ...request.Option) (*ListDataMigrateTaskOutput, error) {
	req, out := c.ListDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
