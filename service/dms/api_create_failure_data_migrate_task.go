...
// CreateFailureDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for DMS's
...
func (c *DMS) CreateFailureDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateFailureDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// CreateFailureDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) CreateFailureDataMigrateTaskWithContext(ctx byteplus.Context, input *CreateFailureDataMigrateTaskInput, opts ...request.Option) (*CreateFailureDataMigrateTaskOutput, error) {
	req, out := c.CreateFailureDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
