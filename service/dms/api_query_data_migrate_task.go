...
// QueryDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) QueryDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// QueryDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) QueryDataMigrateTaskWithContext(ctx byteplus.Context, input *QueryDataMigrateTaskInput, opts ...request.Option) (*QueryDataMigrateTaskOutput, error) {
	req, out := c.QueryDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
