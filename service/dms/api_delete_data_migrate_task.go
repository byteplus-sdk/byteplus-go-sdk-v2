...
// DeleteDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) DeleteDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) DeleteDataMigrateTaskWithContext(ctx byteplus.Context, input *DeleteDataMigrateTaskInput, opts ...request.Option) (*DeleteDataMigrateTaskOutput, error) {
	req, out := c.DeleteDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
