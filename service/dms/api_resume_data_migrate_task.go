...
// ResumeDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) ResumeDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ResumeDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// ResumeDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) ResumeDataMigrateTaskWithContext(ctx byteplus.Context, input *ResumeDataMigrateTaskInput, opts ...request.Option) (*ResumeDataMigrateTaskOutput, error) {
	req, out := c.ResumeDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
