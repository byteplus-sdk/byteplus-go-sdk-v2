...
// CreateDataMigrateTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *DMS) CreateDataMigrateTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDataMigrateTaskCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDataMigrateTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DMS) CreateDataMigrateTaskWithContext(ctx byteplus.Context, input *CreateDataMigrateTaskInput, opts ...request.Option) (*CreateDataMigrateTaskOutput, error) {
	req, out := c.CreateDataMigrateTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
