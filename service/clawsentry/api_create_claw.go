...
// CreateClawCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for CLAWSENTRY's
...
func (c *CLAWSENTRY) CreateClawCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateClawCommonRequest(input)
	req.SetContext(ctx)
...
// CreateClawRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLAWSENTRY) CreateClawWithContext(ctx byteplus.Context, input *CreateClawInput, opts ...request.Option) (*CreateClawOutput, error) {
	req, out := c.CreateClawRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
