...
// ListUsersForGroupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) ListUsersForGroupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListUsersForGroupCommonRequest(input)
	req.SetContext(ctx)
...
// ListUsersForGroupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) ListUsersForGroupWithContext(ctx byteplus.Context, input *ListUsersForGroupInput, opts ...request.Option) (*ListUsersForGroupOutput, error) {
	req, out := c.ListUsersForGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
