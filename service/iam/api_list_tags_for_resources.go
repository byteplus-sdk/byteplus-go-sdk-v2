...
//	    fmt.Println(resp)
//	}
func (c *IAM) ListTagsForResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListTagsForResourcesCommon API operation for IAM.
//
...
func (c *IAM) ListTagsForResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAM) ListTagsForResourcesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListTagsForResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//	    fmt.Println(resp)
//	}
func (c *IAM) ListTagsForResourcesRequest(input *ListTagsForResourcesInput) (req *request.Request, output *ListTagsForResourcesOutput) {
	op := &request.Operation{
...
// ListTagsForResources API operation for IAM.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAM) ListTagsForResources(input *ListTagsForResourcesInput) (*ListTagsForResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) ListTagsForResourcesWithContext(ctx byteplus.Context, input *ListTagsForResourcesInput, opts ...request.Option) (*ListTagsForResourcesOutput, error) {
	req, out := c.ListTagsForResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type ListTagsForResourcesInput struct {
	...
	ResourceNames []*string `type:"list"`
...
func (s *ListTagsForResourcesInput) SetResourceNames(v []*string) *ListTagsForResourcesInput {
	s.ResourceNames = v
	return s
}
...
type ResourceTagForListTagsForResourcesOutput struct {
	...
	ResourceType *string `type:"string" enum:"EnumOfResourceTypeForListTagsForResourcesOutput"`
...
func (s *ResourceTagForListTagsForResourcesOutput) SetResourceName(v string) *ResourceTagForListTagsForResourcesOutput {
	s.ResourceName = &v
	return s
}
...
const (
	// EnumOfResourceTypeForListTagsForResourcesInputUser is a EnumOfResourceTypeForListTagsForResourcesInput enum value
	EnumOfResourceTypeForListTagsForResourcesInputUser = "User"

	// EnumOfResourceTypeForListTagsForResourcesInputRole is a EnumOfResourceTypeForListTagsForResourcesInput enum value
	EnumOfResourceTypeForListTagsForResourcesInputRole = "Role"
)

const (
	// EnumOfResourceTypeForListTagsForResourcesOutputUser is a EnumOfResourceTypeForListTagsForResourcesOutput enum value
	EnumOfResourceTypeForListTagsForResourcesOutputUser = "User"

	// EnumOfResourceTypeForListTagsForResourcesOutputRole is a EnumOfResourceTypeForListTagsForResourcesOutput enum value
	EnumOfResourceTypeForListTagsForResourcesOutputRole = "Role"
)
