...
// SetSecurityConfigCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) SetSecurityConfigCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SetSecurityConfigCommonRequest(input)
	req.SetContext(ctx)
...
// SetSecurityConfigRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) SetSecurityConfigWithContext(ctx byteplus.Context, input *SetSecurityConfigInput, opts ...request.Option) (*SetSecurityConfigOutput, error) {
	req, out := c.SetSecurityConfigRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
