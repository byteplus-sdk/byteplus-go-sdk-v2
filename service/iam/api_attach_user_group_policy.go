...
// AttachUserGroupPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) AttachUserGroupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AttachUserGroupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// AttachUserGroupPolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) AttachUserGroupPolicyWithContext(ctx byteplus.Context, input *AttachUserGroupPolicyInput, opts ...request.Option) (*AttachUserGroupPolicyOutput, error) {
	req, out := c.AttachUserGroupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
