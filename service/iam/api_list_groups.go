...
// ListGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) ListGroupsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListGroupsCommonRequest(input)
	req.SetContext(ctx)
...
// ListGroupsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) ListGroupsWithContext(ctx byteplus.Context, input *ListGroupsInput, opts ...request.Option) (*ListGroupsOutput, error) {
	req, out := c.ListGroupsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *UserGroupForListGroupsOutput) SetUserGroupID(v int32) *UserGroupForListGroupsOutput {
	s.UserGroupID = &v
	return s
}
