...
//	    fmt.Println(resp)
//	}
func (c *IAM) UntagResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UntagResourcesCommon API operation for IAM.
//
...
func (c *IAM) UntagResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAM) UntagResourcesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UntagResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//	    fmt.Println(resp)
//	}
func (c *IAM) UntagResourcesRequest(input *UntagResourcesInput) (req *request.Request, output *UntagResourcesOutput) {
	op := &request.Operation{
...
// UntagResources API operation for IAM.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAM) UntagResources(input *UntagResourcesInput) (*UntagResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) UntagResourcesWithContext(ctx byteplus.Context, input *UntagResourcesInput, opts ...request.Option) (*UntagResourcesOutput, error) {
	req, out := c.UntagResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type UntagResourcesInput struct {
	...
	// ResourceNames is a required field
	ResourceNames []*string `type:"list" required:"true"`
...
func (s *UntagResourcesInput) Validate() error {
	...
	if s.ResourceNames == nil {
		invalidParams.Add(request.NewErrParamRequired("ResourceNames"))
	}
...
func (s *UntagResourcesInput) SetResourceNames(v []*string) *UntagResourcesInput {
	s.ResourceNames = v
	return s
}
...
const (
	// EnumOfResourceTypeForUntagResourcesInputUser is a EnumOfResourceTypeForUntagResourcesInput enum value
	EnumOfResourceTypeForUntagResourcesInputUser = "User"

	// EnumOfResourceTypeForUntagResourcesInputRole is a EnumOfResourceTypeForUntagResourcesInput enum value
	EnumOfResourceTypeForUntagResourcesInputRole = "Role"
)
