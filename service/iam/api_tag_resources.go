...
//	    fmt.Println(resp)
//	}
func (c *IAM) TagResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// TagResourcesCommon API operation for IAM.
//
...
func (c *IAM) TagResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAM) TagResourcesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.TagResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//	    fmt.Println(resp)
//	}
func (c *IAM) TagResourcesRequest(input *TagResourcesInput) (req *request.Request, output *TagResourcesOutput) {
	op := &request.Operation{
		Name:       opTagResources,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// TagResources API operation for IAM.
//
// Returns bytepluserr.Error for service API and SDK errors. Use runtime type assertions
// with bytepluserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAM) TagResources(input *TagResourcesInput) (*TagResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) TagResourcesWithContext(ctx byteplus.Context, input *TagResourcesInput, opts ...request.Option) (*TagResourcesOutput, error) {
	req, out := c.TagResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *TagResourcesInput) SetResourceNames(v []*string) *TagResourcesInput {
	s.ResourceNames = v
	return s
}
...
const (
	// EnumOfResourceTypeForTagResourcesInputUser is a EnumOfResourceTypeForTagResourcesInput enum value
	EnumOfResourceTypeForTagResourcesInputUser = "User"

	// EnumOfResourceTypeForTagResourcesInputRole is a EnumOfResourceTypeForTagResourcesInput enum value
	EnumOfResourceTypeForTagResourcesInputRole = "Role"
)
