...
// GetGroupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) GetGroupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetGroupCommonRequest(input)
	req.SetContext(ctx)
...
// GetGroupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) GetGroupWithContext(ctx byteplus.Context, input *GetGroupInput, opts ...request.Option) (*GetGroupOutput, error) {
	req, out := c.GetGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *UserGroupForGetGroupOutput) SetUserGroupID(v int32) *UserGroupForGetGroupOutput {
	s.UserGroupID = &v
	return s
}
