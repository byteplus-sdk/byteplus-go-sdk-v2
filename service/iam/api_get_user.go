...
// GetUserCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) GetUserCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetUserCommonRequest(input)
	req.SetContext(ctx)
...
// GetUserRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) GetUserWithContext(ctx byteplus.Context, input *GetUserInput, opts ...request.Option) (*GetUserOutput, error) {
	req, out := c.GetUserRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type TagForGetUserOutput struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s TagForGetUserOutput) String() string {
	return byteplusutil.Prettify(s)
}

// GoString returns the string representation
func (s TagForGetUserOutput) GoString() string {
	return s.String()
}

// SetKey sets the Key field's value.
func (s *TagForGetUserOutput) SetKey(v string) *TagForGetUserOutput {
	s.Key = &v
	return s
}

// SetValue sets the Value field's value.
func (s *TagForGetUserOutput) SetValue(v string) *TagForGetUserOutput {
	s.Value = &v
	return s
}
...
type UserForGetUserOutput struct {
	...
	Tags []*TagForGetUserOutput `type:"list"`
...
func (s *UserForGetUserOutput) SetTags(v []*TagForGetUserOutput) *UserForGetUserOutput {
	s.Tags = v
	return s
}
