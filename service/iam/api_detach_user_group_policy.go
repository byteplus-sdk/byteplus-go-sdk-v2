...
// DetachUserGroupPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *IAM) DetachUserGroupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DetachUserGroupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// DetachUserGroupPolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAM) DetachUserGroupPolicyWithContext(ctx byteplus.Context, input *DetachUserGroupPolicyInput, opts ...request.Option) (*DetachUserGroupPolicyOutput, error) {
	req, out := c.DetachUserGroupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
