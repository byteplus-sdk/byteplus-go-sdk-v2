...
// DeletePrivateZoneCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) DeletePrivateZoneCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeletePrivateZoneCommonRequest(input)
	req.SetContext(ctx)
...
// DeletePrivateZoneRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) DeletePrivateZoneWithContext(ctx byteplus.Context, input *DeletePrivateZoneInput, opts ...request.Option) (*DeletePrivateZoneOutput, error) {
	req, out := c.DeletePrivateZoneRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
