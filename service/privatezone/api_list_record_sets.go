...
// ListRecordSetsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListRecordSetsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListRecordSetsCommonRequest(input)
	req.SetContext(ctx)
...
// ListRecordSetsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListRecordSetsWithContext(ctx byteplus.Context, input *ListRecordSetsInput, opts ...request.Option) (*ListRecordSetsOutput, error) {
	req, out := c.ListRecordSetsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
