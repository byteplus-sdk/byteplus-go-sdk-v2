...
// UpdateBindVPCCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) UpdateBindVPCCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateBindVPCCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateBindVPCRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) UpdateBindVPCWithContext(ctx byteplus.Context, input *UpdateBindVPCInput, opts ...request.Option) (*UpdateBindVPCOutput, error) {
	req, out := c.UpdateBindVPCRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
