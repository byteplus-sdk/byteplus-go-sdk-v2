...
// CreateRecordCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) CreateRecordCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateRecordCommonRequest(input)
	req.SetContext(ctx)
...
// CreateRecordRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) CreateRecordWithContext(ctx byteplus.Context, input *CreateRecordInput, opts ...request.Option) (*CreateRecordOutput, error) {
	req, out := c.CreateRecordRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
