...
// QueryResolverEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) QueryResolverEndpointCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryResolverEndpointCommonRequest(input)
	req.SetContext(ctx)
...
// QueryResolverEndpointRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) QueryResolverEndpointWithContext(ctx byteplus.Context, input *QueryResolverEndpointInput, opts ...request.Option) (*QueryResolverEndpointOutput, error) {
	req, out := c.QueryResolverEndpointRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
