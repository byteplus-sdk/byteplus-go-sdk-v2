...
// UpdatePrivateZoneCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) UpdatePrivateZoneCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdatePrivateZoneCommonRequest(input)
	req.SetContext(ctx)
...
// UpdatePrivateZoneRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) UpdatePrivateZoneWithContext(ctx byteplus.Context, input *UpdatePrivateZoneInput, opts ...request.Option) (*UpdatePrivateZoneOutput, error) {
	req, out := c.UpdatePrivateZoneRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
