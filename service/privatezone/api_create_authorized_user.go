...
// CreateAuthorizedUserCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) CreateAuthorizedUserCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateAuthorizedUserCommonRequest(input)
	req.SetContext(ctx)
...
// CreateAuthorizedUserRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) CreateAuthorizedUserWithContext(ctx byteplus.Context, input *CreateAuthorizedUserInput, opts ...request.Option) (*CreateAuthorizedUserOutput, error) {
	req, out := c.CreateAuthorizedUserRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
