...
// IncBindVPCCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) IncBindVPCCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.IncBindVPCCommonRequest(input)
	req.SetContext(ctx)
...
// IncBindVPCRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) IncBindVPCWithContext(ctx byteplus.Context, input *IncBindVPCInput, opts ...request.Option) (*IncBindVPCOutput, error) {
	req, out := c.IncBindVPCRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
