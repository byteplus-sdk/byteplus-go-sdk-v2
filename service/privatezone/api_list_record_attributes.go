...
// ListRecordAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListRecordAttributesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListRecordAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ListRecordAttributesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListRecordAttributesWithContext(ctx byteplus.Context, input *ListRecordAttributesInput, opts ...request.Option) (*ListRecordAttributesOutput, error) {
	req, out := c.ListRecordAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
