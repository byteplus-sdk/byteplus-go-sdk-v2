...
// ListBindVPCCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListBindVPCCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListBindVPCCommonRequest(input)
	req.SetContext(ctx)
...
// ListBindVPCRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListBindVPCWithContext(ctx byteplus.Context, input *ListBindVPCInput, opts ...request.Option) (*ListBindVPCOutput, error) {
	req, out := c.ListBindVPCRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
