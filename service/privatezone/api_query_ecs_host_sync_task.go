...
// QueryEcsHostSyncTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) QueryEcsHostSyncTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryEcsHostSyncTaskCommonRequest(input)
	req.SetContext(ctx)
...
// QueryEcsHostSyncTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) QueryEcsHostSyncTaskWithContext(ctx byteplus.Context, input *QueryEcsHostSyncTaskInput, opts ...request.Option) (*QueryEcsHostSyncTaskOutput, error) {
	req, out := c.QueryEcsHostSyncTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
