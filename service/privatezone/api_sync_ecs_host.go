...
// SyncEcsHostCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) SyncEcsHostCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SyncEcsHostCommonRequest(input)
	req.SetContext(ctx)
...
// SyncEcsHostRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) SyncEcsHostWithContext(ctx byteplus.Context, input *SyncEcsHostInput, opts ...request.Option) (*SyncEcsHostOutput, error) {
	req, out := c.SyncEcsHostRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
