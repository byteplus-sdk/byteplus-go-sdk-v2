...
// QueryPrivateZoneCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) QueryPrivateZoneCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryPrivateZoneCommonRequest(input)
	req.SetContext(ctx)
...
// QueryPrivateZoneRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) QueryPrivateZoneWithContext(ctx byteplus.Context, input *QueryPrivateZoneInput, opts ...request.Option) (*QueryPrivateZoneOutput, error) {
	req, out := c.QueryPrivateZoneRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
