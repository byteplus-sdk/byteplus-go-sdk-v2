...
// UpdateResolverEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) UpdateResolverEndpointCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateResolverEndpointCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateResolverEndpointRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) UpdateResolverEndpointWithContext(ctx byteplus.Context, input *UpdateResolverEndpointInput, opts ...request.Option) (*UpdateResolverEndpointOutput, error) {
	req, out := c.UpdateResolverEndpointRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
