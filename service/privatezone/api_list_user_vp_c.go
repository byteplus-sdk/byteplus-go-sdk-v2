...
// ListUserVPCCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListUserVPCCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListUserVPCCommonRequest(input)
	req.SetContext(ctx)
...
// ListUserVPCRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListUserVPCWithContext(ctx byteplus.Context, input *ListUserVPCInput, opts ...request.Option) (*ListUserVPCOutput, error) {
	req, out := c.ListUserVPCRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
