...
// ListPrivateZonesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListPrivateZonesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListPrivateZonesCommonRequest(input)
	req.SetContext(ctx)
...
// ListPrivateZonesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListPrivateZonesWithContext(ctx byteplus.Context, input *ListPrivateZonesInput, opts ...request.Option) (*ListPrivateZonesOutput, error) {
	req, out := c.ListPrivateZonesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
