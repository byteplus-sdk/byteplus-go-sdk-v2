...
// BindRuleVPCCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) BindRuleVPCCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.BindRuleVPCCommonRequest(input)
	req.SetContext(ctx)
...
// BindRuleVPCRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) BindRuleVPCWithContext(ctx byteplus.Context, input *BindRuleVPCInput, opts ...request.Option) (*BindRuleVPCOutput, error) {
	req, out := c.BindRuleVPCRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
