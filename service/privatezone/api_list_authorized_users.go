...
// ListAuthorizedUsersCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) ListAuthorizedUsersCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAuthorizedUsersCommonRequest(input)
	req.SetContext(ctx)
...
// ListAuthorizedUsersRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListAuthorizedUsersWithContext(ctx byteplus.Context, input *ListAuthorizedUsersInput, opts ...request.Option) (*ListAuthorizedUsersOutput, error) {
	req, out := c.ListAuthorizedUsersRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
