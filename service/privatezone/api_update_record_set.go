...
// UpdateRecordSetCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) UpdateRecordSetCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateRecordSetCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateRecordSetRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) UpdateRecordSetWithContext(ctx byteplus.Context, input *UpdateRecordSetInput, opts ...request.Option) (*UpdateRecordSetOutput, error) {
	req, out := c.UpdateRecordSetRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
