...
// BatchCreateRecordCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) BatchCreateRecordCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.BatchCreateRecordCommonRequest(input)
	req.SetContext(ctx)
...
// BatchCreateRecordRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) BatchCreateRecordWithContext(ctx byteplus.Context, input *BatchCreateRecordInput, opts ...request.Option) (*BatchCreateRecordOutput, error) {
	req, out := c.BatchCreateRecordRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
