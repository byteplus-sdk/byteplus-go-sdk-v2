...
// BatchUpdateRecordCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) BatchUpdateRecordCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.BatchUpdateRecordCommonRequest(input)
	req.SetContext(ctx)
...
// BatchUpdateRecordRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) BatchUpdateRecordWithContext(ctx byteplus.Context, input *BatchUpdateRecordInput, opts ...request.Option) (*BatchUpdateRecordOutput, error) {
	req, out := c.BatchUpdateRecordRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
