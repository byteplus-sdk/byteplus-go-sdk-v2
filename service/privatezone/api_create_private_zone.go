...
// CreatePrivateZoneCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) CreatePrivateZoneCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreatePrivateZoneCommonRequest(input)
	req.SetContext(ctx)
...
// CreatePrivateZoneRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) CreatePrivateZoneWithContext(ctx byteplus.Context, input *CreatePrivateZoneInput, opts ...request.Option) (*CreatePrivateZoneOutput, error) {
	req, out := c.CreatePrivateZoneRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
