...
// QueryResolverRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) QueryResolverRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryResolverRuleCommonRequest(input)
	req.SetContext(ctx)
...
// QueryResolverRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) QueryResolverRuleWithContext(ctx byteplus.Context, input *QueryResolverRuleInput, opts ...request.Option) (*QueryResolverRuleOutput, error) {
	req, out := c.QueryResolverRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
