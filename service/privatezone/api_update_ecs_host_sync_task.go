...
// UpdateEcsHostSyncTaskCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) UpdateEcsHostSyncTaskCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateEcsHostSyncTaskCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateEcsHostSyncTaskRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) UpdateEcsHostSyncTaskWithContext(ctx byteplus.Context, input *UpdateEcsHostSyncTaskInput, opts ...request.Option) (*UpdateEcsHostSyncTaskOutput, error) {
	req, out := c.UpdateEcsHostSyncTaskRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
