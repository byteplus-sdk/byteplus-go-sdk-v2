...
// QueryRecordCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *PRIVATEZONE) QueryRecordCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.QueryRecordCommonRequest(input)
	req.SetContext(ctx)
...
// QueryRecordRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) QueryRecordWithContext(ctx byteplus.Context, input *QueryRecordInput, opts ...request.Option) (*QueryRecordOutput, error) {
	req, out := c.QueryRecordRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
