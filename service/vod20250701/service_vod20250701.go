...
// VOD20250701 provides the API operation methods for making requests to
// VOD20250701. See this package's package overview docs
// for details on the service.
//
// VOD20250701 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type VOD20250701 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *VOD20250701 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VOD20250701 {
	svc := &VOD20250701{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VOD20250701 operation and runs any
// custom request initialization.
func (c *VOD20250701) newRequest(op *request.Operation, params, data interface{}) *request.Request {
