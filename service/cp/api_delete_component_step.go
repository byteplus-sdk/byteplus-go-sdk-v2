...
// DeleteComponentStepCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteComponentStepRequest generates a "byteplus/request.Request" representing the
