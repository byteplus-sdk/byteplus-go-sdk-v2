...
// CP provides the API operation methods for making requests to
// CP. See this package's package overview docs
// for details on the service.
//
// CP methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CP {
	svc := &CP{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CP operation and runs any
// custom request initialization.
func (c *CP) newRequest(op *request.Operation, params, data interface{}) *request.Request {
