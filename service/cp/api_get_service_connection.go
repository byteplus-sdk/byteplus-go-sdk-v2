...
// GetServiceConnectionCommonRequest generates a "byteplus/request.Request" representing the
...
// GetServiceConnectionRequest generates a "byteplus/request.Request" representing the
