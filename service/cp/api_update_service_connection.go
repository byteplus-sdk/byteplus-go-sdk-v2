...
// UpdateServiceConnectionCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateServiceConnectionRequest generates a "byteplus/request.Request" representing the
