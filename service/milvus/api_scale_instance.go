...
// ScaleInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
// ScaleInstanceRequest generates a "byteplus/request.Request" representing the
