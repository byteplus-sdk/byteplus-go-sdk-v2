...
// MILVUS provides the API operation methods for making requests to
// MILVUS. See this package's package overview docs
// for details on the service.
//
// MILVUS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *MILVUS {
	svc := &MILVUS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MILVUS operation and runs any
// custom request initialization.
func (c *MILVUS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
