...
// DescribeNodeInfoCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNodeInfoRequest generates a "byteplus/request.Request" representing the
