...
// GetSecretValueCommonRequest generates a "byteplus/request.Request" representing the
...
// GetSecretValueRequest generates a "byteplus/request.Request" representing the
