...
// DescribeSecretsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSecretsRequest generates a "byteplus/request.Request" representing the
