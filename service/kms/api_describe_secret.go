...
// DescribeSecretCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSecretRequest generates a "byteplus/request.Request" representing the
