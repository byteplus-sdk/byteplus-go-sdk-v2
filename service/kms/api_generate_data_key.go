...
// GenerateDataKeyCommonRequest generates a "byteplus/request.Request" representing the
...
// GenerateDataKeyRequest generates a "byteplus/request.Request" representing the
