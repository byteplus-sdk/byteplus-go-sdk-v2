...
// AsymmetricSignCommonRequest generates a "byteplus/request.Request" representing the
...
// AsymmetricSignRequest generates a "byteplus/request.Request" representing the
