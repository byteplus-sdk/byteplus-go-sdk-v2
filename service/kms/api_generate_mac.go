...
// GenerateMacCommonRequest generates a "byteplus/request.Request" representing the
...
// GenerateMacRequest generates a "byteplus/request.Request" representing the
