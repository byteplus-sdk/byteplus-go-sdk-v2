...
// EnableKeyRotationCommonRequest generates a "byteplus/request.Request" representing the
...
// EnableKeyRotationRequest generates a "byteplus/request.Request" representing the
