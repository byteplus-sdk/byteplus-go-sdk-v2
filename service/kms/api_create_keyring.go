...
// CreateKeyringCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateKeyringRequest generates a "byteplus/request.Request" representing the
