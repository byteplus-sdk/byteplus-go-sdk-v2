...
// BatchGetSecretValueCommonRequest generates a "byteplus/request.Request" representing the
...
// BatchGetSecretValueRequest generates a "byteplus/request.Request" representing the
