...
// GetPublicKeyCommonRequest generates a "byteplus/request.Request" representing the
...
// GetPublicKeyRequest generates a "byteplus/request.Request" representing the
