...
// ReplicateKeyCommonRequest generates a "byteplus/request.Request" representing the
...
// ReplicateKeyRequest generates a "byteplus/request.Request" representing the
