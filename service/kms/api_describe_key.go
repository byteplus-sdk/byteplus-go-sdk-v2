...
// DescribeKeyCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeKeyRequest generates a "byteplus/request.Request" representing the
