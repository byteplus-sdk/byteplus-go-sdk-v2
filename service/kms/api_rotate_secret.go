...
// RotateSecretCommonRequest generates a "byteplus/request.Request" representing the
...
// RotateSecretRequest generates a "byteplus/request.Request" representing the
