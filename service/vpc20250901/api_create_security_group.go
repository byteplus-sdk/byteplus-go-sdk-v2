...
// CreateSecurityGroupCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSecurityGroupRequest generates a "byteplus/request.Request" representing the
