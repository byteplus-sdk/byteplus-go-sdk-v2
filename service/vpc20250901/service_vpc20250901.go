...
// VPC20250901 provides the API operation methods for making requests to
// VPC20250901. See this package's package overview docs
// for details on the service.
//
// VPC20250901 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type VPC20250901 struct {
	*client.Client
}
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VPC20250901 {
	svc := &VPC20250901{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VPC20250901 operation and runs any
// custom request initialization.
func (c *VPC20250901) newRequest(op *request.Operation, params, data interface{}) *request.Request {
