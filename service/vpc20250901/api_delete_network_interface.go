...
// DeleteNetworkInterfaceCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNetworkInterfaceRequest generates a "byteplus/request.Request" representing the
