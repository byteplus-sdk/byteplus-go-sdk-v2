...
// DescribeNetworkInterfaceAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNetworkInterfaceAttributesRequest generates a "byteplus/request.Request" representing the
