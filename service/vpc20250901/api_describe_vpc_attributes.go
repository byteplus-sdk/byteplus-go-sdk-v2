...
// DescribeVpcAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeVpcAttributesRequest generates a "byteplus/request.Request" representing the
