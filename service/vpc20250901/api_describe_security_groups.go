...
// DescribeSecurityGroupsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSecurityGroupsRequest generates a "byteplus/request.Request" representing the
