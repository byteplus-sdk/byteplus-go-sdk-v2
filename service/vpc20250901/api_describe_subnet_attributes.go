...
// DescribeSubnetAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSubnetAttributesRequest generates a "byteplus/request.Request" representing the
