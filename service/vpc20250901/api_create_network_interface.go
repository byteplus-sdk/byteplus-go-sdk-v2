...
// CreateNetworkInterfaceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNetworkInterfaceRequest generates a "byteplus/request.Request" representing the
