...
// CreateRouteTableCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateRouteTableRequest generates a "byteplus/request.Request" representing the
