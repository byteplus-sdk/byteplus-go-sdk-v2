...
// DescribeSecurityGroupAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSecurityGroupAttributesRequest generates a "byteplus/request.Request" representing the
