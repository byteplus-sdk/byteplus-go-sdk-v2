...
// CreateSubnetCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSubnetRequest generates a "byteplus/request.Request" representing the
