...
// DescribeSubnetsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSubnetsRequest generates a "byteplus/request.Request" representing the
