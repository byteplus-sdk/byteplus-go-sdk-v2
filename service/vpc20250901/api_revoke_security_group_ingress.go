...
// RevokeSecurityGroupIngressCommonRequest generates a "byteplus/request.Request" representing the
...
// RevokeSecurityGroupIngressRequest generates a "byteplus/request.Request" representing the
