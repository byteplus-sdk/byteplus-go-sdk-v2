...
// DeleteSubnetCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteSubnetRequest generates a "byteplus/request.Request" representing the
