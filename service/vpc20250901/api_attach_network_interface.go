...
// AttachNetworkInterfaceCommonRequest generates a "byteplus/request.Request" representing the
...
// AttachNetworkInterfaceRequest generates a "byteplus/request.Request" representing the
