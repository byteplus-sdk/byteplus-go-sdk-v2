...
// DeleteAlarmRulesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) DeleteAlarmRulesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteAlarmRulesCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteAlarmRulesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) DeleteAlarmRulesWithContext(ctx byteplus.Context, input *DeleteAlarmRulesInput, opts ...request.Option) (*DeleteAlarmRulesOutput, error) {
	req, out := c.DeleteAlarmRulesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
