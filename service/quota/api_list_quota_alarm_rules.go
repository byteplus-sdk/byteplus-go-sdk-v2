...
// ListQuotaAlarmRulesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListQuotaAlarmRulesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListQuotaAlarmRulesCommonRequest(input)
	req.SetContext(ctx)
...
// ListQuotaAlarmRulesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListQuotaAlarmRulesWithContext(ctx byteplus.Context, input *ListQuotaAlarmRulesInput, opts ...request.Option) (*ListQuotaAlarmRulesOutput, error) {
	req, out := c.ListQuotaAlarmRulesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
