...
// ListProductsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListProductsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListProductsCommonRequest(input)
	req.SetContext(ctx)
...
// ListProductsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListProductsWithContext(ctx byteplus.Context, input *ListProductsInput, opts ...request.Option) (*ListProductsOutput, error) {
	req, out := c.ListProductsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
