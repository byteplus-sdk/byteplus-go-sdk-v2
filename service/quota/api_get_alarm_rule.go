...
// GetAlarmRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) GetAlarmRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetAlarmRuleCommonRequest(input)
	req.SetContext(ctx)
...
// GetAlarmRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) GetAlarmRuleWithContext(ctx byteplus.Context, input *GetAlarmRuleInput, opts ...request.Option) (*GetAlarmRuleOutput, error) {
	req, out := c.GetAlarmRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
