...
// GetProductQuotaCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) GetProductQuotaCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetProductQuotaCommonRequest(input)
	req.SetContext(ctx)
...
// GetProductQuotaRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) GetProductQuotaWithContext(ctx byteplus.Context, input *GetProductQuotaInput, opts ...request.Option) (*GetProductQuotaOutput, error) {
	req, out := c.GetProductQuotaRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
