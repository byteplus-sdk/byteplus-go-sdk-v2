...
// QUOTA provides the API operation methods for making requests to
// QUOTA. See this package's package overview docs
// for details on the service.
//
// QUOTA methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *QUOTA {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *QUOTA {
	svc := &QUOTA{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a QUOTA operation and runs any
// custom request initialization.
func (c *QUOTA) newRequest(op *request.Operation, params, data interface{}) *request.Request {
