...
// ListQuotaApplicationTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListQuotaApplicationTemplatesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListQuotaApplicationTemplatesCommonRequest(input)
	req.SetContext(ctx)
...
// ListQuotaApplicationTemplatesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListQuotaApplicationTemplatesWithContext(ctx byteplus.Context, input *ListQuotaApplicationTemplatesInput, opts ...request.Option) (*ListQuotaApplicationTemplatesOutput, error) {
	req, out := c.ListQuotaApplicationTemplatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
