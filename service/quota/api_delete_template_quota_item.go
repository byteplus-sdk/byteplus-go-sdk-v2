...
// DeleteTemplateQuotaItemCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) DeleteTemplateQuotaItemCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteTemplateQuotaItemCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteTemplateQuotaItemRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) DeleteTemplateQuotaItemWithContext(ctx byteplus.Context, input *DeleteTemplateQuotaItemInput, opts ...request.Option) (*DeleteTemplateQuotaItemOutput, error) {
	req, out := c.DeleteTemplateQuotaItemRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
