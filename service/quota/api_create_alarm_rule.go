...
// CreateAlarmRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) CreateAlarmRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateAlarmRuleCommonRequest(input)
	req.SetContext(ctx)
...
// CreateAlarmRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) CreateAlarmRuleWithContext(ctx byteplus.Context, input *CreateAlarmRuleInput, opts ...request.Option) (*CreateAlarmRuleOutput, error) {
	req, out := c.CreateAlarmRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
