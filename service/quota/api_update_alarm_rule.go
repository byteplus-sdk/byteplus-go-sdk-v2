...
// UpdateAlarmRuleCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) UpdateAlarmRuleCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateAlarmRuleCommonRequest(input)
	req.SetContext(ctx)
...
// UpdateAlarmRuleRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) UpdateAlarmRuleWithContext(ctx byteplus.Context, input *UpdateAlarmRuleInput, opts ...request.Option) (*UpdateAlarmRuleOutput, error) {
	req, out := c.UpdateAlarmRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
