...
// CreateQuotaApplicationCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) CreateQuotaApplicationCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateQuotaApplicationCommonRequest(input)
	req.SetContext(ctx)
...
// CreateQuotaApplicationRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) CreateQuotaApplicationWithContext(ctx byteplus.Context, input *CreateQuotaApplicationInput, opts ...request.Option) (*CreateQuotaApplicationOutput, error) {
	req, out := c.CreateQuotaApplicationRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
