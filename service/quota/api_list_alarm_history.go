...
// ListAlarmHistoryCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListAlarmHistoryCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAlarmHistoryCommonRequest(input)
	req.SetContext(ctx)
...
// ListAlarmHistoryRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListAlarmHistoryWithContext(ctx byteplus.Context, input *ListAlarmHistoryInput, opts ...request.Option) (*ListAlarmHistoryOutput, error) {
	req, out := c.ListAlarmHistoryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
