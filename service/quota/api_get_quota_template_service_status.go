...
// GetQuotaTemplateServiceStatusCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) GetQuotaTemplateServiceStatusCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetQuotaTemplateServiceStatusCommonRequest(input)
	req.SetContext(ctx)
...
// GetQuotaTemplateServiceStatusRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) GetQuotaTemplateServiceStatusWithContext(ctx byteplus.Context, input *GetQuotaTemplateServiceStatusInput, opts ...request.Option) (*GetQuotaTemplateServiceStatusOutput, error) {
	req, out := c.GetQuotaTemplateServiceStatusRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
