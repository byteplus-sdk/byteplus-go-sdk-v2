...
// ModifyTemplateQuotaItemCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ModifyTemplateQuotaItemCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyTemplateQuotaItemCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyTemplateQuotaItemRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ModifyTemplateQuotaItemWithContext(ctx byteplus.Context, input *ModifyTemplateQuotaItemInput, opts ...request.Option) (*ModifyTemplateQuotaItemOutput, error) {
	req, out := c.ModifyTemplateQuotaItemRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
