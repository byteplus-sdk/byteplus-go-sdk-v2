...
// ListQuotaApplicationsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListQuotaApplicationsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListQuotaApplicationsCommonRequest(input)
	req.SetContext(ctx)
...
// ListQuotaApplicationsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListQuotaApplicationsWithContext(ctx byteplus.Context, input *ListQuotaApplicationsInput, opts ...request.Option) (*ListQuotaApplicationsOutput, error) {
	req, out := c.ListQuotaApplicationsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
