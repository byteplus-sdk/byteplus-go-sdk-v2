...
// CreateTemplateQuotaItemCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) CreateTemplateQuotaItemCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateTemplateQuotaItemCommonRequest(input)
	req.SetContext(ctx)
...
// CreateTemplateQuotaItemRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) CreateTemplateQuotaItemWithContext(ctx byteplus.Context, input *CreateTemplateQuotaItemInput, opts ...request.Option) (*CreateTemplateQuotaItemOutput, error) {
	req, out := c.CreateTemplateQuotaItemRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
