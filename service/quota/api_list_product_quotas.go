...
// ListProductQuotasCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) ListProductQuotasCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListProductQuotasCommonRequest(input)
	req.SetContext(ctx)
...
// ListProductQuotasRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) ListProductQuotasWithContext(ctx byteplus.Context, input *ListProductQuotasInput, opts ...request.Option) (*ListProductQuotasOutput, error) {
	req, out := c.ListProductQuotasRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
