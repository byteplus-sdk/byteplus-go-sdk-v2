...
// GetQuotaApplicationCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *QUOTA) GetQuotaApplicationCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetQuotaApplicationCommonRequest(input)
	req.SetContext(ctx)
...
// GetQuotaApplicationRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *QUOTA) GetQuotaApplicationWithContext(ctx byteplus.Context, input *GetQuotaApplicationInput, opts ...request.Option) (*GetQuotaApplicationOutput, error) {
	req, out := c.GetQuotaApplicationRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
