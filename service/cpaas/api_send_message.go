...
// SendMessageCommonRequest generates a "byteplus/request.Request" representing the
...
// SendMessageRequest generates a "byteplus/request.Request" representing the
