...
// SMC provides the API operation methods for making requests to
// SMC. See this package's package overview docs
// for details on the service.
//
// SMC methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SMC {
	svc := &SMC{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SMC operation and runs any
// custom request initialization.
func (c *SMC) newRequest(op *request.Operation, params, data interface{}) *request.Request {
