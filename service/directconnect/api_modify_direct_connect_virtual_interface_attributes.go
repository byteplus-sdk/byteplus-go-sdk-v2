...
// ModifyDirectConnectVirtualInterfaceAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyDirectConnectVirtualInterfaceAttributesRequest generates a "byteplus/request.Request" representing the
...
func (s *ModifyDirectConnectVirtualInterfaceAttributesInput) SetEnableBfdEcho(v bool) *ModifyDirectConnectVirtualInterfaceAttributesInput {
	s.EnableBfdEcho = &v
	return s
}
