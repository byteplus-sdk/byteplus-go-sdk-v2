...
// ApplyDirectConnectConnectionLoaCommonRequest generates a "byteplus/request.Request" representing the
...
// ApplyDirectConnectConnectionLoaRequest generates a "byteplus/request.Request" representing the
