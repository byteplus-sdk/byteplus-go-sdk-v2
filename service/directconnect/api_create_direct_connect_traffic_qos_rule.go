...
// CreateDirectConnectTrafficQosRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDirectConnectTrafficQosRuleRequest generates a "byteplus/request.Request" representing the
