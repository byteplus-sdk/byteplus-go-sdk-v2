...
// DescribeBgpPeersCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeBgpPeersRequest generates a "byteplus/request.Request" representing the
