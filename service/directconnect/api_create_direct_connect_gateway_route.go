...
// CreateDirectConnectGatewayRouteCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDirectConnectGatewayRouteRequest generates a "byteplus/request.Request" representing the
