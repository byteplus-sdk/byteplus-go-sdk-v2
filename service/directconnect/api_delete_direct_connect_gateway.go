...
// DeleteDirectConnectGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteDirectConnectGatewayRequest generates a "byteplus/request.Request" representing the
