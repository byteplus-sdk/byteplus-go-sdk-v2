...
// DescribeDirectConnectGatewayRoutesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDirectConnectGatewayRoutesRequest generates a "byteplus/request.Request" representing the
