...
// CreateBgpPeerCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateBgpPeerRequest generates a "byteplus/request.Request" representing the
