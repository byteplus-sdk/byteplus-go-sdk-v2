...
// AllocateDirectConnectVirtualInterfaceCommonRequest generates a "byteplus/request.Request" representing the
...
// AllocateDirectConnectVirtualInterfaceRequest generates a "byteplus/request.Request" representing the
