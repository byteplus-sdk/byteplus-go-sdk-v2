...
// DeleteBgpPeerCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteBgpPeerRequest generates a "byteplus/request.Request" representing the
