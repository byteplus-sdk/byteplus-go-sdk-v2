...
// ModifyBgpPeerAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyBgpPeerAttributesRequest generates a "byteplus/request.Request" representing the
