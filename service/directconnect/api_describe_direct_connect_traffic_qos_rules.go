...
// DescribeDirectConnectTrafficQosRulesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDirectConnectTrafficQosRulesRequest generates a "byteplus/request.Request" representing the
