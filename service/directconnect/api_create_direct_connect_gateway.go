...
// CreateDirectConnectGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDirectConnectGatewayRequest generates a "byteplus/request.Request" representing the
