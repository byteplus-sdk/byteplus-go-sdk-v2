...
// DescribeBgpPeerAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeBgpPeerAttributesRequest generates a "byteplus/request.Request" representing the
