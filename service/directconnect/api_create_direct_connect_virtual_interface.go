...
// CreateDirectConnectVirtualInterfaceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDirectConnectVirtualInterfaceRequest generates a "byteplus/request.Request" representing the
