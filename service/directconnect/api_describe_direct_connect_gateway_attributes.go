...
// DescribeDirectConnectGatewayAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDirectConnectGatewayAttributesRequest generates a "byteplus/request.Request" representing the
