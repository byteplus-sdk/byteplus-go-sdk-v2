...
// DescribeCrossBackupPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeCrossBackupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCrossBackupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCrossBackupPolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeCrossBackupPolicyWithContext(ctx byteplus.Context, input *DescribeCrossBackupPolicyInput, opts ...request.Option) (*DescribeCrossBackupPolicyOutput, error) {
	req, out := c.DescribeCrossBackupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
