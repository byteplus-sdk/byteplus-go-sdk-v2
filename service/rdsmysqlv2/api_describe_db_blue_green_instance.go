...
// DescribeDBBlueGreenInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBBlueGreenInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBBlueGreenInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBBlueGreenInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBBlueGreenInstanceWithContext(ctx byteplus.Context, input *DescribeDBBlueGreenInstanceInput, opts ...request.Option) (*DescribeDBBlueGreenInstanceOutput, error) {
	req, out := c.DescribeDBBlueGreenInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
