...
// DescribeDBProxyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBProxyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBProxyCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBProxyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBProxyWithContext(ctx byteplus.Context, input *DescribeDBProxyInput, opts ...request.Option) (*DescribeDBProxyOutput, error) {
	req, out := c.DescribeDBProxyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
