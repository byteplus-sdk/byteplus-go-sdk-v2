...
// CreateDrDBInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CreateDrDBInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDrDBInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDrDBInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CreateDrDBInstanceWithContext(ctx byteplus.Context, input *CreateDrDBInstanceInput, opts ...request.Option) (*CreateDrDBInstanceOutput, error) {
	req, out := c.CreateDrDBInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
