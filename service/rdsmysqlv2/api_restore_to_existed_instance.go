...
// RestoreToExistedInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RestoreToExistedInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RestoreToExistedInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RestoreToExistedInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RestoreToExistedInstanceWithContext(ctx byteplus.Context, input *RestoreToExistedInstanceInput, opts ...request.Option) (*RestoreToExistedInstanceOutput, error) {
	req, out := c.RestoreToExistedInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
