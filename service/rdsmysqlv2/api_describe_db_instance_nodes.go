...
// DescribeDBInstanceNodesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBInstanceNodesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceNodesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceNodesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceNodesWithContext(ctx byteplus.Context, input *DescribeDBInstanceNodesInput, opts ...request.Option) (*DescribeDBInstanceNodesOutput, error) {
	req, out := c.DescribeDBInstanceNodesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
