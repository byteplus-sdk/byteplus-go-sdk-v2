...
// ModifyDatabaseDescriptionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDatabaseDescriptionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDatabaseDescriptionCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDatabaseDescriptionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDatabaseDescriptionWithContext(ctx byteplus.Context, input *ModifyDatabaseDescriptionInput, opts ...request.Option) (*ModifyDatabaseDescriptionOutput, error) {
	req, out := c.ModifyDatabaseDescriptionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
