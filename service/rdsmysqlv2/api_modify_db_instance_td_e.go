...
// ModifyDBInstanceTDECommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBInstanceTDECommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceTDECommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceTDERequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceTDEWithContext(ctx byteplus.Context, input *ModifyDBInstanceTDEInput, opts ...request.Option) (*ModifyDBInstanceTDEOutput, error) {
	req, out := c.ModifyDBInstanceTDERequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
