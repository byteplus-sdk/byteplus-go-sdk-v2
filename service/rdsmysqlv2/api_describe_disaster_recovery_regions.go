...
// DescribeDisasterRecoveryRegionsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDisasterRecoveryRegionsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDisasterRecoveryRegionsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDisasterRecoveryRegionsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDisasterRecoveryRegionsWithContext(ctx byteplus.Context, input *DescribeDisasterRecoveryRegionsInput, opts ...request.Option) (*DescribeDisasterRecoveryRegionsOutput, error) {
	req, out := c.DescribeDisasterRecoveryRegionsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
