...
// UpgradeDBInstanceEngineMajorVersionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMajorVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpgradeDBInstanceEngineMajorVersionCommonRequest(input)
	req.SetContext(ctx)
...
// UpgradeDBInstanceEngineMajorVersionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMajorVersionWithContext(ctx byteplus.Context, input *UpgradeDBInstanceEngineMajorVersionInput, opts ...request.Option) (*UpgradeDBInstanceEngineMajorVersionOutput, error) {
	req, out := c.UpgradeDBInstanceEngineMajorVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
