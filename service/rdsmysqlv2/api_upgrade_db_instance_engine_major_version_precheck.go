...
// UpgradeDBInstanceEngineMajorVersionPrecheckCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMajorVersionPrecheckCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpgradeDBInstanceEngineMajorVersionPrecheckCommonRequest(input)
	req.SetContext(ctx)
...
// UpgradeDBInstanceEngineMajorVersionPrecheckRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMajorVersionPrecheckWithContext(ctx byteplus.Context, input *UpgradeDBInstanceEngineMajorVersionPrecheckInput, opts ...request.Option) (*UpgradeDBInstanceEngineMajorVersionPrecheckOutput, error) {
	req, out := c.UpgradeDBInstanceEngineMajorVersionPrecheckRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
