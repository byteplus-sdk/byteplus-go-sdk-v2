...
// DescribeResourcePackagePriceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeResourcePackagePriceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeResourcePackagePriceCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeResourcePackagePriceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeResourcePackagePriceWithContext(ctx byteplus.Context, input *DescribeResourcePackagePriceInput, opts ...request.Option) (*DescribeResourcePackagePriceOutput, error) {
	req, out := c.DescribeResourcePackagePriceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
