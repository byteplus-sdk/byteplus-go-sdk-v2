...
// DescribeDBProxyPriceDetailCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBProxyPriceDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBProxyPriceDetailCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBProxyPriceDetailRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBProxyPriceDetailWithContext(ctx byteplus.Context, input *DescribeDBProxyPriceDetailInput, opts ...request.Option) (*DescribeDBProxyPriceDetailOutput, error) {
	req, out := c.DescribeDBProxyPriceDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
