...
// DeleteDBNodesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DeleteDBNodesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteDBNodesCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteDBNodesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DeleteDBNodesWithContext(ctx byteplus.Context, input *DeleteDBNodesInput, opts ...request.Option) (*DeleteDBNodesOutput, error) {
	req, out := c.DeleteDBNodesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
