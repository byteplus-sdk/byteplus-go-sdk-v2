...
// DescribeDBInstanceChargeDetailCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBInstanceChargeDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceChargeDetailCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceChargeDetailRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceChargeDetailWithContext(ctx byteplus.Context, input *DescribeDBInstanceChargeDetailInput, opts ...request.Option) (*DescribeDBInstanceChargeDetailOutput, error) {
	req, out := c.DescribeDBInstanceChargeDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
