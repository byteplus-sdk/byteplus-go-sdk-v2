...
// ListParameterTemplatesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ListParameterTemplatesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListParameterTemplatesCommonRequest(input)
	req.SetContext(ctx)
...
// ListParameterTemplatesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ListParameterTemplatesWithContext(ctx byteplus.Context, input *ListParameterTemplatesInput, opts ...request.Option) (*ListParameterTemplatesOutput, error) {
	req, out := c.ListParameterTemplatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
