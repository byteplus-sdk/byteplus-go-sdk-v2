...
// ModifyDBEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBEndpointCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBEndpointRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBEndpointWithContext(ctx byteplus.Context, input *ModifyDBEndpointInput, opts ...request.Option) (*ModifyDBEndpointOutput, error) {
	req, out := c.ModifyDBEndpointRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
