...
// CopyParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CopyParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CopyParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// CopyParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CopyParameterTemplateWithContext(ctx byteplus.Context, input *CopyParameterTemplateInput, opts ...request.Option) (*CopyParameterTemplateOutput, error) {
	req, out := c.CopyParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
