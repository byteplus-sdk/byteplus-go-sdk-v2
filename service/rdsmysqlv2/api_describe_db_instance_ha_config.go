...
// DescribeDBInstanceHAConfigCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBInstanceHAConfigCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceHAConfigCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceHAConfigRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceHAConfigWithContext(ctx byteplus.Context, input *DescribeDBInstanceHAConfigInput, opts ...request.Option) (*DescribeDBInstanceHAConfigOutput, error) {
	req, out := c.DescribeDBInstanceHAConfigRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
