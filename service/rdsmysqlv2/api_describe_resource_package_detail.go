...
// DescribeResourcePackageDetailCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeResourcePackageDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeResourcePackageDetailCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeResourcePackageDetailRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeResourcePackageDetailWithContext(ctx byteplus.Context, input *DescribeResourcePackageDetailInput, opts ...request.Option) (*DescribeResourcePackageDetailOutput, error) {
	req, out := c.DescribeResourcePackageDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
