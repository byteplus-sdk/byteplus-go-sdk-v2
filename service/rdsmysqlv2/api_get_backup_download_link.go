...
// GetBackupDownloadLinkCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) GetBackupDownloadLinkCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetBackupDownloadLinkCommonRequest(input)
	req.SetContext(ctx)
...
// GetBackupDownloadLinkRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) GetBackupDownloadLinkWithContext(ctx byteplus.Context, input *GetBackupDownloadLinkInput, opts ...request.Option) (*GetBackupDownloadLinkOutput, error) {
	req, out := c.GetBackupDownloadLinkRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
