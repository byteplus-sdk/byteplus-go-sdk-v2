...
// DescribeResourceUsageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeResourceUsageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeResourceUsageCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeResourceUsageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeResourceUsageWithContext(ctx byteplus.Context, input *DescribeResourceUsageInput, opts ...request.Option) (*DescribeResourceUsageOutput, error) {
	req, out := c.DescribeResourceUsageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
