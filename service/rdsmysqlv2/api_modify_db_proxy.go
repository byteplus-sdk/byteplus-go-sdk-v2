...
// ModifyDBProxyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBProxyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBProxyCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBProxyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBProxyWithContext(ctx byteplus.Context, input *ModifyDBProxyInput, opts ...request.Option) (*ModifyDBProxyOutput, error) {
	req, out := c.ModifyDBProxyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
