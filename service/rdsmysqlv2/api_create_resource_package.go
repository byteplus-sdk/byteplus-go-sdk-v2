...
// CreateResourcePackageCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CreateResourcePackageCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateResourcePackageCommonRequest(input)
	req.SetContext(ctx)
...
// CreateResourcePackageRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CreateResourcePackageWithContext(ctx byteplus.Context, input *CreateResourcePackageInput, opts ...request.Option) (*CreateResourcePackageOutput, error) {
	req, out := c.CreateResourcePackageRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
