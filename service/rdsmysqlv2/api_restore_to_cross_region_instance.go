...
// RestoreToCrossRegionInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RestoreToCrossRegionInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RestoreToCrossRegionInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RestoreToCrossRegionInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RestoreToCrossRegionInstanceWithContext(ctx byteplus.Context, input *RestoreToCrossRegionInstanceInput, opts ...request.Option) (*RestoreToCrossRegionInstanceOutput, error) {
	req, out := c.RestoreToCrossRegionInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
