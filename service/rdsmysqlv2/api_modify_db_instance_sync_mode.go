...
// ModifyDBInstanceSyncModeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBInstanceSyncModeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceSyncModeCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceSyncModeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceSyncModeWithContext(ctx byteplus.Context, input *ModifyDBInstanceSyncModeInput, opts ...request.Option) (*ModifyDBInstanceSyncModeOutput, error) {
	req, out := c.ModifyDBInstanceSyncModeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
