...
// CreateParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CreateParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// CreateParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CreateParameterTemplateWithContext(ctx byteplus.Context, input *CreateParameterTemplateInput, opts ...request.Option) (*CreateParameterTemplateOutput, error) {
	req, out := c.CreateParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
