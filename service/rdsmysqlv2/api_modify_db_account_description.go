...
// ModifyDBAccountDescriptionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBAccountDescriptionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBAccountDescriptionCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBAccountDescriptionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBAccountDescriptionWithContext(ctx byteplus.Context, input *ModifyDBAccountDescriptionInput, opts ...request.Option) (*ModifyDBAccountDescriptionOutput, error) {
	req, out := c.ModifyDBAccountDescriptionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
