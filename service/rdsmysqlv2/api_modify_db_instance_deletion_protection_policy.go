...
// ModifyDBInstanceDeletionProtectionPolicyCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBInstanceDeletionProtectionPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceDeletionProtectionPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceDeletionProtectionPolicyRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceDeletionProtectionPolicyWithContext(ctx byteplus.Context, input *ModifyDBInstanceDeletionProtectionPolicyInput, opts ...request.Option) (*ModifyDBInstanceDeletionProtectionPolicyOutput, error) {
	req, out := c.ModifyDBInstanceDeletionProtectionPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
