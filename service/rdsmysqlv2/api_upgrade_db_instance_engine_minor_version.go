...
// UpgradeDBInstanceEngineMinorVersionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMinorVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpgradeDBInstanceEngineMinorVersionCommonRequest(input)
	req.SetContext(ctx)
...
// UpgradeDBInstanceEngineMinorVersionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) UpgradeDBInstanceEngineMinorVersionWithContext(ctx byteplus.Context, input *UpgradeDBInstanceEngineMinorVersionInput, opts ...request.Option) (*UpgradeDBInstanceEngineMinorVersionOutput, error) {
	req, out := c.UpgradeDBInstanceEngineMinorVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
