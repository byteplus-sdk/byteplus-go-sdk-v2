...
// SwitchDBInstanceHACommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SwitchDBInstanceHACommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchDBInstanceHACommonRequest(input)
	req.SetContext(ctx)
...
// SwitchDBInstanceHARequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SwitchDBInstanceHAWithContext(ctx byteplus.Context, input *SwitchDBInstanceHAInput, opts ...request.Option) (*SwitchDBInstanceHAOutput, error) {
	req, out := c.SwitchDBInstanceHARequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
