...
// DescribeDBNodeParameterDifferencesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBNodeParameterDifferencesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBNodeParameterDifferencesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBNodeParameterDifferencesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBNodeParameterDifferencesWithContext(ctx byteplus.Context, input *DescribeDBNodeParameterDifferencesInput, opts ...request.Option) (*DescribeDBNodeParameterDifferencesOutput, error) {
	req, out := c.DescribeDBNodeParameterDifferencesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
