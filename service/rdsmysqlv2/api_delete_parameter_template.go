...
// DeleteParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DeleteParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DeleteParameterTemplateWithContext(ctx byteplus.Context, input *DeleteParameterTemplateInput, opts ...request.Option) (*DeleteParameterTemplateOutput, error) {
	req, out := c.DeleteParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
