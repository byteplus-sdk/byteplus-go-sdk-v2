...
func (c *RDSMYSQLV2) UpgradeAllowListVersionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpgradeAllowListVersionCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) UpgradeAllowListVersionWithContext(ctx byteplus.Context, input *UpgradeAllowListVersionInput, opts ...request.Option) (*UpgradeAllowListVersionOutput, error) {
	req, out := c.UpgradeAllowListVersionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
