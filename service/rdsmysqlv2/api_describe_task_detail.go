...
// DescribeTaskDetailCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeTaskDetailCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeTaskDetailCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeTaskDetailRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeTaskDetailWithContext(ctx byteplus.Context, input *DescribeTaskDetailInput, opts ...request.Option) (*DescribeTaskDetailOutput, error) {
	req, out := c.DescribeTaskDetailRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
