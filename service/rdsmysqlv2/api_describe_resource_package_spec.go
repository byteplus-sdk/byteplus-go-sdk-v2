...
// DescribeResourcePackageSpecCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeResourcePackageSpecCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeResourcePackageSpecCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeResourcePackageSpecRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeResourcePackageSpecWithContext(ctx byteplus.Context, input *DescribeResourcePackageSpecInput, opts ...request.Option) (*DescribeResourcePackageSpecOutput, error) {
	req, out := c.DescribeResourcePackageSpecRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
