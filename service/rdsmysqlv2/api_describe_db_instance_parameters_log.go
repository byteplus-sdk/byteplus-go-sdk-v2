...
func (c *RDSMYSQLV2) DescribeDBInstanceParametersLogCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceParametersLogCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceParametersLogWithContext(ctx byteplus.Context, input *DescribeDBInstanceParametersLogInput, opts ...request.Option) (*DescribeDBInstanceParametersLogOutput, error) {
	req, out := c.DescribeDBInstanceParametersLogRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
