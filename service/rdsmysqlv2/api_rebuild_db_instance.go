...
// RebuildDBInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RebuildDBInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RebuildDBInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// RebuildDBInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RebuildDBInstanceWithContext(ctx byteplus.Context, input *RebuildDBInstanceInput, opts ...request.Option) (*RebuildDBInstanceOutput, error) {
	req, out := c.RebuildDBInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
