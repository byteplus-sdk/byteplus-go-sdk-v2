...
func (c *RDSMYSQLV2) ModifyDBEndpointAddressCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointAddressCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBEndpointAddressWithContext(ctx byteplus.Context, input *ModifyDBEndpointAddressInput, opts ...request.Option) (*ModifyDBEndpointAddressOutput, error) {
	req, out := c.ModifyDBEndpointAddressRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
