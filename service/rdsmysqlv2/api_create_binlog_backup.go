...
// CreateBinlogBackupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CreateBinlogBackupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateBinlogBackupCommonRequest(input)
	req.SetContext(ctx)
...
// CreateBinlogBackupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CreateBinlogBackupWithContext(ctx byteplus.Context, input *CreateBinlogBackupInput, opts ...request.Option) (*CreateBinlogBackupOutput, error) {
	req, out := c.CreateBinlogBackupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
