...
// CreateDBBlueGreenInstanceCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CreateDBBlueGreenInstanceCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateDBBlueGreenInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// CreateDBBlueGreenInstanceRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CreateDBBlueGreenInstanceWithContext(ctx byteplus.Context, input *CreateDBBlueGreenInstanceInput, opts ...request.Option) (*CreateDBBlueGreenInstanceOutput, error) {
	req, out := c.CreateDBBlueGreenInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
