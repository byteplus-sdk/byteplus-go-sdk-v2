...
func (c *RDSMYSQLV2) ModifyDBInstanceParametersCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceParametersCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceParametersWithContext(ctx byteplus.Context, input *ModifyDBInstanceParametersInput, opts ...request.Option) (*ModifyDBInstanceParametersOutput, error) {
	req, out := c.ModifyDBInstanceParametersRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
