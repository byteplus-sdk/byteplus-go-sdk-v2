...
// RestoreToNewInstanceFromUserTosCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RestoreToNewInstanceFromUserTosCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RestoreToNewInstanceFromUserTosCommonRequest(input)
	req.SetContext(ctx)
...
// RestoreToNewInstanceFromUserTosRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RestoreToNewInstanceFromUserTosWithContext(ctx byteplus.Context, input *RestoreToNewInstanceFromUserTosInput, opts ...request.Option) (*RestoreToNewInstanceFromUserTosOutput, error) {
	req, out := c.RestoreToNewInstanceFromUserTosRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
