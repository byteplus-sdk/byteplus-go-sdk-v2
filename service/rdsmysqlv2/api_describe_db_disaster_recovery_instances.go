...
// DescribeDBDisasterRecoveryInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBDisasterRecoveryInstancesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBDisasterRecoveryInstancesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBDisasterRecoveryInstancesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBDisasterRecoveryInstancesWithContext(ctx byteplus.Context, input *DescribeDBDisasterRecoveryInstancesInput, opts ...request.Option) (*DescribeDBDisasterRecoveryInstancesOutput, error) {
	req, out := c.DescribeDBDisasterRecoveryInstancesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
