...
// SwitchDrInstanceToMasterCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SwitchDrInstanceToMasterCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchDrInstanceToMasterCommonRequest(input)
	req.SetContext(ctx)
...
// SwitchDrInstanceToMasterRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SwitchDrInstanceToMasterWithContext(ctx byteplus.Context, input *SwitchDrInstanceToMasterInput, opts ...request.Option) (*SwitchDrInstanceToMasterOutput, error) {
	req, out := c.SwitchDrInstanceToMasterRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
