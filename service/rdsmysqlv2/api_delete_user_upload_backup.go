...
// DeleteUserUploadBackupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DeleteUserUploadBackupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteUserUploadBackupCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteUserUploadBackupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DeleteUserUploadBackupWithContext(ctx byteplus.Context, input *DeleteUserUploadBackupInput, opts ...request.Option) (*DeleteUserUploadBackupOutput, error) {
	req, out := c.DeleteUserUploadBackupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
