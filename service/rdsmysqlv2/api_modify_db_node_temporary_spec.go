...
// ModifyDBNodeTemporarySpecCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBNodeTemporarySpecCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBNodeTemporarySpecCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBNodeTemporarySpecRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBNodeTemporarySpecWithContext(ctx byteplus.Context, input *ModifyDBNodeTemporarySpecInput, opts ...request.Option) (*ModifyDBNodeTemporarySpecOutput, error) {
	req, out := c.ModifyDBNodeTemporarySpecRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
