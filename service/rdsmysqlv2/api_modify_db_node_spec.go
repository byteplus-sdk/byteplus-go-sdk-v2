...
// ModifyDBNodeSpecCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBNodeSpecCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBNodeSpecCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBNodeSpecRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBNodeSpecWithContext(ctx byteplus.Context, input *ModifyDBNodeSpecInput, opts ...request.Option) (*ModifyDBNodeSpecOutput, error) {
	req, out := c.ModifyDBNodeSpecRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
