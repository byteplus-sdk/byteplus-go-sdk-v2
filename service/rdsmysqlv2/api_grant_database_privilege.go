...
// GrantDatabasePrivilegeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) GrantDatabasePrivilegeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GrantDatabasePrivilegeCommonRequest(input)
	req.SetContext(ctx)
...
// GrantDatabasePrivilegeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) GrantDatabasePrivilegeWithContext(ctx byteplus.Context, input *GrantDatabasePrivilegeInput, opts ...request.Option) (*GrantDatabasePrivilegeOutput, error) {
	req, out := c.GrantDatabasePrivilegeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
