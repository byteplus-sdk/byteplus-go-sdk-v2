...
func (c *RDSMYSQLV2) DescribeDBInstanceTDECommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceTDECommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceTDEWithContext(ctx byteplus.Context, input *DescribeDBInstanceTDEInput, opts ...request.Option) (*DescribeDBInstanceTDEOutput, error) {
	req, out := c.DescribeDBInstanceTDERequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
