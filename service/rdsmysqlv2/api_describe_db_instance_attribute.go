...
// DescribeDBInstanceAttributeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBInstanceAttributeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceAttributeCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceAttributeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceAttributeWithContext(ctx byteplus.Context, input *DescribeDBInstanceAttributeInput, opts ...request.Option) (*DescribeDBInstanceAttributeOutput, error) {
	req, out := c.DescribeDBInstanceAttributeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
