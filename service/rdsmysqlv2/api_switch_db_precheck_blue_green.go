...
// SwitchDBPrecheckBlueGreenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SwitchDBPrecheckBlueGreenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchDBPrecheckBlueGreenCommonRequest(input)
	req.SetContext(ctx)
...
// SwitchDBPrecheckBlueGreenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SwitchDBPrecheckBlueGreenWithContext(ctx byteplus.Context, input *SwitchDBPrecheckBlueGreenInput, opts ...request.Option) (*SwitchDBPrecheckBlueGreenOutput, error) {
	req, out := c.SwitchDBPrecheckBlueGreenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
