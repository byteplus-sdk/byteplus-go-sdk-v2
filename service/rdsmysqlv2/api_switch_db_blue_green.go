...
// SwitchDBBlueGreenCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SwitchDBBlueGreenCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SwitchDBBlueGreenCommonRequest(input)
	req.SetContext(ctx)
...
// SwitchDBBlueGreenRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SwitchDBBlueGreenWithContext(ctx byteplus.Context, input *SwitchDBBlueGreenInput, opts ...request.Option) (*SwitchDBBlueGreenOutput, error) {
	req, out := c.SwitchDBBlueGreenRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
