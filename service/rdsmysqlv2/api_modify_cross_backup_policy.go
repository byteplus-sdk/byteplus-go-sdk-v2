...
func (c *RDSMYSQLV2) ModifyCrossBackupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyCrossBackupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyCrossBackupPolicyWithContext(ctx byteplus.Context, input *ModifyCrossBackupPolicyInput, opts ...request.Option) (*ModifyCrossBackupPolicyOutput, error) {
	req, out := c.ModifyCrossBackupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *ModifyCrossBackupPolicyInput) SetCrossBackupAllRetention(v bool) *ModifyCrossBackupPolicyInput {
...
// SetCrossBackupAllRetention sets the CrossBackupAllRetention field's value.
func (s *ModifyCrossBackupPolicyOutput) SetCrossBackupAllRetention(v bool) *ModifyCrossBackupPolicyOutput {
	s.CrossBackupAllRetention = &v
	return s
}
