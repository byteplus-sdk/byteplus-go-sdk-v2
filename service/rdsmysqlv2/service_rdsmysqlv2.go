...
func New(p client.ConfigProvider, cfgs ...*byteplus.Config) *RDSMYSQLV2 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *RDSMYSQLV2 {
	svc := &RDSMYSQLV2{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
