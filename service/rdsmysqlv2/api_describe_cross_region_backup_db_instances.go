...
// DescribeCrossRegionBackupDBInstancesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeCrossRegionBackupDBInstancesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCrossRegionBackupDBInstancesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeCrossRegionBackupDBInstancesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeCrossRegionBackupDBInstancesWithContext(ctx byteplus.Context, input *DescribeCrossRegionBackupDBInstancesInput, opts ...request.Option) (*DescribeCrossRegionBackupDBInstancesOutput, error) {
	req, out := c.DescribeCrossRegionBackupDBInstancesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
