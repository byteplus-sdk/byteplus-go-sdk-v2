...
// ListResourcePackagesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ListResourcePackagesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourcePackagesCommonRequest(input)
	req.SetContext(ctx)
...
// ListResourcePackagesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ListResourcePackagesWithContext(ctx byteplus.Context, input *ListResourcePackagesInput, opts ...request.Option) (*ListResourcePackagesOutput, error) {
	req, out := c.ListResourcePackagesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
