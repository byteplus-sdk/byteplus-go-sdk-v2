...
// CheckUserUploadBackupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CheckUserUploadBackupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CheckUserUploadBackupCommonRequest(input)
	req.SetContext(ctx)
...
// CheckUserUploadBackupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CheckUserUploadBackupWithContext(ctx byteplus.Context, input *CheckUserUploadBackupInput, opts ...request.Option) (*CheckUserUploadBackupOutput, error) {
	req, out := c.CheckUserUploadBackupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
