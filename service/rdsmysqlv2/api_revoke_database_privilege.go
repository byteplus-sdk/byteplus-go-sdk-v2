...
// RevokeDatabasePrivilegeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RevokeDatabasePrivilegeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RevokeDatabasePrivilegeCommonRequest(input)
	req.SetContext(ctx)
...
// RevokeDatabasePrivilegeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RevokeDatabasePrivilegeWithContext(ctx byteplus.Context, input *RevokeDatabasePrivilegeInput, opts ...request.Option) (*RevokeDatabasePrivilegeOutput, error) {
	req, out := c.RevokeDatabasePrivilegeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
