...
// DescribeNonWhiteSessionListCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeNonWhiteSessionListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeNonWhiteSessionListCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeNonWhiteSessionListRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeNonWhiteSessionListWithContext(ctx byteplus.Context, input *DescribeNonWhiteSessionListInput, opts ...request.Option) (*DescribeNonWhiteSessionListOutput, error) {
	req, out := c.DescribeNonWhiteSessionListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
