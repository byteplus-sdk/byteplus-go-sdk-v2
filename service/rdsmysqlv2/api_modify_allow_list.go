...
func (c *RDSMYSQLV2) ModifyAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyAllowListWithContext(ctx byteplus.Context, input *ModifyAllowListInput, opts ...request.Option) (*ModifyAllowListOutput, error) {
	req, out := c.ModifyAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
