...
// DescribeUpgradeEngineMajorVersionPrecheckResultCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeUpgradeEngineMajorVersionPrecheckResultCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeUpgradeEngineMajorVersionPrecheckResultCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeUpgradeEngineMajorVersionPrecheckResultRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeUpgradeEngineMajorVersionPrecheckResultWithContext(ctx byteplus.Context, input *DescribeUpgradeEngineMajorVersionPrecheckResultInput, opts ...request.Option) (*DescribeUpgradeEngineMajorVersionPrecheckResultOutput, error) {
	req, out := c.DescribeUpgradeEngineMajorVersionPrecheckResultRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
