...
// SyncAllowListCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SyncAllowListCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SyncAllowListCommonRequest(input)
	req.SetContext(ctx)
...
// SyncAllowListRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SyncAllowListWithContext(ctx byteplus.Context, input *SyncAllowListInput, opts ...request.Option) (*SyncAllowListOutput, error) {
	req, out := c.SyncAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
