...
// DescribeDbAccountTableColumnInfoCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDbAccountTableColumnInfoCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDbAccountTableColumnInfoCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDbAccountTableColumnInfoRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDbAccountTableColumnInfoWithContext(ctx byteplus.Context, input *DescribeDbAccountTableColumnInfoInput, opts ...request.Option) (*DescribeDbAccountTableColumnInfoOutput, error) {
	req, out := c.DescribeDbAccountTableColumnInfoRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
