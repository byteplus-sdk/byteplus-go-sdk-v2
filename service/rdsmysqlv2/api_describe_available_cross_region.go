...
// DescribeAvailableCrossRegionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeAvailableCrossRegionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeAvailableCrossRegionCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeAvailableCrossRegionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeAvailableCrossRegionWithContext(ctx byteplus.Context, input *DescribeAvailableCrossRegionInput, opts ...request.Option) (*DescribeAvailableCrossRegionOutput, error) {
	req, out := c.DescribeAvailableCrossRegionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
