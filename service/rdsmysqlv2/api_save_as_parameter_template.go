...
// SaveAsParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) SaveAsParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SaveAsParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// SaveAsParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) SaveAsParameterTemplateWithContext(ctx byteplus.Context, input *SaveAsParameterTemplateInput, opts ...request.Option) (*SaveAsParameterTemplateOutput, error) {
	req, out := c.SaveAsParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
