...
// DescribeDBBlueGreenDifferencesCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBBlueGreenDifferencesCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBBlueGreenDifferencesCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBBlueGreenDifferencesRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBBlueGreenDifferencesWithContext(ctx byteplus.Context, input *DescribeDBBlueGreenDifferencesInput, opts ...request.Option) (*DescribeDBBlueGreenDifferencesOutput, error) {
	req, out := c.DescribeDBBlueGreenDifferencesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
