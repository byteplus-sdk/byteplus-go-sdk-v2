...
// DescribeUserUploadBackupsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeUserUploadBackupsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeUserUploadBackupsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeUserUploadBackupsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeUserUploadBackupsWithContext(ctx byteplus.Context, input *DescribeUserUploadBackupsInput, opts ...request.Option) (*DescribeUserUploadBackupsOutput, error) {
	req, out := c.DescribeUserUploadBackupsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
