...
func (c *RDSMYSQLV2) DownloadBackupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DownloadBackupCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DownloadBackupWithContext(ctx byteplus.Context, input *DownloadBackupInput, opts ...request.Option) (*DownloadBackupOutput, error) {
	req, out := c.DownloadBackupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
