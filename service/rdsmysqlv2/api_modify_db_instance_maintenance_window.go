...
// ModifyDBInstanceMaintenanceWindowCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBInstanceMaintenanceWindowCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceMaintenanceWindowCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceMaintenanceWindowRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceMaintenanceWindowWithContext(ctx byteplus.Context, input *ModifyDBInstanceMaintenanceWindowInput, opts ...request.Option) (*ModifyDBInstanceMaintenanceWindowOutput, error) {
	req, out := c.ModifyDBInstanceMaintenanceWindowRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
