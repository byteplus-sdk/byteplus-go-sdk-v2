...
// RemoveTagFromUserBackupInfoCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) RemoveTagFromUserBackupInfoCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.RemoveTagFromUserBackupInfoCommonRequest(input)
	req.SetContext(ctx)
...
// RemoveTagFromUserBackupInfoRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) RemoveTagFromUserBackupInfoWithContext(ctx byteplus.Context, input *RemoveTagFromUserBackupInfoInput, opts ...request.Option) (*RemoveTagFromUserBackupInfoOutput, error) {
	req, out := c.RemoveTagFromUserBackupInfoRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
