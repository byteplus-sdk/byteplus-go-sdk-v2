...
// AssociateUserBackupCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) AssociateUserBackupCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AssociateUserBackupCommonRequest(input)
	req.SetContext(ctx)
...
// AssociateUserBackupRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) AssociateUserBackupWithContext(ctx byteplus.Context, input *AssociateUserBackupInput, opts ...request.Option) (*AssociateUserBackupOutput, error) {
	req, out := c.AssociateUserBackupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
