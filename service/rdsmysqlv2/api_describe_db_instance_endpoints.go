...
// DescribeDBInstanceEndpointsCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBInstanceEndpointsCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBInstanceEndpointsCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBInstanceEndpointsRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBInstanceEndpointsWithContext(ctx byteplus.Context, input *DescribeDBInstanceEndpointsInput, opts ...request.Option) (*DescribeDBInstanceEndpointsOutput, error) {
	req, out := c.DescribeDBInstanceEndpointsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
