...
// AddDiagnosticsEntityCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) AddDiagnosticsEntityCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.AddDiagnosticsEntityCommonRequest(input)
	req.SetContext(ctx)
...
// AddDiagnosticsEntityRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) AddDiagnosticsEntityWithContext(ctx byteplus.Context, input *AddDiagnosticsEntityInput, opts ...request.Option) (*AddDiagnosticsEntityOutput, error) {
	req, out := c.AddDiagnosticsEntityRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
