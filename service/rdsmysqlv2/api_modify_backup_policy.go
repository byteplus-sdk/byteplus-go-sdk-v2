...
func (c *RDSMYSQLV2) ModifyBackupPolicyCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyBackupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyBackupPolicyWithContext(ctx byteplus.Context, input *ModifyBackupPolicyInput, opts ...request.Option) (*ModifyBackupPolicyOutput, error) {
	req, out := c.ModifyBackupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *ModifyBackupPolicyInput) SetLockDDLTimeSecond(v int32) *ModifyBackupPolicyInput {
