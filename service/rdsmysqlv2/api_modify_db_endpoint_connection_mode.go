...
// ModifyDBEndpointConnectionModeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBEndpointConnectionModeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBEndpointConnectionModeCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBEndpointConnectionModeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBEndpointConnectionModeWithContext(ctx byteplus.Context, input *ModifyDBEndpointConnectionModeInput, opts ...request.Option) (*ModifyDBEndpointConnectionModeOutput, error) {
	req, out := c.ModifyDBEndpointConnectionModeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
