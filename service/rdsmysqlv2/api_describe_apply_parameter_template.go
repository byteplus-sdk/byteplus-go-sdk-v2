...
// DescribeApplyParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeApplyParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeApplyParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeApplyParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeApplyParameterTemplateWithContext(ctx byteplus.Context, input *DescribeApplyParameterTemplateInput, opts ...request.Option) (*DescribeApplyParameterTemplateOutput, error) {
	req, out := c.DescribeApplyParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
