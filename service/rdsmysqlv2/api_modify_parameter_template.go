...
// ModifyParameterTemplateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyParameterTemplateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyParameterTemplateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyParameterTemplateWithContext(ctx byteplus.Context, input *ModifyParameterTemplateInput, opts ...request.Option) (*ModifyParameterTemplateOutput, error) {
	req, out := c.ModifyParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
