...
// CleanNonWhiteSessionCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) CleanNonWhiteSessionCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CleanNonWhiteSessionCommonRequest(input)
	req.SetContext(ctx)
...
// CleanNonWhiteSessionRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) CleanNonWhiteSessionWithContext(ctx byteplus.Context, input *CleanNonWhiteSessionInput, opts ...request.Option) (*CleanNonWhiteSessionOutput, error) {
	req, out := c.CleanNonWhiteSessionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
