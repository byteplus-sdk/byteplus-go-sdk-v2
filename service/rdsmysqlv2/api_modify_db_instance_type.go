...
// ModifyDBInstanceTypeCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) ModifyDBInstanceTypeCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyDBInstanceTypeCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyDBInstanceTypeRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) ModifyDBInstanceTypeWithContext(ctx byteplus.Context, input *ModifyDBInstanceTypeInput, opts ...request.Option) (*ModifyDBInstanceTypeOutput, error) {
	req, out := c.ModifyDBInstanceTypeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
