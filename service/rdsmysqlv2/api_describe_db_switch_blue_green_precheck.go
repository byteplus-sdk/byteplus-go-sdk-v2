...
// DescribeDBSwitchBlueGreenPrecheckCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeDBSwitchBlueGreenPrecheckCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeDBSwitchBlueGreenPrecheckCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeDBSwitchBlueGreenPrecheckRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeDBSwitchBlueGreenPrecheckWithContext(ctx byteplus.Context, input *DescribeDBSwitchBlueGreenPrecheckInput, opts ...request.Option) (*DescribeDBSwitchBlueGreenPrecheckOutput, error) {
	req, out := c.DescribeDBSwitchBlueGreenPrecheckRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
