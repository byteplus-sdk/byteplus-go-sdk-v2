...
// DescribeUserTosBackupAssociateCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) DescribeUserTosBackupAssociateCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeUserTosBackupAssociateCommonRequest(input)
	req.SetContext(ctx)
...
// DescribeUserTosBackupAssociateRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) DescribeUserTosBackupAssociateWithContext(ctx byteplus.Context, input *DescribeUserTosBackupAssociateInput, opts ...request.Option) (*DescribeUserTosBackupAssociateOutput, error) {
	req, out := c.DescribeUserTosBackupAssociateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
