...
// MigrateToOtherZoneCommonRequest generates a "byteplus/request.Request" representing the
...
func (c *RDSMYSQLV2) MigrateToOtherZoneCommonWithContext(ctx byteplus.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.MigrateToOtherZoneCommonRequest(input)
	req.SetContext(ctx)
...
// MigrateToOtherZoneRequest generates a "byteplus/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RDSMYSQLV2) MigrateToOtherZoneWithContext(ctx byteplus.Context, input *MigrateToOtherZoneInput, opts ...request.Option) (*MigrateToOtherZoneOutput, error) {
	req, out := c.MigrateToOtherZoneRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
