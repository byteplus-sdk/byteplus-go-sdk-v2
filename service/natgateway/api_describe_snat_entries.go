...
// DescribeSnatEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeSnatEntriesRequest generates a "byteplus/request.Request" representing the
