...
// CreateSnatEntryCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateSnatEntryRequest generates a "byteplus/request.Request" representing the
