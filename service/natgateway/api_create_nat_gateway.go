...
// CreateNatGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNatGatewayRequest generates a "byteplus/request.Request" representing the
