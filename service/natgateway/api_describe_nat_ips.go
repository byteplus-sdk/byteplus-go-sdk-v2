...
// DescribeNatIpsCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNatIpsRequest generates a "byteplus/request.Request" representing the
