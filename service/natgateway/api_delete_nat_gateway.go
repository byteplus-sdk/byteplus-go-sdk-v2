...
// DeleteNatGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteNatGatewayRequest generates a "byteplus/request.Request" representing the
