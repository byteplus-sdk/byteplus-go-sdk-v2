...
// CreateNatIpLimitRuleCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateNatIpLimitRuleRequest generates a "byteplus/request.Request" representing the
