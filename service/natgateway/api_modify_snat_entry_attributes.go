...
// ModifySnatEntryAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifySnatEntryAttributesRequest generates a "byteplus/request.Request" representing the
