...
// DescribeNatIpLimitRulesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNatIpLimitRulesRequest generates a "byteplus/request.Request" representing the
