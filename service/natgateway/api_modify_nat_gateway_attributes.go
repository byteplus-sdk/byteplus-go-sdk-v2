...
// ModifyNatGatewayAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// ModifyNatGatewayAttributesRequest generates a "byteplus/request.Request" representing the
