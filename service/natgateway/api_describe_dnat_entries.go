...
// DescribeDnatEntriesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeDnatEntriesRequest generates a "byteplus/request.Request" representing the
