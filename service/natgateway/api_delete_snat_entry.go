...
// DeleteSnatEntryCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteSnatEntryRequest generates a "byteplus/request.Request" representing the
