...
// DescribeNatGatewaysCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNatGatewaysRequest generates a "byteplus/request.Request" representing the
