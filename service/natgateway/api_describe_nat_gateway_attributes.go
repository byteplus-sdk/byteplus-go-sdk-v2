...
// DescribeNatGatewayAttributesCommonRequest generates a "byteplus/request.Request" representing the
...
// DescribeNatGatewayAttributesRequest generates a "byteplus/request.Request" representing the
