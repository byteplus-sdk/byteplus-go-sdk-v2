...
// CreateDnatEntryCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateDnatEntryRequest generates a "byteplus/request.Request" representing the
