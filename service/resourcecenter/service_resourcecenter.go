...
// RESOURCECENTER provides the API operation methods for making requests to
// RESOURCECENTER. See this package's package overview docs
// for details on the service.
//
// RESOURCECENTER methods are safe to use concurrently. It is not safe to
...
func newClient(cfg byteplus.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *RESOURCECENTER {
	svc := &RESOURCECENTER{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a RESOURCECENTER operation and runs any
// custom request initialization.
func (c *RESOURCECENTER) newRequest(op *request.Operation, params, data interface{}) *request.Request {
