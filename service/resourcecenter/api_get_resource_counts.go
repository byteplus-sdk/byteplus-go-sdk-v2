...
// GetResourceCountsCommonRequest generates a "byteplus/request.Request" representing the
...
// GetResourceCountsRequest generates a "byteplus/request.Request" representing the
