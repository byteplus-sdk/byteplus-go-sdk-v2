...
// GetResourceCenterStatusCommonRequest generates a "byteplus/request.Request" representing the
...
// GetResourceCenterStatusRequest generates a "byteplus/request.Request" representing the
