...
// SearchResourcesCommonRequest generates a "byteplus/request.Request" representing the
...
// SearchResourcesRequest generates a "byteplus/request.Request" representing the
