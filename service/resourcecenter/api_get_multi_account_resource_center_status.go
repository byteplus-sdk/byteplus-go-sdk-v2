...
// GetMultiAccountResourceCenterStatusCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for RESOURCECENTER's
...
// GetMultiAccountResourceCenterStatusRequest generates a "byteplus/request.Request" representing the
