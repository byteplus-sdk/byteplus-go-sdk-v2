...
// DeleteRepositoryCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteRepositoryRequest generates a "byteplus/request.Request" representing the
