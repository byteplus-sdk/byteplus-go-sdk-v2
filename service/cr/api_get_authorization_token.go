...
// GetAuthorizationTokenCommonRequest generates a "byteplus/request.Request" representing the
...
// GetAuthorizationTokenRequest generates a "byteplus/request.Request" representing the
