...
// CreateRepositoryCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateRepositoryRequest generates a "byteplus/request.Request" representing the
