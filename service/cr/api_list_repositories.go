...
// ListRepositoriesCommonRequest generates a "byteplus/request.Request" representing the
...
// ListRepositoriesRequest generates a "byteplus/request.Request" representing the
