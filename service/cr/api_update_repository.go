...
// UpdateRepositoryCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateRepositoryRequest generates a "byteplus/request.Request" representing the
