...
// GetVpcEndpointCommonRequest generates a "byteplus/request.Request" representing the
...
// GetVpcEndpointRequest generates a "byteplus/request.Request" representing the
