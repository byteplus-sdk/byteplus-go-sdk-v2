...
// CreateRegistryCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateRegistryRequest generates a "byteplus/request.Request" representing the
