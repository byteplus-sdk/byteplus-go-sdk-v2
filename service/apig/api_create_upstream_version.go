...
// CreateUpstreamVersionCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUpstreamVersionRequest generates a "byteplus/request.Request" representing the
