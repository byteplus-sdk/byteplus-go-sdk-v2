...
// GetConsumerCommonRequest generates a "byteplus/request.Request" representing the
...
// GetConsumerRequest generates a "byteplus/request.Request" representing the
