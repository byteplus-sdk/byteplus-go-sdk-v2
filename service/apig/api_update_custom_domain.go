...
// UpdateCustomDomainCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateCustomDomainRequest generates a "byteplus/request.Request" representing the
