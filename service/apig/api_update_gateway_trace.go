...
// UpdateGatewayTraceCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateGatewayTraceRequest generates a "byteplus/request.Request" representing the
