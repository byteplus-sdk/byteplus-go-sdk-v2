...
// CreateConsumerCredentialCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateConsumerCredentialRequest generates a "byteplus/request.Request" representing the
