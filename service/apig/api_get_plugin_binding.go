...
// GetPluginBindingCommonRequest generates a "byteplus/request.Request" representing the
...
// GetPluginBindingRequest generates a "byteplus/request.Request" representing the
