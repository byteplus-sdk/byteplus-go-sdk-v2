...
// GetUpstreamSourceCommonRequest generates a "byteplus/request.Request" representing the
...
// GetUpstreamSourceRequest generates a "byteplus/request.Request" representing the
