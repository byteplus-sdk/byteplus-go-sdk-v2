...
// UpdateGatewayServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateGatewayServiceRequest generates a "byteplus/request.Request" representing the
