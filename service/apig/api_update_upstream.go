...
// UpdateUpstreamCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateUpstreamRequest generates a "byteplus/request.Request" representing the
