...
// CreateConsumerCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateConsumerRequest generates a "byteplus/request.Request" representing the
