...
// UpdateUpstreamVersionCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateUpstreamVersionRequest generates a "byteplus/request.Request" representing the
