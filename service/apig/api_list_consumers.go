...
// ListConsumersCommonRequest generates a "byteplus/request.Request" representing the
...
// ListConsumersRequest generates a "byteplus/request.Request" representing the
