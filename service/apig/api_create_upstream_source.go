...
// CreateUpstreamSourceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUpstreamSourceRequest generates a "byteplus/request.Request" representing the
