...
// UpdateGatewayLogCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateGatewayLogRequest generates a "byteplus/request.Request" representing the
