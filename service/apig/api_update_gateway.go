...
// UpdateGatewayCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateGatewayRequest generates a "byteplus/request.Request" representing the
