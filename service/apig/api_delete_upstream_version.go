...
// DeleteUpstreamVersionCommonRequest generates a "byteplus/request.Request" representing the
...
// DeleteUpstreamVersionRequest generates a "byteplus/request.Request" representing the
