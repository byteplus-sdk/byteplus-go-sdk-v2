...
// DeleteConsumerCredentialCommonRequest generates a "byteplus/request.Request" representing the
...
// the error.
//
// See the BYTEPLUS API reference guide for APIG's
...
// DeleteConsumerCredentialRequest generates a "byteplus/request.Request" representing the
