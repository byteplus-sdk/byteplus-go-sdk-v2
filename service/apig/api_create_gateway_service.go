...
// CreateGatewayServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateGatewayServiceRequest generates a "byteplus/request.Request" representing the
