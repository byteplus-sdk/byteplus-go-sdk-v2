...
// GetGatewayServiceCommonRequest generates a "byteplus/request.Request" representing the
...
// GetGatewayServiceRequest generates a "byteplus/request.Request" representing the
