...
// CreateUpstreamCommonRequest generates a "byteplus/request.Request" representing the
...
// CreateUpstreamRequest generates a "byteplus/request.Request" representing the
