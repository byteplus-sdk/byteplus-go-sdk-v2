...
// UpdatePluginBindingCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdatePluginBindingRequest generates a "byteplus/request.Request" representing the
