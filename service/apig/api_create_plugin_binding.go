...
// CreatePluginBindingCommonRequest generates a "byteplus/request.Request" representing the
...
// CreatePluginBindingRequest generates a "byteplus/request.Request" representing the
