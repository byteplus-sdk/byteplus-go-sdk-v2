...
// UpdateUpstreamSourceCommonRequest generates a "byteplus/request.Request" representing the
...
// UpdateUpstreamSourceRequest generates a "byteplus/request.Request" representing the
