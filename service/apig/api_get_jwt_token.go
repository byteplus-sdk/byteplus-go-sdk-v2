...
// GetJwtTokenCommonRequest generates a "byteplus/request.Request" representing the
...
// GetJwtTokenRequest generates a "byteplus/request.Request" representing the
