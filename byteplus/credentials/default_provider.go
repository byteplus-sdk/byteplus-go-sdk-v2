...
type DefaultCredentialProviderOptions struct {
	...
	// from env var BYTEPLUS_ECS_METADATA.
	RoleName string
...
//
// verboseErrors mirrors byteplus.Config.CredentialsChainVerboseErrors: when
...
func (d *DefaultCredentialProvider) Retrieve() (Value, error) {
	...
	if d.verboseErrors {
		return Value{}, bytepluserr.NewBatchError("NoCredentialProviders",
