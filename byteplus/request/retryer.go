...
func (r *Request) IsErrorRetryable() bool {
	...
	if isErrCode(r.Error, r.RetryErrorCodes) {
		logger.DebugByLevel(byteplus.LogDebugWithRequestRetries, "[Retry] retryable error code is contained in RetryErrorCodes list", r.Error)
		return true
	}
	...
	if IsErrorRetryable(r.Error) {
		logger.DebugByLevel(byteplus.LogDebugWithRequestRetries, "[Retry] error is retryable", r.Error)
		return true
	}
